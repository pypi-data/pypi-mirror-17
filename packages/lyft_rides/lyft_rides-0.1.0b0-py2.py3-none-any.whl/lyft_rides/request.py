...
from lyft_rides.utils import http
from lyft_rides.utils.request import build_url
from lyft_rides.utils.request import generate_data
from lyft_rides.utils.request import generate_prepared_request
...
class Request(object):
    ...
    def _prepare(self):
        ...
        if self.method not in http.ALLOWED_METHODS:
            raise LyftIllegalState('Unsupported HTTP Method.')
