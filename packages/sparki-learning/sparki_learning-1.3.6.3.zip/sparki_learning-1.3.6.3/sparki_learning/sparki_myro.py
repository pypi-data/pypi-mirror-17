...
########### CONSTANTS ###########
# ***** VERSION NUMBER ***** #
SPARKI_MYRO_VERSION = "1.3.2.1"     # this may differ from the version on Sparki itself and from the library as a whole
...
def askQuestion(message, options, mytitle = "Question"):
    ...
    if USE_GUI:
        try:
            result = tk.simpledialog(title = mytitle, text = message, buttons = options, parent = root)
        except:
            result = None
