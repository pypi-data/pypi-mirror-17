...
class HeatTemplate(base.BaseArtifact):
    ...
    fields = {
        'environment': Dict(glare_fields.Dependency,
        ...
        'nested_templates': BlobDict(required_on_activate=False,
                                     description="Dict of nested templates "
                                                 "where key is the name  of "
                                                 "template and value is "
                                                 "nested template body."),
        'default_envs': Dict(fields.String, required_on_activate=False,
