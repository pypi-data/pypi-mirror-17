...
# Target: ContribPlugin(BuildFileAddress(BuildFile(contrib/scalajs/src/python/pants/contrib/scalajs/BUILD, FileSystemProjectTree(/Users/benjyw/src/pants)), plugin))
...
{   'classifiers': [   'Intended Audience :: Developers',
    ...
    'install_requires': [   'pantsbuild.pants.contrib.node==1.2.0rc0',
