...
class JSONTests(unittest.TestCase):
    ...
    def testWriteWithEncodingBaseCases(self):
        ...
        # r = jsonWriter(obj, 'utf-8',outputEncoding='utf-8')
        r = jsonWriter(obj, ensure_ascii=False)
        self.assertEqual(unicode(r, 'utf-8'), good_result)

        # from unicode
        obj = input_uni
        # r = jsonWriter(obj, outputEncoding='utf-8')
        r = jsonWriter(obj, ensure_ascii=False)
        self.assertEqual(r, good_result)

        # from latin2
        obj = input_uni.encode('latin2')
        # r = jsonWriter(obj, 'latin2', outputEncoding='latin2')
        r = jsonWriter(obj, 'latin2', ensure_ascii=False)
        self.assertEqual(r, good_result)
