...
# Target: PythonLibrary(BuildFileAddress(BuildFile(contrib/buildgen/src/python/pants/contrib/buildgen/BUILD, FileSystemProjectTree(/Users/stuhood/src/pants)), plugin))
...
{   'classifiers': [   'Intended Audience :: Developers',
    ...
    'package_data': {   },
    'package_dir': {   '': 'src'},
    'packages': ['pants', 'pants.contrib', 'pants.contrib.buildgen'],
