...
# Target: PythonLibrary(BuildFileAddress(BuildFile(contrib/buildgen/src/python/pants/contrib/buildgen/BUILD, FileSystemProjectTree(/Users/benjyw/src/pants)), plugin))
