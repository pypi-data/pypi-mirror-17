...
STRING = c_char_p
_libraries = {}
_libraries['libnfc.so.5'] = CDLL('libnfc.so.5')
...
_IO_2_1_stdin_ = (_IO_FILE_plus).in_dll(_libraries['libnfc.so.5'], '_IO_2_1_stdin_')
_IO_2_1_stdout_ = (_IO_FILE_plus).in_dll(_libraries['libnfc.so.5'], '_IO_2_1_stdout_')
_IO_2_1_stderr_ = (_IO_FILE_plus).in_dll(_libraries['libnfc.so.5'], '_IO_2_1_stderr_')
__ssize_t = c_long
...
nfc_initiator_list_passive_targets = _libraries['libnfc.so.5'].nfc_initiator_list_passive_targets
...
nfc_initiator_poll_target = _libraries['libnfc.so.5'].nfc_initiator_poll_target
...
nfc_initiator_select_dep_target = _libraries['libnfc.so.5'].nfc_initiator_select_dep_target
...
nfc_initiator_poll_dep_target = _libraries['libnfc.so.5'].nfc_initiator_poll_dep_target
...
nfc_initiator_deselect_target = _libraries['libnfc.so.5'].nfc_initiator_deselect_target
nfc_initiator_deselect_target.restype = c_int
nfc_initiator_deselect_target.argtypes = [POINTER(nfc_device)]
nfc_initiator_transceive_bytes = _libraries['libnfc.so.5'].nfc_initiator_transceive_bytes
...
nfc_initiator_transceive_bits = _libraries['libnfc.so.5'].nfc_initiator_transceive_bits
...
uint32_t = c_uint32
nfc_initiator_transceive_bytes_timed = _libraries['libnfc.so.5'].nfc_initiator_transceive_bytes_timed
...
nfc_initiator_transceive_bits_timed = _libraries['libnfc.so.5'].nfc_initiator_transceive_bits_timed
...
nfc_initiator_target_is_present = _libraries['libnfc.so.5'].nfc_initiator_target_is_present
...
nfc_target_receive_bits = _libraries['libnfc.so.5'].nfc_target_receive_bits
...
nfc_device_get_supported_baud_rate = _libraries['libnfc.so.5'].nfc_device_get_supported_baud_rate
...
nfc_free = _libraries['libnfc.so.5'].nfc_free
nfc_free.restype = None
nfc_free.argtypes = [c_void_p]
nfc_version = _libraries['libnfc.so.5'].nfc_version
nfc_version.restype = STRING
nfc_version.argtypes = []
nfc_device_get_information_about = _libraries['libnfc.so.5'].nfc_device_get_information_about
...
str_nfc_modulation_type = _libraries['libnfc.so.5'].str_nfc_modulation_type
str_nfc_modulation_type.restype = STRING
str_nfc_modulation_type.argtypes = [nfc_modulation_type]
str_nfc_baud_rate = _libraries['libnfc.so.5'].str_nfc_baud_rate
str_nfc_baud_rate.restype = STRING
str_nfc_baud_rate.argtypes = [nfc_baud_rate]
str_nfc_target = _libraries['libnfc.so.5'].str_nfc_target
...
flockfile = _libraries['libnfc.so.5'].flockfile
flockfile.restype = None
flockfile.argtypes = [POINTER(FILE)]
ftrylockfile = _libraries['libnfc.so.5'].ftrylockfile
ftrylockfile.restype = c_int
ftrylockfile.argtypes = [POINTER(FILE)]
funlockfile = _libraries['libnfc.so.5'].funlockfile
...
__fdelt_chk = _libraries['libnfc.so.5'].__fdelt_chk
__fdelt_chk.restype = c_long
__fdelt_chk.argtypes = [c_long]
__fdelt_warn = _libraries['libnfc.so.5'].__fdelt_warn
