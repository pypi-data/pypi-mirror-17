...
_libraries = {}
_libraries['libfreefare.so.0'] = CDLL('libfreefare.so.0')
...
from pynfc.nfc import time_t
from pynfc.nfc import __clockid_t
from pynfc.nfc import __timer_t
from pynfc.nfc import timespec
from pynfc.nfc import __mbstate_t
from pynfc.nfc import __sig_atomic_t
from pynfc.nfc import __sigset_t
from pynfc.nfc import timeval
...
from pynfc.nfc import sigset_t
from pynfc.nfc import __fd_mask
from pynfc.nfc import fd_set
from pynfc.nfc import fd_mask
from pynfc.nfc import timezone
from pynfc.nfc import __timezone_ptr_t
from pynfc.nfc import __itimer_which
from pynfc.nfc import itimerval
from pynfc.nfc import __itimer_which_t
from pynfc.nfc import off64_t
from pynfc.nfc import suseconds_t
...
mifare_ultralight_write = _libraries['libfreefare.so.0'].mifare_ultralight_write
...
mifare_ultralightc_authenticate = _libraries['libfreefare.so.0'].mifare_ultralightc_authenticate
mifare_ultralightc_authenticate.restype = c_int
mifare_ultralightc_authenticate.argtypes = [MifareTag, MifareDESFireKey]
is_mifare_ultralightc_on_reader = _libraries['libfreefare.so.0'].is_mifare_ultralightc_on_reader
...
mifare_classic_nfcforum_public_key_a = (MifareClassicKey).in_dll(_libraries['libfreefare.so.0'], 'mifare_classic_nfcforum_public_key_a')
mifare_classic_connect = _libraries['libfreefare.so.0'].mifare_classic_connect
mifare_classic_connect.restype = c_int
mifare_classic_connect.argtypes = [MifareTag]
mifare_classic_disconnect = _libraries['libfreefare.so.0'].mifare_classic_disconnect
mifare_classic_disconnect.restype = c_int
mifare_classic_disconnect.argtypes = [MifareTag]
mifare_classic_authenticate = _libraries['libfreefare.so.0'].mifare_classic_authenticate
...
mifare_classic_read = _libraries['libfreefare.so.0'].mifare_classic_read
...
mifare_classic_init_value = _libraries['libfreefare.so.0'].mifare_classic_init_value
...
mifare_classic_read_value = _libraries['libfreefare.so.0'].mifare_classic_read_value
...
mifare_classic_get_data_block_permission = _libraries['libfreefare.so.0'].mifare_classic_get_data_block_permission
...
mifare_classic_format_sector = _libraries['libfreefare.so.0'].mifare_classic_format_sector
mifare_classic_format_sector.restype = c_int
mifare_classic_format_sector.argtypes = [MifareTag, MifareClassicSectorNumber]
mifare_classic_trailer_block = _libraries['libfreefare.so.0'].mifare_classic_trailer_block
...
mifare_classic_block_sector = _libraries['libfreefare.so.0'].mifare_classic_block_sector
...
mifare_classic_sector_first_block = _libraries['libfreefare.so.0'].mifare_classic_sector_first_block
...
mifare_classic_sector_block_count = _libraries['libfreefare.so.0'].mifare_classic_sector_block_count
mifare_classic_sector_block_count.restype = size_t
mifare_classic_sector_block_count.argtypes = [MifareClassicSectorNumber]
mifare_classic_sector_last_block = _libraries['libfreefare.so.0'].mifare_classic_sector_last_block
...
Mad = POINTER(mad)
mad_public_key_a = (MifareClassicKey).in_dll(_libraries['libfreefare.so.0'], 'mad_public_key_a')
mad_free_aid = (MadAid).in_dll(_libraries['libfreefare.so.0'], 'mad_free_aid')
mad_defect_aid = (MadAid).in_dll(_libraries['libfreefare.so.0'], 'mad_defect_aid')
mad_reserved_aid = (MadAid).in_dll(_libraries['libfreefare.so.0'], 'mad_reserved_aid')
mad_card_holder_aid = (MadAid).in_dll(_libraries['libfreefare.so.0'], 'mad_card_holder_aid')
mad_not_applicable_aid = (MadAid).in_dll(_libraries['libfreefare.so.0'], 'mad_not_applicable_aid')
mad_nfcforum_aid = (MadAid).in_dll(_libraries['libfreefare.so.0'], 'mad_nfcforum_aid')
mad_new = _libraries['libfreefare.so.0'].mad_new
mad_new.restype = Mad
mad_new.argtypes = [uint8_t]
mad_read = _libraries['libfreefare.so.0'].mad_read
mad_read.restype = Mad
mad_read.argtypes = [MifareTag]
mad_write = _libraries['libfreefare.so.0'].mad_write
mad_write.restype = c_int
mad_write.argtypes = [MifareTag, Mad, POINTER(c_ubyte), POINTER(c_ubyte)]
mad_get_version = _libraries['libfreefare.so.0'].mad_get_version
mad_get_version.restype = c_int
mad_get_version.argtypes = [Mad]
mad_set_version = _libraries['libfreefare.so.0'].mad_set_version
mad_set_version.restype = None
mad_set_version.argtypes = [Mad, uint8_t]
mad_get_card_publisher_sector = _libraries['libfreefare.so.0'].mad_get_card_publisher_sector
mad_get_card_publisher_sector.restype = MifareClassicSectorNumber
mad_get_card_publisher_sector.argtypes = [Mad]
mad_set_card_publisher_sector = _libraries['libfreefare.so.0'].mad_set_card_publisher_sector
mad_set_card_publisher_sector.restype = c_int
mad_set_card_publisher_sector.argtypes = [Mad, MifareClassicSectorNumber]
mad_get_aid = _libraries['libfreefare.so.0'].mad_get_aid
mad_get_aid.restype = c_int
mad_get_aid.argtypes = [Mad, MifareClassicSectorNumber, POINTER(MadAid)]
mad_set_aid = _libraries['libfreefare.so.0'].mad_set_aid
mad_set_aid.restype = c_int
mad_set_aid.argtypes = [Mad, MifareClassicSectorNumber, MadAid]
mad_sector_reserved = _libraries['libfreefare.so.0'].mad_sector_reserved
mad_sector_reserved.restype = c_bool
mad_sector_reserved.argtypes = [MifareClassicSectorNumber]
mad_free = _libraries['libfreefare.so.0'].mad_free
mad_free.restype = None
mad_free.argtypes = [Mad]
mifare_application_alloc = _libraries['libfreefare.so.0'].mifare_application_alloc
mifare_application_alloc.restype = POINTER(MifareClassicSectorNumber)
mifare_application_alloc.argtypes = [Mad, MadAid, size_t]
mifare_application_read = _libraries['libfreefare.so.0'].mifare_application_read
...
mifare_application_write = _libraries['libfreefare.so.0'].mifare_application_write
...
mifare_application_free = _libraries['libfreefare.so.0'].mifare_application_free
mifare_application_free.restype = None
mifare_application_free.argtypes = [Mad, MadAid]
mifare_application_find = _libraries['libfreefare.so.0'].mifare_application_find
...
mifare_desfire_aid_new = _libraries['libfreefare.so.0'].mifare_desfire_aid_new
mifare_desfire_aid_new.restype = MifareDESFireAID
mifare_desfire_aid_new.argtypes = [uint32_t]
mifare_desfire_aid_new_with_mad_aid = _libraries['libfreefare.so.0'].mifare_desfire_aid_new_with_mad_aid
mifare_desfire_aid_new_with_mad_aid.restype = MifareDESFireAID
mifare_desfire_aid_new_with_mad_aid.argtypes = [MadAid, uint8_t]
mifare_desfire_aid_get_aid = _libraries['libfreefare.so.0'].mifare_desfire_aid_get_aid
mifare_desfire_aid_get_aid.restype = uint32_t
mifare_desfire_aid_get_aid.argtypes = [MifareDESFireAID]
mifare_desfire_last_pcd_error = _libraries['libfreefare.so.0'].mifare_desfire_last_pcd_error
mifare_desfire_last_pcd_error.restype = uint8_t
mifare_desfire_last_pcd_error.argtypes = [MifareTag]
mifare_desfire_last_picc_error = _libraries['libfreefare.so.0'].mifare_desfire_last_picc_error
...
mifare_desfire_change_key = _libraries['libfreefare.so.0'].mifare_desfire_change_key
...
mifare_desfire_get_key_version = _libraries['libfreefare.so.0'].mifare_desfire_get_key_version
mifare_desfire_get_key_version.restype = c_int
mifare_desfire_get_key_version.argtypes = [MifareTag, uint8_t, POINTER(uint8_t)]
mifare_desfire_create_application = _libraries['libfreefare.so.0'].mifare_desfire_create_application
...
mifare_desfire_create_application_3k3des = _libraries['libfreefare.so.0'].mifare_desfire_create_application_3k3des
...
mifare_desfire_create_application_aes = _libraries['libfreefare.so.0'].mifare_desfire_create_application_aes
...
mifare_desfire_create_application_iso = _libraries['libfreefare.so.0'].mifare_desfire_create_application_iso
...
mifare_desfire_create_application_3k3des_iso = _libraries['libfreefare.so.0'].mifare_desfire_create_application_3k3des_iso
...
mifare_desfire_create_application_aes_iso = _libraries['libfreefare.so.0'].mifare_desfire_create_application_aes_iso
...
mifare_desfire_delete_application = _libraries['libfreefare.so.0'].mifare_desfire_delete_application
mifare_desfire_delete_application.restype = c_int
mifare_desfire_delete_application.argtypes = [MifareTag, MifareDESFireAID]
mifare_desfire_get_application_ids = _libraries['libfreefare.so.0'].mifare_desfire_get_application_ids
...
mifare_desfire_get_df_names = _libraries['libfreefare.so.0'].mifare_desfire_get_df_names
...
mifare_desfire_free_application_ids = _libraries['libfreefare.so.0'].mifare_desfire_free_application_ids
mifare_desfire_free_application_ids.restype = None
mifare_desfire_free_application_ids.argtypes = [POINTER(MifareDESFireAID)]
mifare_desfire_select_application = _libraries['libfreefare.so.0'].mifare_desfire_select_application
mifare_desfire_select_application.restype = c_int
mifare_desfire_select_application.argtypes = [MifareTag, MifareDESFireAID]
mifare_desfire_format_picc = _libraries['libfreefare.so.0'].mifare_desfire_format_picc
mifare_desfire_format_picc.restype = c_int
mifare_desfire_format_picc.argtypes = [MifareTag]
mifare_desfire_get_version = _libraries['libfreefare.so.0'].mifare_desfire_get_version
...
mifare_desfire_get_iso_file_ids = _libraries['libfreefare.so.0'].mifare_desfire_get_iso_file_ids
...
mifare_desfire_get_file_settings = _libraries['libfreefare.so.0'].mifare_desfire_get_file_settings
...
mifare_desfire_change_file_settings = _libraries['libfreefare.so.0'].mifare_desfire_change_file_settings
...
mifare_desfire_create_std_data_file = _libraries['libfreefare.so.0'].mifare_desfire_create_std_data_file
...
mifare_desfire_create_std_data_file_iso = _libraries['libfreefare.so.0'].mifare_desfire_create_std_data_file_iso
...
mifare_desfire_create_backup_data_file = _libraries['libfreefare.so.0'].mifare_desfire_create_backup_data_file
...
mifare_desfire_create_backup_data_file_iso = _libraries['libfreefare.so.0'].mifare_desfire_create_backup_data_file_iso
...
mifare_desfire_create_value_file = _libraries['libfreefare.so.0'].mifare_desfire_create_value_file
...
mifare_desfire_create_linear_record_file = _libraries['libfreefare.so.0'].mifare_desfire_create_linear_record_file
...
mifare_desfire_create_linear_record_file_iso = _libraries['libfreefare.so.0'].mifare_desfire_create_linear_record_file_iso
...
mifare_desfire_create_cyclic_record_file = _libraries['libfreefare.so.0'].mifare_desfire_create_cyclic_record_file
...
mifare_desfire_create_cyclic_record_file_iso = _libraries['libfreefare.so.0'].mifare_desfire_create_cyclic_record_file_iso
...
mifare_desfire_delete_file = _libraries['libfreefare.so.0'].mifare_desfire_delete_file
mifare_desfire_delete_file.restype = c_int
mifare_desfire_delete_file.argtypes = [MifareTag, uint8_t]
mifare_desfire_read_data = _libraries['libfreefare.so.0'].mifare_desfire_read_data
mifare_desfire_read_data.restype = ssize_t
mifare_desfire_read_data.argtypes = [MifareTag, uint8_t, off_t, size_t, c_void_p]
mifare_desfire_read_data_ex = _libraries['libfreefare.so.0'].mifare_desfire_read_data_ex
...
mifare_desfire_write_data = _libraries['libfreefare.so.0'].mifare_desfire_write_data
mifare_desfire_write_data.restype = ssize_t
mifare_desfire_write_data.argtypes = [MifareTag, uint8_t, off_t, size_t, c_void_p]
mifare_desfire_write_data_ex = _libraries['libfreefare.so.0'].mifare_desfire_write_data_ex
...
mifare_desfire_read_records = _libraries['libfreefare.so.0'].mifare_desfire_read_records
mifare_desfire_read_records.restype = ssize_t
mifare_desfire_read_records.argtypes = [MifareTag, uint8_t, off_t, size_t, c_void_p]
mifare_desfire_read_records_ex = _libraries['libfreefare.so.0'].mifare_desfire_read_records_ex
...
mifare_desfire_clear_record_file = _libraries['libfreefare.so.0'].mifare_desfire_clear_record_file
mifare_desfire_clear_record_file.restype = c_int
mifare_desfire_clear_record_file.argtypes = [MifareTag, uint8_t]
mifare_desfire_commit_transaction = _libraries['libfreefare.so.0'].mifare_desfire_commit_transaction
mifare_desfire_commit_transaction.restype = c_int
mifare_desfire_commit_transaction.argtypes = [MifareTag]
mifare_desfire_abort_transaction = _libraries['libfreefare.so.0'].mifare_desfire_abort_transaction
mifare_desfire_abort_transaction.restype = c_int
mifare_desfire_abort_transaction.argtypes = [MifareTag]
mifare_desfire_des_key_new = _libraries['libfreefare.so.0'].mifare_desfire_des_key_new
mifare_desfire_des_key_new.restype = MifareDESFireKey
mifare_desfire_des_key_new.argtypes = [POINTER(uint8_t)]
mifare_desfire_3des_key_new = _libraries['libfreefare.so.0'].mifare_desfire_3des_key_new
mifare_desfire_3des_key_new.restype = MifareDESFireKey
mifare_desfire_3des_key_new.argtypes = [POINTER(uint8_t)]
mifare_desfire_des_key_new_with_version = _libraries['libfreefare.so.0'].mifare_desfire_des_key_new_with_version
...
mifare_desfire_3des_key_new_with_version = _libraries['libfreefare.so.0'].mifare_desfire_3des_key_new_with_version
...
mifare_desfire_3k3des_key_new = _libraries['libfreefare.so.0'].mifare_desfire_3k3des_key_new
mifare_desfire_3k3des_key_new.restype = MifareDESFireKey
mifare_desfire_3k3des_key_new.argtypes = [POINTER(uint8_t)]
mifare_desfire_3k3des_key_new_with_version = _libraries['libfreefare.so.0'].mifare_desfire_3k3des_key_new_with_version
...
mifare_desfire_aes_key_new = _libraries['libfreefare.so.0'].mifare_desfire_aes_key_new
mifare_desfire_aes_key_new.restype = MifareDESFireKey
mifare_desfire_aes_key_new.argtypes = [POINTER(uint8_t)]
mifare_desfire_aes_key_new_with_version = _libraries['libfreefare.so.0'].mifare_desfire_aes_key_new_with_version
...
nfc_initiator_list_passive_targets = _libraries['libfreefare.so.0'].nfc_initiator_list_passive_targets
...
nfc_initiator_poll_target = _libraries['libfreefare.so.0'].nfc_initiator_poll_target
...
nfc_initiator_select_dep_target = _libraries['libfreefare.so.0'].nfc_initiator_select_dep_target
...
nfc_initiator_poll_dep_target = _libraries['libfreefare.so.0'].nfc_initiator_poll_dep_target
...
nfc_initiator_deselect_target = _libraries['libfreefare.so.0'].nfc_initiator_deselect_target
nfc_initiator_deselect_target.restype = c_int
nfc_initiator_deselect_target.argtypes = [POINTER(nfc_device)]
nfc_initiator_transceive_bytes = _libraries['libfreefare.so.0'].nfc_initiator_transceive_bytes
...
nfc_initiator_transceive_bits = _libraries['libfreefare.so.0'].nfc_initiator_transceive_bits
...
nfc_initiator_transceive_bytes_timed = _libraries['libfreefare.so.0'].nfc_initiator_transceive_bytes_timed
...
nfc_initiator_transceive_bits_timed = _libraries['libfreefare.so.0'].nfc_initiator_transceive_bits_timed
...
nfc_initiator_target_is_present = _libraries['libfreefare.so.0'].nfc_initiator_target_is_present
...
nfc_target_receive_bits = _libraries['libfreefare.so.0'].nfc_target_receive_bits
...
nfc_device_get_supported_baud_rate = _libraries['libfreefare.so.0'].nfc_device_get_supported_baud_rate
...
nfc_free = _libraries['libfreefare.so.0'].nfc_free
nfc_free.restype = None
nfc_free.argtypes = [c_void_p]
nfc_version = _libraries['libfreefare.so.0'].nfc_version
nfc_version.restype = STRING
nfc_version.argtypes = []
nfc_device_get_information_about = _libraries['libfreefare.so.0'].nfc_device_get_information_about
...
str_nfc_modulation_type = _libraries['libfreefare.so.0'].str_nfc_modulation_type
str_nfc_modulation_type.restype = STRING
str_nfc_modulation_type.argtypes = [nfc_modulation_type]
str_nfc_baud_rate = _libraries['libfreefare.so.0'].str_nfc_baud_rate
str_nfc_baud_rate.restype = STRING
str_nfc_baud_rate.argtypes = [nfc_baud_rate]
str_nfc_target = _libraries['libfreefare.so.0'].str_nfc_target
...
CRYPTO_mem_ctrl = _libraries['libfreefare.so.0'].CRYPTO_mem_ctrl
CRYPTO_mem_ctrl.restype = c_int
CRYPTO_mem_ctrl.argtypes = [c_int]
CRYPTO_is_mem_check_on = _libraries['libfreefare.so.0'].CRYPTO_is_mem_check_on
CRYPTO_is_mem_check_on.restype = c_int
CRYPTO_is_mem_check_on.argtypes = []
SSLeay_version = _libraries['libfreefare.so.0'].SSLeay_version
SSLeay_version.restype = STRING
SSLeay_version.argtypes = [c_int]
SSLeay = _libraries['libfreefare.so.0'].SSLeay
SSLeay.restype = c_ulong
SSLeay.argtypes = []
OPENSSL_issetugid = _libraries['libfreefare.so.0'].OPENSSL_issetugid
...
CRYPTO_get_ex_data_implementation = _libraries['libfreefare.so.0'].CRYPTO_get_ex_data_implementation
CRYPTO_get_ex_data_implementation.restype = POINTER(CRYPTO_EX_DATA_IMPL)
CRYPTO_get_ex_data_implementation.argtypes = []
CRYPTO_set_ex_data_implementation = _libraries['libfreefare.so.0'].CRYPTO_set_ex_data_implementation
CRYPTO_set_ex_data_implementation.restype = c_int
CRYPTO_set_ex_data_implementation.argtypes = [POINTER(CRYPTO_EX_DATA_IMPL)]
CRYPTO_ex_data_new_class = _libraries['libfreefare.so.0'].CRYPTO_ex_data_new_class
CRYPTO_ex_data_new_class.restype = c_int
CRYPTO_ex_data_new_class.argtypes = []
CRYPTO_get_ex_new_index = _libraries['libfreefare.so.0'].CRYPTO_get_ex_new_index
...
CRYPTO_get_add_lock_callback = _libraries['libfreefare.so.0'].CRYPTO_get_add_lock_callback
...
CRYPTO_set_dynlock_lock_callback = _libraries['libfreefare.so.0'].CRYPTO_set_dynlock_lock_callback
...
CRYPTO_set_dynlock_destroy_callback = _libraries['libfreefare.so.0'].CRYPTO_set_dynlock_destroy_callback
...
CRYPTO_get_dynlock_create_callback = _libraries['libfreefare.so.0'].CRYPTO_get_dynlock_create_callback
...
CRYPTO_get_dynlock_lock_callback = _libraries['libfreefare.so.0'].CRYPTO_get_dynlock_lock_callback
...
CRYPTO_get_dynlock_destroy_callback = _libraries['libfreefare.so.0'].CRYPTO_get_dynlock_destroy_callback
...
CRYPTO_set_mem_functions = _libraries['libfreefare.so.0'].CRYPTO_set_mem_functions
...
CRYPTO_set_locked_mem_functions = _libraries['libfreefare.so.0'].CRYPTO_set_locked_mem_functions
...
CRYPTO_set_mem_ex_functions = _libraries['libfreefare.so.0'].CRYPTO_set_mem_ex_functions
...
CRYPTO_set_locked_mem_ex_functions = _libraries['libfreefare.so.0'].CRYPTO_set_locked_mem_ex_functions
...
CRYPTO_set_mem_debug_functions = _libraries['libfreefare.so.0'].CRYPTO_set_mem_debug_functions
...
CRYPTO_get_mem_functions = _libraries['libfreefare.so.0'].CRYPTO_get_mem_functions
...
CRYPTO_get_locked_mem_functions = _libraries['libfreefare.so.0'].CRYPTO_get_locked_mem_functions
...
CRYPTO_get_mem_ex_functions = _libraries['libfreefare.so.0'].CRYPTO_get_mem_ex_functions
...
CRYPTO_get_locked_mem_ex_functions = _libraries['libfreefare.so.0'].CRYPTO_get_locked_mem_ex_functions
...
CRYPTO_get_mem_debug_functions = _libraries['libfreefare.so.0'].CRYPTO_get_mem_debug_functions
...
CRYPTO_mem_leaks_cb = _libraries['libfreefare.so.0'].CRYPTO_mem_leaks_cb
CRYPTO_mem_leaks_cb.restype = None
CRYPTO_mem_leaks_cb.argtypes = [POINTER(CRYPTO_MEM_LEAK_CB)]
OpenSSLDie = _libraries['libfreefare.so.0'].OpenSSLDie
OpenSSLDie.restype = None
OpenSSLDie.argtypes = [STRING, c_int, STRING]
OPENSSL_ia32cap_loc = _libraries['libfreefare.so.0'].OPENSSL_ia32cap_loc
OPENSSL_ia32cap_loc.restype = POINTER(c_ulong)
OPENSSL_ia32cap_loc.argtypes = []
OPENSSL_isservice = _libraries['libfreefare.so.0'].OPENSSL_isservice
OPENSSL_isservice.restype = c_int
OPENSSL_isservice.argtypes = []
FIPS_mode = _libraries['libfreefare.so.0'].FIPS_mode
FIPS_mode.restype = c_int
FIPS_mode.argtypes = []
FIPS_mode_set = _libraries['libfreefare.so.0'].FIPS_mode_set
FIPS_mode_set.restype = c_int
FIPS_mode_set.argtypes = [c_int]
OPENSSL_init = _libraries['libfreefare.so.0'].OPENSSL_init
OPENSSL_init.restype = None
OPENSSL_init.argtypes = []
FIPS_selftest_check = _libraries['libfreefare.so.0'].FIPS_selftest_check
FIPS_selftest_check.restype = None
FIPS_selftest_check.argtypes = []
CRYPTO_memcmp = _libraries['libfreefare.so.0'].CRYPTO_memcmp
CRYPTO_memcmp.restype = c_int
CRYPTO_memcmp.argtypes = [c_void_p, c_void_p, size_t]
ERR_load_CRYPTO_strings = _libraries['libfreefare.so.0'].ERR_load_CRYPTO_strings
ERR_load_CRYPTO_strings.restype = None
ERR_load_CRYPTO_strings.argtypes = []
OPENSSL_init_library = _libraries['libfreefare.so.0'].OPENSSL_init_library
OPENSSL_init_library.restype = None
OPENSSL_init_library.argtypes = []
...
_shadow_DES_check_key = (c_int).in_dll(_libraries['libfreefare.so.0'], '_shadow_DES_check_key')
_shadow_DES_rw_mode = (c_int).in_dll(_libraries['libfreefare.so.0'], '_shadow_DES_rw_mode')
DES_options = _libraries['libfreefare.so.0'].DES_options
DES_options.restype = STRING
DES_options.argtypes = []
DES_ecb3_encrypt = _libraries['libfreefare.so.0'].DES_ecb3_encrypt
...
DES_cbc_cksum = _libraries['libfreefare.so.0'].DES_cbc_cksum
...
DES_cbc_encrypt = _libraries['libfreefare.so.0'].DES_cbc_encrypt
...
DES_ncbc_encrypt = _libraries['libfreefare.so.0'].DES_ncbc_encrypt
...
DES_xcbc_encrypt = _libraries['libfreefare.so.0'].DES_xcbc_encrypt
...
DES_cfb_encrypt = _libraries['libfreefare.so.0'].DES_cfb_encrypt
...
DES_ecb_encrypt = _libraries['libfreefare.so.0'].DES_ecb_encrypt
...
DES_decrypt3 = _libraries['libfreefare.so.0'].DES_decrypt3
...
DES_ede3_cbc_encrypt = _libraries['libfreefare.so.0'].DES_ede3_cbc_encrypt
...
DES_ede3_cbcm_encrypt = _libraries['libfreefare.so.0'].DES_ede3_cbcm_encrypt
...
DES_ede3_cfb64_encrypt = _libraries['libfreefare.so.0'].DES_ede3_cfb64_encrypt
...
DES_ede3_cfb_encrypt = _libraries['libfreefare.so.0'].DES_ede3_cfb_encrypt
...
DES_ede3_ofb64_encrypt = _libraries['libfreefare.so.0'].DES_ede3_ofb64_encrypt
...
DES_pcbc_encrypt = _libraries['libfreefare.so.0'].DES_pcbc_encrypt
...
DES_ofb64_encrypt = _libraries['libfreefare.so.0'].DES_ofb64_encrypt
...
DES_read_password = _libraries['libfreefare.so.0'].DES_read_password
DES_read_password.restype = c_int
DES_read_password.argtypes = [POINTER(DES_cblock), STRING, c_int]
DES_read_2passwords = _libraries['libfreefare.so.0'].DES_read_2passwords
...
_ossl_old_des_options = _libraries['libfreefare.so.0']._ossl_old_des_options
_ossl_old_des_options.restype = STRING
_ossl_old_des_options.argtypes = []
_ossl_old_des_ecb3_encrypt = _libraries['libfreefare.so.0']._ossl_old_des_ecb3_encrypt
...
_ossl_old_des_cbc_cksum = _libraries['libfreefare.so.0']._ossl_old_des_cbc_cksum
...
_ossl_old_des_cbc_encrypt = _libraries['libfreefare.so.0']._ossl_old_des_cbc_encrypt
...
_ossl_old_des_ncbc_encrypt = _libraries['libfreefare.so.0']._ossl_old_des_ncbc_encrypt
...
_ossl_old_des_xcbc_encrypt = _libraries['libfreefare.so.0']._ossl_old_des_xcbc_encrypt
...
_ossl_old_des_cfb_encrypt = _libraries['libfreefare.so.0']._ossl_old_des_cfb_encrypt
...
_ossl_old_des_ecb_encrypt = _libraries['libfreefare.so.0']._ossl_old_des_ecb_encrypt
...
_ossl_old_des_decrypt3 = _libraries['libfreefare.so.0']._ossl_old_des_decrypt3
...
_ossl_old_des_ede3_cbc_encrypt = _libraries['libfreefare.so.0']._ossl_old_des_ede3_cbc_encrypt
...
_ossl_old_des_ede3_cfb64_encrypt = _libraries['libfreefare.so.0']._ossl_old_des_ede3_cfb64_encrypt
...
_ossl_old_des_ede3_ofb64_encrypt = _libraries['libfreefare.so.0']._ossl_old_des_ede3_ofb64_encrypt
...
_ossl_old_des_enc_read = _libraries['libfreefare.so.0']._ossl_old_des_enc_read
...
_ossl_old_des_enc_write = _libraries['libfreefare.so.0']._ossl_old_des_enc_write
...
_ossl_old_des_fcrypt = _libraries['libfreefare.so.0']._ossl_old_des_fcrypt
_ossl_old_des_fcrypt.restype = STRING
_ossl_old_des_fcrypt.argtypes = [STRING, STRING, STRING]
_ossl_old_des_crypt = _libraries['libfreefare.so.0']._ossl_old_des_crypt
_ossl_old_des_crypt.restype = STRING
_ossl_old_des_crypt.argtypes = [STRING, STRING]
_ossl_old_crypt = _libraries['libfreefare.so.0']._ossl_old_crypt
_ossl_old_crypt.restype = STRING
_ossl_old_crypt.argtypes = [STRING, STRING]
_ossl_old_des_ofb_encrypt = _libraries['libfreefare.so.0']._ossl_old_des_ofb_encrypt
...
_ossl_old_des_pcbc_encrypt = _libraries['libfreefare.so.0']._ossl_old_des_pcbc_encrypt
...
_ossl_old_des_quad_cksum = _libraries['libfreefare.so.0']._ossl_old_des_quad_cksum
...
_ossl_old_des_random_seed = _libraries['libfreefare.so.0']._ossl_old_des_random_seed
_ossl_old_des_random_seed.restype = None
_ossl_old_des_random_seed.argtypes = [POINTER(c_ubyte)]
_ossl_old_des_random_key = _libraries['libfreefare.so.0']._ossl_old_des_random_key
_ossl_old_des_random_key.restype = None
_ossl_old_des_random_key.argtypes = [POINTER(c_ubyte)]
_ossl_old_des_read_password = _libraries['libfreefare.so.0']._ossl_old_des_read_password
_ossl_old_des_read_password.restype = c_int
_ossl_old_des_read_password.argtypes = [POINTER(_ossl_old_des_cblock), STRING, c_int]
_ossl_old_des_read_2passwords = _libraries['libfreefare.so.0']._ossl_old_des_read_2passwords
...
_ossl_old_des_set_odd_parity = _libraries['libfreefare.so.0']._ossl_old_des_set_odd_parity
_ossl_old_des_set_odd_parity.restype = None
_ossl_old_des_set_odd_parity.argtypes = [POINTER(_ossl_old_des_cblock)]
_ossl_old_des_is_weak_key = _libraries['libfreefare.so.0']._ossl_old_des_is_weak_key
_ossl_old_des_is_weak_key.restype = c_int
_ossl_old_des_is_weak_key.argtypes = [POINTER(_ossl_old_des_cblock)]
_ossl_old_des_set_key = _libraries['libfreefare.so.0']._ossl_old_des_set_key
...
_ossl_old_des_key_sched = _libraries['libfreefare.so.0']._ossl_old_des_key_sched
...
_ossl_old_des_string_to_key = _libraries['libfreefare.so.0']._ossl_old_des_string_to_key
_ossl_old_des_string_to_key.restype = None
_ossl_old_des_string_to_key.argtypes = [STRING, POINTER(_ossl_old_des_cblock)]
_ossl_old_des_string_to_2keys = _libraries['libfreefare.so.0']._ossl_old_des_string_to_2keys
...
_ossl_old_des_cfb64_encrypt = _libraries['libfreefare.so.0']._ossl_old_des_cfb64_encrypt
...
_ossl_old_des_ofb64_encrypt = _libraries['libfreefare.so.0']._ossl_old_des_ofb64_encrypt
...
_ossl_096_des_random_seed = _libraries['libfreefare.so.0']._ossl_096_des_random_seed
...
UI_create_method = _libraries['libfreefare.so.0'].UI_create_method
UI_create_method.restype = POINTER(UI_METHOD)
UI_create_method.argtypes = [STRING]
UI_destroy_method = _libraries['libfreefare.so.0'].UI_destroy_method
UI_destroy_method.restype = None
UI_destroy_method.argtypes = [POINTER(UI_METHOD)]
UI_method_set_opener = _libraries['libfreefare.so.0'].UI_method_set_opener
UI_method_set_opener.restype = c_int
UI_method_set_opener.argtypes = [POINTER(UI_METHOD), CFUNCTYPE(c_int, POINTER(UI))]
UI_method_set_writer = _libraries['libfreefare.so.0'].UI_method_set_writer
...
UI_method_set_flusher = _libraries['libfreefare.so.0'].UI_method_set_flusher
UI_method_set_flusher.restype = c_int
UI_method_set_flusher.argtypes = [POINTER(UI_METHOD), CFUNCTYPE(c_int, POINTER(UI))]
UI_method_set_reader = _libraries['libfreefare.so.0'].UI_method_set_reader
...
UI_method_set_closer = _libraries['libfreefare.so.0'].UI_method_set_closer
UI_method_set_closer.restype = c_int
UI_method_set_closer.argtypes = [POINTER(UI_METHOD), CFUNCTYPE(c_int, POINTER(UI))]
UI_method_set_prompt_constructor = _libraries['libfreefare.so.0'].UI_method_set_prompt_constructor
...
pthread_cond_t._fields_ = [
    ('__data', N14pthread_cond_t4DOT_14E),
    ('__size', c_char * 48),
    ('__align', c_longlong),
]
...
pthread_rwlock_t._fields_ = [
    ('__data', N16pthread_rwlock_t4DOT_17E),
    ('__size', c_char * 56),
    ('__align', c_long),
]
...
wait._fields_ = [
    ('w_status', c_int),
    ('__wait_terminated', N4wait3DOT_4E),
    ('__wait_stopped', N4wait3DOT_5E),
]
select = _libraries['libfreefare.so.0'].select
select.restype = c_int
select.argtypes = [c_int, POINTER(fd_set), POINTER(fd_set), POINTER(fd_set), POINTER(timeval)]
pselect = _libraries['libfreefare.so.0'].pselect
...
mifare_desfire_session_key_new = _libraries['libfreefare.so.0'].mifare_desfire_session_key_new
...
mifare_desfire_error_lookup = _libraries['libfreefare.so.0'].mifare_desfire_error_lookup
...
__all__ = ['sk_sort', 'CRYPTO_THREADID_get_callback', 'X509_REVOKED',
           ...
           'renameat', 'str_nfc_baud_rate', 'ecvt', 'buf_mem_st',
           ...
           'sk_value', 'mifare_desfire_write_data_ex',
           'CRYPTO_mem_ctrl', 'ECDSA_METHOD', 'CRYPTO_THREADID_hash',
           'UI_add_user_data', '_ossl_old_des_ks_struct',
           'CRYPTO_set_mem_debug_functions', 'abs', 'N4wait3DOT_5E',
           'id_t', 'ASN1_BIT_STRING', 'sk_shift', '__codecvt_partial',
           ...
           'mifare_ultralight_tag', 'wcstombs', 'UI_STRING',
           'freefare_strerror', 'ecdsa_method', 'fcloseall',
           ...
           'UI_add_info_string', 'printf', 'unlockpt', 'MFC_KEY_A',
           'MFC_KEY_B', 'DES_fcrypt', 'pthread_rwlock_t',
           'NMT_ISO14443B2CT',
           'mifare_desfire_create_application_3k3des', 'sk_delete',
           '__vdprintf_chk', 'NP_FORCE_SPEED_106',
           'nfc_target_receive_bytes', 'stdout', 'fsfilcnt64_t',
           'fputs_unlocked', 'x509_store_st', 'lrand48_r',
           'ui_string_st', '_ossl_old_des_cfb64_encrypt',
           'nfc_target_send_bytes', 'CRYPTO_thread_id',
           'mifare_ultralightc_authenticate', 'engine_st', 'ftello64',
           'CRYPTO_EX_DATA', 'qsort', 'ferror_unlocked', 'qgcvt',
           'AUTHORITY_KEYID_st', 'sk_push', 'sk_delete_ptr',
           'X509_POLICY_LEVEL_st', 'mifare_desfire_credit',
           'fwrite_unlocked', 'CRYPTO_get_new_dynlockid',
           'DES_enc_write', 'CLASSIC_4K', 'pthread_barrierattr_t',
           ...
           'CRYPTO_THREADID_cmp', 'mkostemps', 'strtoq',
           'mifare_classic_get_trailer_block_permission',
           'env_md_ctx_st', 'fprintf', 'asn1_string_st', 'sk_pop',
           'ui_st', 'X509_PUBKEY', '__locale_struct', 'u_int8_t',
           'ASN1_ITEM_st', 'mad_set_version', 'ui_method_st',
           'MifareClassicBlockNumber', 'abort', 'DES_random_key',
           'UI_ctrl', 'crypto_ex_data_st',
           ...
           'nfc_initiator_init_secure_element', 'fcvt', 'DES_crypt',
           'UI_dup_error_string', 'CRYPTO_dup_ex_data',
           'UI_method_set_writer', 'MDFT_VALUE_FILE_WITH_BACKUP',
           'DES_ede3_cfb_encrypt', 'UI_UTIL_read_pw_string',
           'strtouq', 'nfc_version', 'T_DES', 'UI_get0_result',
           'CRYPTO_malloc_locked', 'DES_set_key_unchecked',
           'nfc_device_set_property_int',
           'mifare_desfire_create_linear_record_file',
           'X509_POLICY_CACHE_st', 'ASN1_GENERALSTRING',
           ...
           'N23_ossl_old_des_ks_struct3DOT_1E', 'UI_get0_test_string',
           'nfc_initiator_poll_target', 'mifare_ultralight_connect',
           'mkostemps64', 'BN_BLINDING', 'feof_unlocked',
           ...
           '__asprintf_chk', 'uid_t', 'on_exit', 'perror',
           'CRYPTO_get_lock_name', 'SSL', 'X509_POLICY_NODE_st',
           '__vprintf_chk', 'NP_INFINITE_SELECT', 'AS_LEGACY',
           'conf_st', 'gcvt', 'getdelim', 'sk_dup',
           'CRYPTO_set_dynlock_lock_callback', 'mad_card_holder_aid',
           'UI_add_error_string', 'UI_METHOD', 'UIT_PROMPT',
           'vsprintf', '_ossl_old_des_cfb_encrypt', 'setstate',
           'mifare_ultralight_read', 'snprintf', 'pthread_spinlock_t',
           'flockfile', 'st_CRYPTO_EX_DATA_IMPL',
           'CRYPTO_get_dynlock_destroy_callback',
           '_ossl_old_des_encrypt3',
           'MDFT_CYCLIC_RECORD_FILE_WITH_BACKUP', 'sk_zero',
           'UI_method_set_flusher', 'fsblkcnt64_t',
           'mad_nfcforum_aid', 'mifare_desfire_write_record',
           'nfc_initiator_list_passive_targets',
           '_ossl_old_des_xcbc_encrypt', 'initstate_r',
           'CRYPTO_get_add_lock_callback', 'DES_ncbc_encrypt',
           'mifare_desfire_create_application_3k3des_iso', 'clock_t',
           '_IO_free_backup_area', 'openssl_item_st',
           '_ossl_old_des_pcbc_encrypt', 'sk_unshift',
           '_ossl_old_des_ede3_ofb64_encrypt', 'sprintf', 'vscanf',
           'nfc_perror', '_ossl_old_des_enc_read', 'CRYPTO_memcmp',
           '__fgets_chk', 'pthread_barrier_t',
           'CRYPTO_dbg_set_options', 'BIGNUM', 'iso14443a_crc_append',
           'DES_key_sched', 'mifare_desfire_limited_credit_ex',
           'asprintf', 'nfc_exit', 'UI_create_method', 'free', 'labs',
           '_ossl_old_des_decrypt3', 'CRYPTO_mem_leaks_fp',
           'UI_set_result', 'qsort_r', 'BN_CTX', 'ERR_FNS',
           'UI_set_default_method', 'fseeko', '__uflow',
           'NP_HANDLE_PARITY', 'DIST_POINT_st', '__pthread_list_t',
           'nfc_register_driver', 'OPENSSL_ia32cap_loc',
           'pthread_attr_t', 'UI_add_input_string', 'EVP_MD',
           'NP_TIMEOUT_ATR', 'ino_t', 'strtoll_l', 'bignum_st',
           'mifare_desfire_last_pcd_error', 'rand',
           'nfc_device_get_connstring', '_shadow_DES_check_key',
           'N28mifare_desfire_file_settings4DOT_464DOT_47E',
           '__getdelim', 'DES_options', 'sk_deep_copy', 'system',
           'ASN1_OCTET_STRING', 'calloc', 'sk_num', '_IO_seekoff',
           'nfc_close', 'ecdh_method', 'DES_cbc_cksum',
           ...
           'asn1_object_st', 'DES_cfb_encrypt', 'nfc_init',
           'CRYPTO_is_mem_check_on', 'BUF_MEM', 'setbuffer',
           'CRYPTO_free', 'strtod_l', 'funlockfile', 'mkostemp',
           ...
           '_ossl_old_des_read_2passwords', 'ASN1_UNIVERSALSTRING',
           'putc_unlocked', 'nfc_initiator_transceive_bits',
           'CRYPTO_get_dynlock_lock_callback',
           'nfc_initiator_transceive_bytes', '_IO_peekc_locked',
           'pthread_cond_t', 'N6DES_ks3DOT_0E', 'DH',
           'CRYPTO_get_mem_debug_options', 'x509_crl_method_st',
           'RSA', 'UI_method_get_closer', 'vprintf', '__fread_chk',
           'sys_nerr', 'mifare_desfire_commit_transaction',
           'NP_ACCEPT_MULTIPLE_FRAMES', 'mad_public_key_a', 'nlink_t',
           'secure_getenv', 'UI_dup_input_string', 'fseek',
           'obstack_printf', 'pthread_mutex_t',
           'mifare_desfire_create_std_data_file', 'UI_string_types',
           'BIO_dummy', 'ssl_ctx_st', '_ossl_old_des_ecb_encrypt',
           'UI_get_ex_new_index', 'mktemp', 'ulong',
           'mifare_desfire_read_data', 'freefare_perror',
           'is_mifare_ultralightc_on_reader', 'mad_write',
           'getchar_unlocked', 'asn1_pctx_st', 'STORE',
           '_ossl_old_des_random_key',
           'mifare_desfire_create_application_aes_iso',
           'X509_POLICY_CACHE', 'srand48', 'PKCS8_PRIV_KEY_INFO',
           'X509_CRL', 'fsblkcnt_t', 'fgets_unlocked',
           '__obstack_printf_chk', 'mifare_desfire_connect', 'atoi',
           'x509_st', 'fseeko64', '__obstack_vprintf_chk',
           'setlinebuf', '_sys_errlist', 'setvbuf',
           'mifare_desfire_limited_credit', 'ENGINE',
           '__pthread_mutex_s', 'fgetpos', 'T_3DES',
           ...
           'mifare_desfire_free_mem', 'fsfilcnt_t',
           'UI_get_result_minsize', 'mode_t', 'MifareClassicKeyType',
           'strtoull', 'strtol', 'UI_dup_input_boolean', 'NBR_106',
           'stack_st_UI_STRING', '_IO_2_1_stdin_',
           'mifare_desfire_get_iso_file_ids', 'strtof', 'putw',
           'mkstemps', 'EVP_PKEY', 'fputs', 'NP_AUTO_ISO14443_4',
           ...
           'l64a', 'mifare_ultralight_disconnect', 'UIT_INFO',
           'MadAid', 'env_md_st',
           ...
           'ERR_load_CRYPTO_strings', 'UI_get0_user_data',
           'CRYPTO_lock', 'remove', 'mifare_desfire_session_key_new',
           'nfc_device_get_information_about', 'NDM_ACTIVE',
           'NBR_212', 'mifare_desfire_key_get_version',
           'MifareDESFireDF',
           'mifare_desfire_3k3des_key_new_with_version', 'nfc_idle',
           'mifare_desfire_delete_application', 'mbtowc', 'strtoul',
           'STORE_METHOD', 'mifare_desfire_select_application',
           'pkcs8_priv_key_info_st', 'nfc_device_get_last_error',
           'mifare_desfire_debit_ex', 'OPENSSL_STRING', 'grantpt',
           'OPENSSL_ITEM', 'lcong48_r', 'quick_exit', 'UI_set_method',
           'mad_defect_aid', 'BN_GENCB',
           'mifare_desfire_create_linear_record_file_iso', 'lcong48',
           'jrand48', 'mifare_desfire_get_value_ex',
           'nfc_initiator_target_is_present', 'X509_STORE',
           'OPENSSL_CSTRING', 'N14pthread_cond_t4DOT_14E',
           'CRYPTO_set_ex_data', 'UI_get0_output_string',
           ...
           'ASN1_TIME', 'CRYPTO_set_locking_callback',
           'DES_read_2passwords', '__overflow',
           'MDFT_BACKUP_DATA_FILE', 'mifare_desfire_aid',
           'UI_get_method', 'UI_destroy_method', 'strtol_l',
           'mifare_classic_increment',
           'mifare_desfire_free_application_ids', 'useconds_t',
           'P_PID', 'tmpnam_r', 'x509_revoked_st', 'futimesat',
           'CRYPTO_num_locks', 'mad_get_aid', 'ushort', 'clockid_t',
           'fwrite', 'BN_RECP_CTX', 'OpenSSLDie',
           'mifare_desfire_change_key', 'ISSUING_DIST_POINT',
           'ASN1_BMPSTRING', 'srandom', '__vsnprintf_chk',
           '_IO_flockfile', 'CRYPTO_dbg_free', 'fflush_unlocked',
           'vasprintf', 'mifare_desfire_key_set_version', 'fsetpos64',
           'N11__mbstate_t4DOT_22E', 'CRYPTO_realloc_clean',
           'crypto_threadid_st', 'nfc_initiator_init',
           'DES_ecb_encrypt', 'tmpfile64', 'getc_unlocked',
           'DES_string_to_key', 'blkcnt_t', '__locale_data',
           'UI_new_method', 'CRYPTO_get_mem_functions',
           'mad_free_aid', 'DES_decrypt3', 'UI_get_ex_data',
           '__compar_d_fn_t', 'MifareUltralightPage', 'ssl_st',
           'UI_UTIL_read_pw', 'CRYPTO_THREADID_set_callback',
           'gnu_dev_major', 'UI_method_set_prompt_constructor',
           'putc', '_ossl_old_des_set_key',
           'CRYPTO_get_locked_mem_functions', 'DSA',
           '_ossl_old_des_key_sched',
           'mifare_desfire_create_value_file', 'fcvt_r', 'mad_free',
           'seed48_r', 'fread', 'dh_st', 'ftello',
           'UI_method_get_writer',
           'CRYPTO_set_dynlock_create_callback', 'adjtime',
           'NBR_UNDEFINED', 'NBR_424', 'ASN1_UTCTIME',
           'mifare_classic_read', '_STACK', 'DES_xcbc_encrypt',
           'NAME_CONSTRAINTS', 'T_AES', 'drand48',
           ...
           'lutimes', 'nfc_abort_command', 'mifare_classic_connect',
           'ASN1_INTEGER', 'pthread_t',
           ...
           'MifareClassicBlock', 'NBR_847',
           'nfc_initiator_deselect_target', 'pthread_rwlockattr_t',
           'getw', 'vsnprintf', 'UI_method_set_opener', 'ldiv',
           '__snprintf_chk', 'caddr_t', 'mifare_desfire_get_df_names',
           'CRYPTO_dbg_get_options', '_IO_lock_t', 'setbuf',
           '_IO_2_1_stdout_', 'u_quad_t', 'stdin',
           'NP_ACTIVATE_CRYPTO1', 'idtype_t',
           'nfc_device_get_supported_modulation', 'sk_set',
           'mifare_tag_type', 'qecvt_r', 'drand48_r',
           'MDFT_STANDARD_DATA_FILE', 'DES_pcbc_encrypt', 'nrand48',
           'tlv_decode', 'sk_find_ex', 'mifare_desfire_credit_ex',
           'fopen64', 'mifare_desfire_create_std_data_file_iso',
           'ocsp_responder_id_st', 'rand_meth_st', 'getc',
           'ASN1_OBJECT', 'mifare_application_free',
           'CRYPTO_remove_all_info', 'CRYPTO_dynlock',
           '__mbstowcs_chk', 'mifare_desfire_aid_new',
           'CRYPTO_EX_DATA_IMPL', 'mkstemps64', 'pthread_condattr_t',
           'mifare_desfire_3des_key_new', 'mifare_desfire_get_value',
           'CONF', 'mifare_desfire_des_key_new', '__wcstombs_chk',
           'fflush', 'random_data', 'CRYPTO_get_locking_callback',
           'iso14443a_crc', 'atoll', 'DES_string_to_2keys',
           'NP_HANDLE_CRC', 'mifare_desfire_last_picc_error',
           '__compar_fn_t', '__fprintf_chk', 'P_PGID', 'DES_cblock',
           'ptsname', 'u_int16_t', 'rsa_meth_st', 'fgetpos64',
           'NP_TIMEOUT_COMMAND', 'mifare_desfire_get_application_ids',
           'X509_crl_st', 'tmpnam', 'ASN1_PCTX', 'vfprintf',
           'UI_add_verify_string', 'ASN1_UTF8STRING',
           'store_method_st', 'loff_t', 'mifare_desfire_read_records',
           ...
           'CRYPTO_strdup', '__fgets_unlocked_chk', 'vfscanf',
           ...
           'tempnam', 'tmpfile', 'mifare_classic_format_sector',
           'rpmatch', 'realpath', 'sk_pop_free', 'pclose',
           'DES_ofb64_encrypt', '__fdelt_warn', 'llabs', 'seed48',
           'OCSP_RESPONSE', 'mifare_classic_sector_block_count',
           'evp_cipher_ctx_st', '__codecvt_ok', 'fgets', 'X509_ALGOR',
           'mad_get_version', 'UI_method_set_closer',
           'const_DES_cblock', '_IO_feof', 'dsa_st', 'UI_process',
           'gid_t', 'CRYPTO_set_ex_data_implementation',
           'nfc_target_init', 'mifare_desfire_version_info',
           'mifare_desfire_create_cyclic_record_file_iso',
           'AUTHORITY_KEYID', 'ULTRALIGHT', 'ftell', 'OPENSSL_init',
           'exit', 'select', 'CRYPTO_free_locked', 'fmemopen',
           'EVP_PKEY_CTX', 'N_TARGET', 'OPENSSL_isservice', 'mad_aid',
           ...
           '__vasprintf_chk', 'mifare_desfire_file_settings',
           '_shadow_DES_rw_mode', 'SSLeay_version',
           'X509_POLICY_TREE_st', 'getsubopt', 'putchar_unlocked',
           'CRYPTO_set_mem_ex_functions',
           'mifare_desfire_set_default_key', 'tlv_append',
           'mifare_application_find', 'X509_pubkey_st', 'puts',
           '_ossl_old_des_fcrypt', 'OPENSSL_cleanse',
           'CRYPTO_mem_leaks', 'malloc', 'FIPS_selftest_check',
           'sys_errlist', 'BN_MONT_CTX',
           'mifare_desfire_get_file_settings', 'clearerr_unlocked',
           'NP_TIMEOUT_COM', 'UI_method_get_opener',
           'CRYPTO_dynlock_value', 'aligned_alloc',
           'UI_get0_result_string', '__vsprintf_chk',
           'CRYPTO_cleanup_all_ex_data', 'ferror', '__fdelt_chk',
           ...
           'mifare_desfire_aes_key_new_with_version', 'daddr_t',
           'MifareDESFireAID', 'CRYPTO_get_mem_ex_functions',
           'mrand48', '_ossl_old_crypt', 'mifare_desfire_key',
           ...
           'mifare_classic_read_value', 'atof', 'ASN1_ITEM',
           'ASN1_ENUMERATED', '_IO_getc',
           'mifare_desfire_delete_file', 'mifare_desfire_tag',
           'CRYPTO_THREADID_set_pointer', 'DES_set_key_checked',
           'cuserid', 'pthread_once_t', '_ossl_old_des_string_to_key',
           '_IO_vfscanf', 'sk_insert', 'ungetc',
           ...
           'stack_st_void', 'DES_ks', 'mad_read', 'initstate',
           'dsa_method', 'DES_ede3_cbcm_encrypt',
           ...
           'mifare_desfire_format_picc', 'EVP_MD_CTX', 'setenv',
           'Mad', 'N_INITIATOR',
           'nfc_initiator_transceive_bytes_timed', 'evp_cipher_st',
           'X509_name_st', 'supported_tag', 'mifare_desfire_debit',
           'fsid_t', '_ossl_old_des_ncbc_encrypt',
           '_ossl_096_des_random_seed',
           'mifare_classic_nfcforum_public_key_a',
           'stack_st_OPENSSL_STRING', '__codecvt_error',
           'mifare_desfire_set_ats', '__wctomb_chk',
           ...
           'NP_EASY_FRAMING', 'mifare_desfire_create_application_iso',
           'gettimeofday', 'CRYPTO_get_new_lockid', 'P_ALL',
           'CRYPTO_get_mem_debug_functions', '__codecvt_noconv',
           'fgetc_unlocked', 'MifareUltralightPageNumber',
