...
class XGRequest(object):
    ...
    def __init__(self, type="query", nodes=None, action=None, event=None,
...
class XGQuery(XGRequest):
    ...
    def __init__(self, nodes=None, flat=False, values_only=False):
...
class XGAction(XGRequest):
    ...
    def __init__(self, action, nodes=None, flat=False, values_only=False):
