...
def get_time_for_polyline(iso_time):
    ...
    return int(delorean.Delorean(parsed_time, timezone='UTC').epoch * 1000.0)
...
def get_time_from_polyline(int_representation):
    ...
    '''
    delorean_time = delorean.epoch(int_representation / 1000.0).shift('UTC')
...
def get_gpx_from_decoded(lat_rep, lon_rep, time_stamp_rep):
    ...
    return [
        ...
        get_time_from_polyline(time_stamp_rep)
    ]
