#!/usr/bin/python3
"""This is a configuration file for 'gravely' gravity simulator."""
...
t_max = 180 * day
dt = 1 * sec
substepping_acceleration = 0.1 * cm / sec**2 / dt
max_dt_substepping_depth = 100000
diagnostics_period = 0.5 * hour
