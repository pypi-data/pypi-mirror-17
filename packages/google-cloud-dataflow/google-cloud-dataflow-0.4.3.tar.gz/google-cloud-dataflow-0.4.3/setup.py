...
PACKAGE_DESCRIPTION = (
    'Google Cloud Dataflow SDK for Python, based on Apache Beam (incubating)')
...
PACKAGE_LONG_DESCRIPTION = '''
Apache Beam (incubating) is an open-source, unified programming model for
describing large-scale data processing pipelines. This redistribution of
Apache Beam (incubating) is targeted for executing batch Python pipelines on
