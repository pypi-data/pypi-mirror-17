The ViewModel provides a high level db schema and interface to a database as well as an interface from the db to viewsCurrent version works with bottle framework and pymongohowever a previous version supported sqlalchemy and otherframeworks could be supported.
Home-page: https://bitbucket.org/objdict/objdict
Author: Ian Ogilvy
...
Description: .. ViewModels documentation master README file.
        ...
        'models_' is a list of the names of tables, or actual database tables objects
        used by the view
        
        'dbModels_' is a dictionary of database table objects used by the view, with
