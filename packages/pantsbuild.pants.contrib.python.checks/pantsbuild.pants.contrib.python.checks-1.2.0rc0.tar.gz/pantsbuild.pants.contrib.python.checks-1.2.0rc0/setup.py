...
# Target: ContribPlugin(BuildFileAddress(BuildFile(contrib/python/src/python/pants/contrib/python/checks/BUILD, FileSystemProjectTree(/Users/benjyw/src/pants)), plugin))
