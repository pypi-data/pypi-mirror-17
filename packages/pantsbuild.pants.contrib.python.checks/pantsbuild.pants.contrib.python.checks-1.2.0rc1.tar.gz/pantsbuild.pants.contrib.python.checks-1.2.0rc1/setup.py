...
# Target: ContribPlugin(BuildFileAddress(BuildFile(contrib/python/src/python/pants/contrib/python/checks/BUILD, FileSystemProjectTree(/Users/stuhood/src/pants)), plugin))
...
{   'classifiers': [   'Intended Audience :: Developers',
    ...
    'entry_points': {   'pantsbuild.plugin': [   'register_goals = pants.contrib.python.checks.register:register_goals']},
    ...
    'namespace_packages': ['pants', 'pants.contrib', 'pants.contrib.python'],
    'package_data': {   'pants.contrib.python.checks.tasks': [   'templates/python_eval/eval.py.mustache']},
    'package_dir': {   '': 'src'},
    'packages': [   'pants',
                    'pants.contrib',
                    'pants.contrib.python',
                    'pants.contrib.python.checks',
                    'pants.contrib.python.checks.tasks',
