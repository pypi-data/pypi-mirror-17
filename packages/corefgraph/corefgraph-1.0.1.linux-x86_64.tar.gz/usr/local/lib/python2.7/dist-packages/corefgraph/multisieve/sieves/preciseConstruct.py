...
class AcronymMatch(Sieve):
    ...
    def __init__(self, multi_sieve_processor, options):
        super(AcronymMatch, self).__init__(multi_sieve_processor, options)
...
class RelativePronoun(Sieve):
    ...
    def __init__(self, multi_sieve_processor, options):
        super(RelativePronoun, self).__init__(multi_sieve_processor, options)
        self.logger = getLogger(__name__)
...
class DemonymMatch(Sieve):
    ...
    def __init__(self, multi_sieve_processor, options):
        super(DemonymMatch, self).__init__(multi_sieve_processor, options)
        self.logger = getLogger(__name__)
...
class PreciseConstructSieve(Sieve):
    ...
    def __init__(self, multi_sieve_processor, options):
        super(self.__class__, self).__init__(multi_sieve_processor, options)
        self.sieves = (
            AppositiveConstruction(multi_sieve_processor, options),
            PredicativeNominativeConstruction(multi_sieve_processor, options),
            AcronymMatch(multi_sieve_processor, options),
            RelativePronoun(multi_sieve_processor, options),
            DemonymMatch(multi_sieve_processor, options),
            RoleAppositiveConstruction(multi_sieve_processor, options),
