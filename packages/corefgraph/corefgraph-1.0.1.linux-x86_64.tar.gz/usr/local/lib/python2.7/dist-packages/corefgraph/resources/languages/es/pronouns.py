...
relative = fail()  #list_checker(('adonde', 'como', 'cual', 'cuales', 'cuando', 'cuanta', 'cuantas', 'cuanto', 'cuantos', 'cuya',
...
pleonastic = equality_checker("eso")
