...
class PreciseConstructSieve(Sieve):
    ...
    def __init__(self, multi_sieve_processor):
        super(self.__class__, self).__init__(multi_sieve_processor)
        self.sieves = (
            AppositiveConstruction(multi_sieve_processor),
            PredicativeNominativeConstruction(multi_sieve_processor),
            AcronymMatch(multi_sieve_processor),
            RelativePronoun(multi_sieve_processor),
            DemonymMatch(multi_sieve_processor),
            RoleAppositiveConstruction(multi_sieve_processor),
