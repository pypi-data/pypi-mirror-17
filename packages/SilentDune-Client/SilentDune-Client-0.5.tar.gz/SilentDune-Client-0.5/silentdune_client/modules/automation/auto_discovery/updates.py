...
class SystemUpdatesDiscovery(BaseDiscoveryService):
    ...
    _rebuild_cache_interval = 5  # Rebuild the updates cache rules every 5 days.
    ...
    _rebuild_cache = True  # Rebuild the package manager cache.
