...
class SilentDuneRemoteConfigModule(BaseModule):
    ...
    def validate_arguments(self, args):
        ...
        if not self._uri.scheme or not self._uri.hostname or self._uri.scheme not in ['file', 'http', 'https', 'ftp']:
    ...
    def validate_config(self, config):
        ...
        if self._enabled:
            ...
            if not self._uri.scheme or not self._uri.hostname or \
                            self._uri.scheme not in ['file', 'http', 'https', 'ftp']:
