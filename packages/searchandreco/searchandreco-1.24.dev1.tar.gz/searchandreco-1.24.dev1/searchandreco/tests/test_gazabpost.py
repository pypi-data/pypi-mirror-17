...
## the prop value for gazabpost is s57v
PROP = 's57v'
...
class TestScoopwhoop(SearchDbTestCase):
    '''
    gazabpost search test cases class
    '''
    ...
    def test_index_article(self):
        ...
        :return:
        '''
        data_to_index = {"id": "5694b6aa2d07dfc5072cb4bc",
                         "slug": "slug",
                         "ar_url": "ar_url",
                         "ar_name": "ar_name",
                         "content": "content",
        ...
        response = indexer.index_single_prop(data_to_index,
                                             data_to_index['id'])
        # print "gazabpost Indexed Article Response: " + str(response)
    ...
    def test_index_article_exists(self):
        ...
        response = indexer.index_single_prop(data_to_index,
                                             data_to_index['id'])
        # print "gazabpost Indexed Article Already Exists Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, -1)
    ...
    def test_index_art_chkdatafrmt(self):
        ...
        response = indexer.index_single_prop(data_to_index,
                                             data_to_index['id'])
        # print "gazabpost Indexed Article All Data Fields Not Present Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, -1)
    ...
    def test_ind_art_chkdatafrmt_extra(self):
        ...
        response = indexer.index_single_prop(data_to_index,
                                             data_to_index['id'])
        # print "gazabpost Indexed Article Extra Data Fields Present Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, 1)
    ...
    def test_art_chkfrmt_contentnotstr(self):
        ...
        response = indexer.index_single_prop(data_to_index,
                                             data_to_index['id'])
        # print "gazabpost Indexed Article datatype of Data Fields Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, -1)
    ...
    def test_ind_art_chkdatafrmt_date(self):
        ...
        response = indexer.index_single_prop(data_to_index,
                                             data_to_index['id'])
        # print "gazabpost Indexed Article Date Format Not proper Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, -1)
    ...
    def test_remove_article(self):
        ...
        # print "gazabpost Remove Article Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, 1)
    ...
    def test_remove_article_again(self):
        ...
        indexer = SearchIndexer(index_name)
        response = indexer.delete_doc(docid)
        # print "gazabpost Remove Article Which is not in es database Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, -1)
    ...
    def test_edit_article_2(self):
        ...
        # print "gazabpost Edited Article Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, 1)
    ...
    def test_edit_article_3(self):
        ...
        indexer = SearchIndexer(index_name)
        response = indexer.update_doc_prop(docid, data_to_update)
        # print "gazabpost Edited Article docid not present Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, -1)
    ...
    def test_edit_article_4(self):
        ...
        indexer = SearchIndexer(index_name)
        response = indexer.update_doc_prop(docid, data_to_update)
        # print "gazabpost Edited Article Missing field in data dict Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, -1)
    ...
    def test_edit_article_5(self):
        ...
        indexer = SearchIndexer(index_name)
        response = indexer.update_doc_prop(docid, data_to_update)
        # print "gazabpost Edited Article containing extra field Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, 1)
    ...
    def test_edit_article_6(self):
        ...
        indexer = SearchIndexer(index_name)
        response = indexer.update_doc_prop(docid, data_to_update)
        # print "gazabpost Edited Article containing content
    ...
    def test_edit_article_7(self):
        ...
        indexer = SearchIndexer(index_name)
        response = indexer.update_doc_prop(docid, data_to_update)
        # print "gazabpost Edited Article with improper date format Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, -1)
    ...
    def test_search_article_1(self):
        ...
        sorttype = 'score'
        response = functiontosearch(qvar, pgnum, searchtype, sorttype)
        # print "gazabpost Search Articles Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, 1)
    ...
    def test_mlt_response_1(self):
        ...
        # print "gazabpost MLT Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, 1)
