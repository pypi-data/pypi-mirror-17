...
ES_ANALYZER = {"analyzer":
               {ES_FULL_TEXT_ANALYZER: ES_FULL_TEXT_ANALYZER_RULES}}
...
ES_INDEX_MAPPING = {
    ...
    ES_CONTENT_DOC_TYPE: {
        ...
        'properties': {
            ...
            ES_FIELD_SWCATS: {
                'properties' : {
                    ES_FIELD_CAT_SLUG : {'type': 'string',\
                                         'store': True, 'index': 'not_analyzed'},
                    ES_FIELD_DIS_NAME : {'type': 'string', 'store': True,\
                                         "term_vector": "with_positions_offsets_payloads"}
                }
            },
            ...
            # ES_FIELD_DESCRIPTION: {'type': 'string', 'store': True,\
...
#ES_MLT_STOPWORDS = ["what", "where", "when", "is", "was", "for", "you",
#  "were", "are", "this", "that", "which", "the","a", "an" ]

ES_DICT_PROPERTIES = {'679a': 'vb_realtimeposts_alias', '53e4': 'swp_posts', 'f30a': 'gp_posts',\
                      '25rt': 'swp_realtimeposts_alias',\
                      'd90f': 'swp_realtimedrafts',\
                      's57v': 'gp_realtimeposts'} ###modified #vb_posts changed to vb_realtimeposts

ES_DICT_FIELD_PROPERTIES = {'679a': DEFAULT_FIELDS_DICT, '53e4': DEFAULT_SWP_FIELDS_DICT,\
                            'f30a': DEFAULT_FIELDS_DICT,\
                            '25rt': DEFAULT_SWP_FIELDS_DICT,\
                            'd90f': DEFAULT_SWP_FIELDS_DICT,\
                            's57v':DEFAULT_VB_FIELDS_DICT} ###modified
