'''
_author__ = 'chitraangi'

Originals contants defined
...
ES_INDEX_SETTINGS_ORIGINALS = {"analysis": ES_ANALYZER}
    ...
    ES_CONTENT_DOC_TYPE: {
        'properties': {
            ...
            ES_FIELD_TAGS:{'type': 'string', 'store': True,\
                           "term_vector": "with_positions_offsets_payloads"},
            ES_FIELD_AUTHOR_NAME:{'type': 'string', 'store': True,\
                                  "term_vector": "with_positions_offsets_payloads"},
            ES_FIELD_AUTHOR_URL:{'type': "string", 'store': True,\
                                 'null_value': 'na', 'index': 'not_analyzed'},
