...
from ..paginationspellcheck import functiontosearch_vb, findmltdocsprop

## the prop value for Vagabomb is 679a
PROP = '679a'
...
def function_to_get_id_cat_mlt():
    ...
    searchtype = ''
    sorttype = 'score'
    response = functiontosearch_vb(qvar, pgnum, searchtype, sorttype)

    return response['info']


class TestVagabomb(SearchDbTestCase):
    '''
    Vagabomb search test cases class
    '''
    ...
    def test_index_article(self):
        ...
        :return:
        '''
        data_to_index = {"id": "1694b6aa2d07dfc5072cb4bc",
                         "slug": "slug",
                         "ar_url": "ar_url",
                         "ar_name": "ar_name",
                         "content": "content",
        ...
        response = indexer.index_single_prop(data_to_index,
                                             data_to_index['id'])
        # print "Vagabomb Indexed Article Response: " + str(response)
    ...
    def test_index_article_exists(self):
        ...
        response = indexer.index_single_prop(data_to_index,
                                             data_to_index['id'])
        # print "Vagabomb Indexed Article Already Exists Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, -1)
    ...
    def test_index_art_chkdatafrmt(self):
        ...
        :return:
        '''
        data_to_index = {"id": "7694b6aa2d07dfc5072cb4bc",
                         "slug": "slug",
                         "ar_url": "ar_url",
                         "ar_name": "ar_name",
                         "content": "content",
        ...
        response = indexer.index_single_prop(data_to_index,
                                             data_to_index['id'])
        # print "Vagabomb Indexed Article All Data Fields Not Present Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, -1)
    ...
    def test_ind_art_chkdatafrmt_extra(self):
        ...
        response = indexer.index_single_prop(data_to_index,
                                             data_to_index['id'])
        # print "Vagabomb Indexed Article Extra Data Fields Present Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, 1)
    ...
    def test_art_chkfrmt_contentnotstr(self):
        ...
        response = indexer.index_single_prop(data_to_index,
                                             data_to_index['id'])
        # print "Vagabomb Indexed Article datatype of Data Fields Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, -1)
    ...
    def test_ind_art_chkdatafrmt_date(self):
        ...
        :return:
        '''
        data_to_index = {"id": "dateb6aa2d07dfc5072cb4bc",
                         "slug": "slug",
                         "ar_url": "ar_url",
                         "ar_name": "ar_name",
                         "content": "content",
        ...
        response = indexer.index_single_prop(data_to_index,
                                             data_to_index['id'])
        # print "Vagabomb Indexed Article Date Format Not proper Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, -1)
    ...
    def test_remove_article(self):
        ...
        :return:
        '''
        docid = '1694b6aa2d07dfc5072cb4bc'
        prop = PROP
        index_name = get_index_name(prop)
        indexer = SearchIndexer(index_name)
        response = indexer.delete_doc(docid)
        # print "Vagabomb Remove Article Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, 1)
    ...
    def test_remove_article_again(self):
        ...
        indexer = SearchIndexer(index_name)
        response = indexer.delete_doc(docid)
        # print "Vagabomb Remove Article Which is not in es database Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, -1)
    ...
    def test_edit_article_1(self):
        ...
        :return:
        '''
        data_to_index = {"id": "5694b6edit07dfc5072cb4bc",
                         "slug": "slug",
                         "ar_url": "ar_url",
                         "ar_name": "ar_name",
                         "content": "content",
    ...
    def test_edit_article_2(self):
        ...
        data_to_update = {"slug": "slug",
                          "ar_url": "ar_url",
                          "ar_name": "ar_name_edit",
                          "content": "content",
                          "tags": ["tags"],
                          "fImgUrl": "fImgurl_edit",
                          "title": "title",
                          "ar_id": "12",
                          "sh_heading": "123",
                          "pub_date": "June 04, 2015 13:39:33",
        ...
        # print "Vagabomb Edited Article Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, 1)
    ...
    def test_edit_article_3(self):
        ...
        indexer = SearchIndexer(index_name)
        response = indexer.update_doc_prop(docid, data_to_update)
        # print "Vagabomb Edited Article docid not present Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, -1)
    ...
    def test_edit_article_4(self):
        ...
        indexer = SearchIndexer(index_name)
        response = indexer.update_doc_prop(docid, data_to_update)
        # print "Vagabomb Edited Article Missing field in data dict Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, -1)
    ...
    def test_edit_article_5(self):
        ...
        indexer = SearchIndexer(index_name)
        response = indexer.update_doc_prop(docid, data_to_update)
        # print "Vagabomb Edited Article containing extra field Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, 1)
    ...
    def test_edit_article_6(self):
        ...
        indexer = SearchIndexer(index_name)
        response = indexer.update_doc_prop(docid, data_to_update)
        # print "Vagabomb Edited Article containing content
    ...
    def test_edit_article_7(self):
        ...
        indexer = SearchIndexer(index_name)
        response = indexer.update_doc_prop(docid, data_to_update)
        # print "Vagabomb Edited Article with improper date format Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, -1)
    ...
    def test_search_article_1(self):
        ...
        sorttype = 'score'
        response = functiontosearch_vb(qvar, pgnum, searchtype, sorttype)
        # print "Vagabomb Search Articles Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, 1)
    ...
    def test_mlt_response_1(self):
        ...
        # print xvar
        did = xvar['hits']['hits'][0]['_id']
        dcategory = xvar['hits']['hits'][0]['_source']['swcats'][0][
            'category_slug']
        ...
        # print "Vagabomb MLT Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, 1)
        ...
        try:
            for inf in xvar['hits']['hits']:
                ...
                if {'category_display': "NEWS",
                        'category_slug': "news"} in inf['_source']['swcats']:
                    newsart = inf['_id']
                    # print newsart
                    break
