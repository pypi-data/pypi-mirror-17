...
class TestOriginals(SearchDbTestCase):
    ...
    def test_index_art_chkdatafrmt(self):
        ...
        response = indexer.index_single_prop_originals(data_to_index,
                                                       data_to_index['id'])
        # print "scoopwhoop originals Indexed Article
        #  All Data Fields Not Present Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, -1)
    ...
    def test_ind_art_chkdatafrmt_extra(self):
        ...
        response = indexer.index_single_prop_originals(data_to_index,
                                                       data_to_index['id'])
        # print "scoopwhoop originals Indexed Article
        #  Extra Data Fields Present Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, 1)
    ...
    def test_art_chkfrmt_contentnotstr(self):
        ...
        response = indexer.index_single_prop_originals(data_to_index,
                                                       data_to_index['id'])
        # print "scoopwhoop originals Indexed Article
        #  datatype of Data Fields Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, -1)
    ...
    def test_ind_art_chkdatafrmt_date(self):
        ...
        response = indexer.index_single_prop_originals(data_to_index,
                                                       data_to_index['id'])
        # print "scoopwhoop originals Indexed Article
        #  Date Format Not proper Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, -1)
    ...
    def test_remove_article_again(self):
        ...
        indexer = SearchIndexerOriginals(index_name)
        response = indexer.delete_doc_originals(docid)
        # print "scoopwhoop originals Remove Article
        #  Which is not in es database Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, -1)
    ...
    def test_edit_article_2(self):
        ...
        # print "scoopwhoop originals Edited Article
        #  Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, 1)
    ...
    def test_edit_article_3(self):
        ...
        response = indexer.update_doc_prop_originals(docid, data_to_update)
        # print "scoopwhoop originals Edited Article
        #  docid not present Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, -1)

    #12 edit article info - es (data dict -
    # missing field sent (ex : fImgUrl), docid exists)
    def test_edit_article_4(self):
        ...
        response = indexer.update_doc_prop_originals(docid, data_to_update)
        # print "scoopwhoop originals Edited Article
        #  Missing field in data dict Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, -1)
    ...
    def test_edit_article_5(self):
        ...
        response = indexer.update_doc_prop_originals(docid, data_to_update)
        # print "scoopwhoop originals Edited Article
        #  containing extra field Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, 1)

    #14 edit article info - es (the datatype of fields
    # of data variable - ex: content:string,
    # category:nested object, docid exists)
    ...
    def test_edit_article_7(self):
        ...
        response = indexer.update_doc_prop_originals(docid, data_to_update)
        # print "scoopwhoop originals Edited Article
        #  with improper date format Response: " + str(response)
        stats = response['status']
        self.assertIsNotNone(response)
        self.assertEqual(stats, -1)
    ...
    def test_search_article_1(self):
        ...
        searchtype = ''
        sorttype = 'score'
        response = functiontosearch_originals(qvar, pgnum, searchtype,
                                              sorttype)
