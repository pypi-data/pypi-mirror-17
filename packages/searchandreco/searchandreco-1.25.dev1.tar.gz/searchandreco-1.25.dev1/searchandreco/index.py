...
from .sportscrumbs_index import IndexSport, SearchSport,\
    SuggestSport
...
class IndexExists:
    ...
    def GET(self):
        ...
        LOGGER_SEARCH.warning("exists response " + response)
...
class CreateIndex:
    ...
    def POST(self):
        ...
        LOGGER_SEARCH.warning("i come in createindex")
        LOGGER_SEARCH.warning("data ius ", web.input())
        ...
        LOGGER_SEARCH.info("index name is " + index_name)
...
class SearchSWUserFacing:
    ...
    def GET(self):
        ...
        response = functiontosearch(data.q, data.pn, data.searchtype,
                                    data.sorttype)
        #print response
        web.header('Access-Control-Allow-Origin', '*')
        web.header('Access-Control-Allow-Credentials', 'true')
...
class SearchVBUserFacing:
    ...
    def GET(self):
        ...
        data = web.input(q='', pn=1, searchtype='', sorttype='score')
        response = functiontosearch_vb(data.q, data.pn, data.searchtype,
                                       data.sorttype)
        #print response
        web.header('Access-Control-Allow-Origin', '*')
        web.header('Access-Control-Allow-Credentials', 'true')
...
class SearchGPUserFacing:
    ...
    def GET(self):
        ...
        data = web.input(q='', pn=1, searchtype='', sorttype='score')
        response = functiontosearch_gp(data.q, data.pn, data.searchtype,
                                       data.sorttype)
        #print response
        web.header('Access-Control-Allow-Origin', '*')
        web.header('Access-Control-Allow-Credentials', 'true')
