...
logging.basicConfig(filename=GP_SUB_LOG_FILE_NAME, level=logging.WARNING)
  ...
  while True:
    ...
    for msg in sub.listen():
        ...
        if(msg['data'] != 1):
            ...
            ## remove the id from the document ## TODO: test this
            del(es_doc[ES_DOC_ID])
