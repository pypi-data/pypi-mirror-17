...
def get_info(name):
    ...
    with open(os.path.join(basedir, 'confpages/__init__.py')) as f:
        locals = {}
        exec(f.read(), locals)
        return locals[name]
