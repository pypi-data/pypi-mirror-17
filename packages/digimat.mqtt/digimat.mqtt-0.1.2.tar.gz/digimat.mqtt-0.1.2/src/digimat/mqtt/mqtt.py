...
class MQTTItem(object):
    ...
    def signalUpdate(self):
        print "TODO: signalupdate (%s)" % self.payload.data
...
class MQTTPublisherItem(MQTTItem):
    def __init__(self, client, topic, qos=0, retain=False, payload=None):
        super(MQTTPublisherItem, self).__init__(client, topic, qos, retain, payload)
        self._isPublisher=True
        self._isSubscriber=False


class MQTTSubscriberItem(MQTTItem):
    def __init__(self, client, topic, qos=0, retain=False, payload=None):
        super(MQTTPublisherItem, self).__init__(client, topic, qos, retain, payload)
        self._isPublisher=False
...
class MQTTClient(object):
    ...
    def signalItemPendingManager(self, item):
        try:
            ...
            self.logger.exception('signalItemPendingManager')
            pass
