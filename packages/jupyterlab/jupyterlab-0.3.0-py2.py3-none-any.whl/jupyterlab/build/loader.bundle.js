...
/***/ function(module, exports, __webpack_require__) {
	...
	var ModuleLoader = __webpack_require__(1).ModuleLoader;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Distributed under the terms of the Modified BSD License.
	"use strict";
	var semver_1 = __webpack_require__(2);
	/**
	...
	var ModuleLoader = (function () {
	    ...
	    ModuleLoader.prototype._findMatch = function (path) {
	        ...
	        var source = this._parsePath(path);
	        if (!source) {
	        ...
	        for (var _i = 0, modules_1 = modules; _i < modules_1.length; _i++) {
	            ...
	            var target = this._parsePath(mod);
	            if (!target) {
	                continue;
	            }
	        ...
	        var index = 0;
	        if (matches.length > 1) {
	            var best = semver_1.maxSatisfying(versions, source.version);
	            if (!best) {
