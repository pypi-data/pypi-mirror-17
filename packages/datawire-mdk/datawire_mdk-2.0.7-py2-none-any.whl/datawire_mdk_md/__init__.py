# Quark 1.0.406 run at 2016-08-31 18:38:45.160124
...
class mdk_MDK(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).methods = _List([mdk_MDK_start_Method(), mdk_MDK_stop_Method(), mdk_MDK_register_Method(), mdk_MDK_session_Method(), mdk_MDK_join_Method()])
...
class mdk_MDKImpl(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.String", u"CONTEXT_HEADER"), quark.reflect.Field(u"quark.Logger", u"logger"), quark.reflect.Field(u"mdk_runtime.MDKRuntime", u"_runtime"), quark.reflect.Field(u"mdk_discovery.Discovery", u"_disco"), quark.reflect.Field(u"mdk_discovery.DiscoverySource", u"_discoSource"), quark.reflect.Field(u"mdk_tracing.Tracer", u"_tracer"), quark.reflect.Field(u"quark.String", u"procUUID"), quark.reflect.Field(u"quark.bool", u"_running")])
        (self).methods = _List([mdk_MDKImpl_getDiscoveryFactory_Method(), mdk_MDKImpl__timeout_Method(), mdk_MDKImpl_start_Method(), mdk_MDKImpl_stop_Method(), mdk_MDKImpl_register_Method(), mdk_MDKImpl_session_Method(), mdk_MDKImpl_join_Method()])
        (self).parents = _List([u"quark.Object"])
...
class mdk_SessionImpl_get_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_SessionImpl_get_Method, self).__init__(u"quark.Object", u"get", _List([u"quark.String"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk.SessionImpl);
        return (obj).get(_cast((args)[0], lambda: unicode))
...
class mdk_SessionImpl_set_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_SessionImpl_set_Method, self).__init__(u"quark.void", u"set", _List([u"quark.String", u"quark.Object"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk.SessionImpl);
        (obj).set(_cast((args)[0], lambda: unicode), (args)[1]);
        return None
...
class mdk_SessionImpl_has_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_SessionImpl_has_Method, self).__init__(u"quark.bool", u"has", _List([u"quark.String"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk.SessionImpl);
        return (obj).has(_cast((args)[0], lambda: unicode))
...
class quark_mock_MockRuntime_advanceClock_Method(quark.reflect.Method):
    ...
    def invoke(self, object, args):
        obj = _cast(object, lambda: quark.mock.MockRuntime);
        (obj).advanceClock(_cast((args)[0], lambda: long));
        return None
...
class mdk_runtime_QuarkRuntimeWSActor(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.Logger", u"logger"), quark.reflect.Field(u"quark.WebSocket", u"socket"), quark.reflect.Field(u"mdk_runtime.promise.PromiseResolver", u"factory"), quark.reflect.Field(u"mdk_runtime.actors.Actor", u"originator"), quark.reflect.Field(u"mdk_runtime.actors.MessageDispatcher", u"dispatcher"), quark.reflect.Field(u"quark.String", u"state")])
        (self).methods = _List([mdk_runtime_QuarkRuntimeWSActor_onStart_Method(), mdk_runtime_QuarkRuntimeWSActor_onMessage_Method(), mdk_runtime_QuarkRuntimeWSActor_onWSConnected_Method(), mdk_runtime_QuarkRuntimeWSActor_onWSError_Method(), mdk_runtime_QuarkRuntimeWSActor_onWSMessage_Method(), mdk_runtime_QuarkRuntimeWSActor_onWSFinal_Method(), mdk_runtime_QuarkRuntimeWSActor_onStop_Method(), mdk_runtime_QuarkRuntimeWSActor_onWSInit_Method(), mdk_runtime_QuarkRuntimeWSActor_onWSBinary_Method(), mdk_runtime_QuarkRuntimeWSActor_onWSClosed_Method()])
        (self).parents = _List([u"quark.Object"])

    def construct(self, args):
        return mdk_runtime.QuarkRuntimeWSActor(_cast((args)[0], lambda: mdk_runtime.actors.Actor), _cast((args)[1], lambda: mdk_runtime.promise.PromiseResolver))
...
class mdk_runtime_FakeTime(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.float", u"_now"), quark.reflect.Field(u"quark.Map<quark.long,mdk_runtime._FakeTimeRequest>", u"_scheduled"), quark.reflect.Field(u"mdk_runtime.actors.MessageDispatcher", u"dispatcher")])
...
class mdk_discovery_protocol_DiscoClientFactory(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.String", u"token")])
    ...
    def construct(self, args):
        return mdk_discovery.protocol.DiscoClientFactory(_cast((args)[0], lambda: unicode))
...
class mdk_discovery_protocol_DiscoClient_url_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoClient_url_Method, self).__init__(u"quark.String", u"url", _List([]));
...
class mdk_discovery_protocol_DiscoClient_token_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoClient_token_Method, self).__init__(u"quark.String", u"token", _List([]));
...
class mdk_discovery_protocol_DiscoClient_isStarted_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoClient_isStarted_Method, self).__init__(u"quark.bool", u"isStarted", _List([]));
...
class mdk_discovery_protocol_DiscoClient_onClear_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoClient_onClear_Method, self).__init__(u"quark.void", u"onClear", _List([u"mdk_discovery.protocol.Clear"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_discovery.protocol.DiscoClient);
        (obj).onClear(_cast((args)[0], lambda: mdk_discovery.protocol.Clear));
        return None
...
class mdk_discovery_protocol_DiscoClient_startup_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoClient_startup_Method, self).__init__(u"quark.void", u"startup", _List([]));
...
class mdk_discovery_protocol_DiscoClient_onWSMessage_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoClient_onWSMessage_Method, self).__init__(u"quark.void", u"onWSMessage", _List([u"quark.String"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_discovery.protocol.DiscoClient);
        (obj).onWSMessage(_cast((args)[0], lambda: unicode));
        return None
...
class mdk_discovery_protocol_DiscoClient_isConnected_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoClient_isConnected_Method, self).__init__(u"quark.bool", u"isConnected", _List([]));
...
class mdk_discovery_protocol_DiscoClient_schedule_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoClient_schedule_Method, self).__init__(u"quark.void", u"schedule", _List([u"quark.float"]));
...
class mdk_discovery_protocol_DiscoClient_scheduleReconnect_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoClient_scheduleReconnect_Method, self).__init__(u"quark.void", u"scheduleReconnect", _List([]));
...
class mdk_discovery_protocol_DiscoClient_onOpen_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoClient_onOpen_Method, self).__init__(u"quark.void", u"onOpen", _List([u"mdk_protocol.Open"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_discovery.protocol.DiscoClient);
        (obj).onOpen(_cast((args)[0], lambda: mdk_protocol.Open));
        return None
...
class mdk_discovery_protocol_DiscoClient_doBackoff_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoClient_doBackoff_Method, self).__init__(u"quark.void", u"doBackoff", _List([]));
...
class mdk_discovery_protocol_DiscoClient_onClose_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoClient_onClose_Method, self).__init__(u"quark.void", u"onClose", _List([u"mdk_protocol.Close"]));
...
class mdk_discovery_protocol_DiscoClient_onScheduledEvent_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoClient_onScheduledEvent_Method, self).__init__(u"quark.void", u"onScheduledEvent", _List([]));
...
class mdk_discovery_protocol_DiscoClient_doOpen_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoClient_doOpen_Method, self).__init__(u"quark.void", u"doOpen", _List([]));
...
class mdk_discovery_protocol_DiscoClient_doHeartbeat_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoClient_doHeartbeat_Method, self).__init__(u"quark.void", u"doHeartbeat", _List([]));
...
class mdk_discovery_protocol_DiscoClient_open_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoClient_open_Method, self).__init__(u"quark.void", u"open", _List([u"quark.String"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_discovery.protocol.DiscoClient);
        (obj).open(_cast((args)[0], lambda: unicode));
        return None
...
class mdk_discovery_protocol_DiscoClient_pump_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoClient_pump_Method, self).__init__(u"quark.void", u"pump", _List([]));
...
class mdk_discovery_protocol_DiscoClient_onWSConnected_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_discovery_protocol_DiscoClient_onWSConnected_Method, self).__init__(u"quark.void", u"onWSConnected", _List([u"mdk_runtime.WSActor"]));
...
class mdk_discovery_protocol_DiscoClient_onWSError_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoClient_onWSError_Method, self).__init__(u"quark.void", u"onWSError", _List([u"quark.error.Error"]));
...
class mdk_discovery_protocol_DiscoClient_onWSClosed_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoClient_onWSClosed_Method, self).__init__(u"quark.void", u"onWSClosed", _List([]));
...
class mdk_discovery_protocol_DiscoClient(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.Logger", u"logger"), quark.reflect.Field(u"quark.float", u"firstDelay"), quark.reflect.Field(u"quark.float", u"maxDelay"), quark.reflect.Field(u"quark.float", u"reconnectDelay"), quark.reflect.Field(u"quark.float", u"ttl"), quark.reflect.Field(u"quark.float", u"tick"), quark.reflect.Field(u"mdk_runtime.WSActor", u"sock"), quark.reflect.Field(u"quark.String", u"sockUrl"), quark.reflect.Field(u"quark.long", u"lastConnectAttempt"), quark.reflect.Field(u"quark.long", u"lastHeartbeat"), quark.reflect.Field(u"mdk_runtime.Time", u"timeService"), quark.reflect.Field(u"mdk_runtime.actors.Actor", u"schedulingActor"), quark.reflect.Field(u"mdk_runtime.WebSockets", u"websockets"), quark.reflect.Field(u"mdk_runtime.actors.MessageDispatcher", u"dispatcher"), quark.reflect.Field(u"quark.bool", u"_started"), quark.reflect.Field(u"quark.String", u"_token"), quark.reflect.Field(u"quark.String", u"_url"), quark.reflect.Field(u"mdk_discovery.FailurePolicyFactory", u"_failurePolicyFactory"), quark.reflect.Field(u"mdk_runtime.actors.MessageDispatcher", u"_dispatcher"), quark.reflect.Field(u"mdk_runtime.actors.Actor", u"_subscriber"), quark.reflect.Field(u"quark.Map<quark.String,mdk_discovery.Cluster>", u"registered"), quark.reflect.Field(u"quark.Logger", u"dlog")])
        (self).methods = _List([mdk_discovery_protocol_DiscoClient_onStart_Method(), mdk_discovery_protocol_DiscoClient_onStop_Method(), mdk_discovery_protocol_DiscoClient_onMessage_Method(), mdk_discovery_protocol_DiscoClient_url_Method(), mdk_discovery_protocol_DiscoClient_token_Method(), mdk_discovery_protocol_DiscoClient_isStarted_Method(), mdk_discovery_protocol_DiscoClient__register_Method(), mdk_discovery_protocol_DiscoClient_active_Method(), mdk_discovery_protocol_DiscoClient_expire_Method(), mdk_discovery_protocol_DiscoClient_resolve_Method(), mdk_discovery_protocol_DiscoClient_onActive_Method(), mdk_discovery_protocol_DiscoClient_onExpire_Method(), mdk_discovery_protocol_DiscoClient_onClear_Method(), mdk_discovery_protocol_DiscoClient_startup_Method(), mdk_discovery_protocol_DiscoClient_heartbeat_Method(), mdk_discovery_protocol_DiscoClient_shutdown_Method(), mdk_discovery_protocol_DiscoClient_onWSMessage_Method(), mdk_discovery_protocol_DiscoClient_isConnected_Method(), mdk_discovery_protocol_DiscoClient_schedule_Method(), mdk_discovery_protocol_DiscoClient_scheduleReconnect_Method(), mdk_discovery_protocol_DiscoClient_onOpen_Method(), mdk_discovery_protocol_DiscoClient_doBackoff_Method(), mdk_discovery_protocol_DiscoClient_onClose_Method(), mdk_discovery_protocol_DiscoClient_onScheduledEvent_Method(), mdk_discovery_protocol_DiscoClient_doOpen_Method(), mdk_discovery_protocol_DiscoClient_doHeartbeat_Method(), mdk_discovery_protocol_DiscoClient_open_Method(), mdk_discovery_protocol_DiscoClient_pump_Method(), mdk_discovery_protocol_DiscoClient_onWSConnected_Method(), mdk_discovery_protocol_DiscoClient_onWSError_Method(), mdk_discovery_protocol_DiscoClient_onWSClosed_Method()])
        (self).parents = _List([u"mdk_protocol.WSClient"])

    def construct(self, args):
        return mdk_discovery.protocol.DiscoClient(_cast((args)[0], lambda: mdk_runtime.actors.Actor), _cast((args)[1], lambda: unicode), _cast((args)[2], lambda: unicode), _cast((args)[3], lambda: mdk_runtime.MDKRuntime))
...
class mdk_discovery_protocol_DiscoHandler_onActive_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoHandler_onActive_Method, self).__init__(u"quark.void", u"onActive", _List([u"mdk_discovery.protocol.Active"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_discovery.protocol.DiscoHandler);
        (obj).onActive(_cast((args)[0], lambda: mdk_discovery.protocol.Active));
        return None
...
class mdk_discovery_protocol_DiscoHandler_onExpire_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoHandler_onExpire_Method, self).__init__(u"quark.void", u"onExpire", _List([u"mdk_discovery.protocol.Expire"]));
...
class mdk_discovery_protocol_DiscoHandler_onClear_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoHandler_onClear_Method, self).__init__(u"quark.void", u"onClear", _List([u"mdk_discovery.protocol.Clear"]));
...
class mdk_discovery_protocol_DiscoHandler_onOpen_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoHandler_onOpen_Method, self).__init__(u"quark.void", u"onOpen", _List([u"mdk_protocol.Open"]));
...
class mdk_discovery_protocol_DiscoHandler_onClose_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoHandler_onClose_Method, self).__init__(u"quark.void", u"onClose", _List([u"mdk_protocol.Close"]));
...
class mdk_discovery_protocol_DiscoHandler(quark.reflect.Class):
    def _init(self):
        quark.reflect.Class._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoHandler, self).__init__(u"mdk_discovery.protocol.DiscoHandler");
        (self).name = u"mdk_discovery.protocol.DiscoHandler"
        (self).parameters = _List([])
        (self).fields = _List([])
        (self).methods = _List([mdk_discovery_protocol_DiscoHandler_onActive_Method(), mdk_discovery_protocol_DiscoHandler_onExpire_Method(), mdk_discovery_protocol_DiscoHandler_onClear_Method(), mdk_discovery_protocol_DiscoHandler_onOpen_Method(), mdk_discovery_protocol_DiscoHandler_onClose_Method()])
        (self).parents = _List([u"quark.Object"])
    ...
    def _setField(self, name, value):
        pass
mdk_discovery_protocol_DiscoHandler.singleton = mdk_discovery_protocol_DiscoHandler()
class mdk_discovery_protocol_DiscoveryEvent_construct_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoveryEvent_construct_Method, self).__init__(u"mdk_protocol.ProtocolEvent", u"construct", _List([u"quark.String"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_discovery.protocol.DiscoveryEvent);
        return mdk_discovery.protocol.DiscoveryEvent.construct(_cast((args)[0], lambda: unicode))
...
class mdk_discovery_protocol_DiscoveryEvent_decode_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoveryEvent_decode_Method, self).__init__(u"mdk_protocol.ProtocolEvent", u"decode", _List([u"quark.String"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_discovery.protocol.DiscoveryEvent);
        return mdk_discovery.protocol.DiscoveryEvent.decode(_cast((args)[0], lambda: unicode))
...
class mdk_discovery_protocol_DiscoveryEvent_dispatch_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoveryEvent_dispatch_Method, self).__init__(u"quark.void", u"dispatch", _List([u"mdk_protocol.ProtocolHandler"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_discovery.protocol.DiscoveryEvent);
        (obj).dispatch(_cast((args)[0], lambda: mdk_protocol.ProtocolHandler));
        return None
...
class mdk_discovery_protocol_DiscoveryEvent_dispatchDiscoveryEvent_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoveryEvent_dispatchDiscoveryEvent_Method, self).__init__(u"quark.void", u"dispatchDiscoveryEvent", _List([u"mdk_discovery.protocol.DiscoHandler"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_discovery.protocol.DiscoveryEvent);
        (obj).dispatchDiscoveryEvent(_cast((args)[0], lambda: mdk_discovery.protocol.DiscoHandler));
        return None
...
class mdk_discovery_protocol_DiscoveryEvent_decodeClass_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoveryEvent_decodeClass_Method, self).__init__(u"mdk_protocol.Serializable", u"decodeClass", _List([u"quark.reflect.Class", u"quark.String"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_discovery.protocol.DiscoveryEvent);
        return mdk_protocol.Serializable.decodeClass(_cast((args)[0], lambda: quark.reflect.Class), _cast((args)[1], lambda: unicode))
...
class mdk_discovery_protocol_DiscoveryEvent_decodeClassName_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoveryEvent_decodeClassName_Method, self).__init__(u"mdk_protocol.Serializable", u"decodeClassName", _List([u"quark.String", u"quark.String"]));
...
class mdk_discovery_protocol_DiscoveryEvent_encode_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoveryEvent_encode_Method, self).__init__(u"quark.String", u"encode", _List([]));
...
class mdk_discovery_protocol_DiscoveryEvent(quark.reflect.Class):
    def _init(self):
        quark.reflect.Class._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_DiscoveryEvent, self).__init__(u"mdk_discovery.protocol.DiscoveryEvent");
        (self).name = u"mdk_discovery.protocol.DiscoveryEvent"
        (self).parameters = _List([])
        (self).fields = _List([])
        (self).methods = _List([mdk_discovery_protocol_DiscoveryEvent_construct_Method(), mdk_discovery_protocol_DiscoveryEvent_decode_Method(), mdk_discovery_protocol_DiscoveryEvent_dispatch_Method(), mdk_discovery_protocol_DiscoveryEvent_dispatchDiscoveryEvent_Method(), mdk_discovery_protocol_DiscoveryEvent_decodeClass_Method(), mdk_discovery_protocol_DiscoveryEvent_decodeClassName_Method(), mdk_discovery_protocol_DiscoveryEvent_encode_Method()])
        (self).parents = _List([u"mdk_protocol.ProtocolEvent"])
    ...
    def _setField(self, name, value):
        pass
mdk_discovery_protocol_DiscoveryEvent.singleton = mdk_discovery_protocol_DiscoveryEvent()
class mdk_discovery_protocol_Active_dispatchDiscoveryEvent_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_Active_dispatchDiscoveryEvent_Method, self).__init__(u"quark.void", u"dispatchDiscoveryEvent", _List([u"mdk_discovery.protocol.DiscoHandler"]));
...
class mdk_discovery_protocol_Active_construct_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_Active_construct_Method, self).__init__(u"mdk_protocol.ProtocolEvent", u"construct", _List([u"quark.String"]));
...
class mdk_discovery_protocol_Active_decode_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_Active_decode_Method, self).__init__(u"mdk_protocol.ProtocolEvent", u"decode", _List([u"quark.String"]));
...
class mdk_discovery_protocol_Active_dispatch_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_Active_dispatch_Method, self).__init__(u"quark.void", u"dispatch", _List([u"mdk_protocol.ProtocolHandler"]));
...
class mdk_discovery_protocol_Active_decodeClass_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_Active_decodeClass_Method, self).__init__(u"mdk_protocol.Serializable", u"decodeClass", _List([u"quark.reflect.Class", u"quark.String"]));
...
class mdk_discovery_protocol_Active(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"mdk_protocol.Discriminator", u"_discriminator"), quark.reflect.Field(u"mdk_discovery.Node", u"node"), quark.reflect.Field(u"quark.float", u"ttl")])
        (self).methods = _List([mdk_discovery_protocol_Active_dispatchDiscoveryEvent_Method(), mdk_discovery_protocol_Active_construct_Method(), mdk_discovery_protocol_Active_decode_Method(), mdk_discovery_protocol_Active_dispatch_Method(), mdk_discovery_protocol_Active_decodeClass_Method(), mdk_discovery_protocol_Active_decodeClassName_Method(), mdk_discovery_protocol_Active_encode_Method()])
        (self).parents = _List([u"mdk_discovery.protocol.DiscoveryEvent"])
...
class mdk_discovery_protocol_Expire_dispatchDiscoveryEvent_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_Expire_dispatchDiscoveryEvent_Method, self).__init__(u"quark.void", u"dispatchDiscoveryEvent", _List([u"mdk_discovery.protocol.DiscoHandler"]));
...
class mdk_discovery_protocol_Expire_construct_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_Expire_construct_Method, self).__init__(u"mdk_protocol.ProtocolEvent", u"construct", _List([u"quark.String"]));
...
class mdk_discovery_protocol_Expire_decode_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_Expire_decode_Method, self).__init__(u"mdk_protocol.ProtocolEvent", u"decode", _List([u"quark.String"]));
...
class mdk_discovery_protocol_Expire_dispatch_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_Expire_dispatch_Method, self).__init__(u"quark.void", u"dispatch", _List([u"mdk_protocol.ProtocolHandler"]));
...
class mdk_discovery_protocol_Expire_decodeClass_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_Expire_decodeClass_Method, self).__init__(u"mdk_protocol.Serializable", u"decodeClass", _List([u"quark.reflect.Class", u"quark.String"]));
...
class mdk_discovery_protocol_Expire(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"mdk_protocol.Discriminator", u"_discriminator"), quark.reflect.Field(u"mdk_discovery.Node", u"node")])
        (self).methods = _List([mdk_discovery_protocol_Expire_dispatchDiscoveryEvent_Method(), mdk_discovery_protocol_Expire_construct_Method(), mdk_discovery_protocol_Expire_decode_Method(), mdk_discovery_protocol_Expire_dispatch_Method(), mdk_discovery_protocol_Expire_decodeClass_Method(), mdk_discovery_protocol_Expire_decodeClassName_Method(), mdk_discovery_protocol_Expire_encode_Method()])
        (self).parents = _List([u"mdk_discovery.protocol.DiscoveryEvent"])
...
class mdk_discovery_protocol_Clear_dispatchDiscoveryEvent_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_Clear_dispatchDiscoveryEvent_Method, self).__init__(u"quark.void", u"dispatchDiscoveryEvent", _List([u"mdk_discovery.protocol.DiscoHandler"]));
...
class mdk_discovery_protocol_Clear_construct_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_Clear_construct_Method, self).__init__(u"mdk_protocol.ProtocolEvent", u"construct", _List([u"quark.String"]));
...
class mdk_discovery_protocol_Clear_decode_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_Clear_decode_Method, self).__init__(u"mdk_protocol.ProtocolEvent", u"decode", _List([u"quark.String"]));
...
class mdk_discovery_protocol_Clear_dispatch_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_Clear_dispatch_Method, self).__init__(u"quark.void", u"dispatch", _List([u"mdk_protocol.ProtocolHandler"]));
...
class mdk_discovery_protocol_Clear_decodeClass_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_discovery_protocol_Clear_decodeClass_Method, self).__init__(u"mdk_protocol.Serializable", u"decodeClass", _List([u"quark.reflect.Class", u"quark.String"]));
...
class mdk_discovery_protocol_Clear(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"mdk_protocol.Discriminator", u"_discriminator")])
        (self).methods = _List([mdk_discovery_protocol_Clear_dispatchDiscoveryEvent_Method(), mdk_discovery_protocol_Clear_construct_Method(), mdk_discovery_protocol_Clear_decode_Method(), mdk_discovery_protocol_Clear_dispatch_Method(), mdk_discovery_protocol_Clear_decodeClass_Method(), mdk_discovery_protocol_Clear_decodeClassName_Method(), mdk_discovery_protocol_Clear_encode_Method()])
        (self).parents = _List([u"mdk_discovery.protocol.DiscoveryEvent"])
...
class mdk_protocol_Discriminator_matches_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_Discriminator_matches_Method, self).__init__(u"quark.bool", u"matches", _List([u"quark.String"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_protocol.Discriminator);
        return (obj).matches(_cast((args)[0], lambda: unicode))
...
class mdk_protocol_Discriminator(quark.reflect.Class):
    def _init(self):
        quark.reflect.Class._init(self)

    def __init__(self):
        super(mdk_protocol_Discriminator, self).__init__(u"mdk_protocol.Discriminator");
        (self).name = u"mdk_protocol.Discriminator"
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.List<quark.String>", u"values")])
        (self).methods = _List([mdk_protocol_Discriminator_matches_Method()])
        (self).parents = _List([u"quark.Object"])

    def construct(self, args):
        return mdk_protocol.Discriminator(_cast((args)[0], lambda: _List))
    ...
    def _setField(self, name, value):
        pass
mdk_protocol_Discriminator.singleton = mdk_protocol_Discriminator()
class mdk_protocol_Serializable_decodeClass_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_Serializable_decodeClass_Method, self).__init__(u"mdk_protocol.Serializable", u"decodeClass", _List([u"quark.reflect.Class", u"quark.String"]));
...
class mdk_protocol_Serializable(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([])
        (self).methods = _List([mdk_protocol_Serializable_decodeClass_Method(), mdk_protocol_Serializable_decodeClassName_Method(), mdk_protocol_Serializable_encode_Method()])
        (self).parents = _List([u"quark.Object"])
...
class mdk_protocol_LamportClock_decodeClass_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_LamportClock_decodeClass_Method, self).__init__(u"mdk_protocol.Serializable", u"decodeClass", _List([u"quark.reflect.Class", u"quark.String"]));
...
class mdk_protocol_LamportClock(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).methods = _List([mdk_protocol_LamportClock_decode_Method(), mdk_protocol_LamportClock_key_Method(), mdk_protocol_LamportClock_toString_Method(), mdk_protocol_LamportClock_enter_Method(), mdk_protocol_LamportClock_leave_Method(), mdk_protocol_LamportClock_tick_Method(), mdk_protocol_LamportClock_decodeClass_Method(), mdk_protocol_LamportClock_decodeClassName_Method(), mdk_protocol_LamportClock_encode_Method()])
...
class mdk_protocol_SharedContext_decodeClass_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_SharedContext_decodeClass_Method, self).__init__(u"mdk_protocol.Serializable", u"decodeClass", _List([u"quark.reflect.Class", u"quark.String"]));
...
class mdk_protocol_ProtocolHandler_onOpen_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_ProtocolHandler_onOpen_Method, self).__init__(u"quark.void", u"onOpen", _List([u"mdk_protocol.Open"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_protocol.ProtocolHandler);
        (obj).onOpen(_cast((args)[0], lambda: mdk_protocol.Open));
        return None
...
class mdk_protocol_ProtocolHandler_onClose_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_ProtocolHandler_onClose_Method, self).__init__(u"quark.void", u"onClose", _List([u"mdk_protocol.Close"]));
...
class mdk_protocol_ProtocolHandler(quark.reflect.Class):
    def _init(self):
        quark.reflect.Class._init(self)

    def __init__(self):
        super(mdk_protocol_ProtocolHandler, self).__init__(u"mdk_protocol.ProtocolHandler");
        (self).name = u"mdk_protocol.ProtocolHandler"
        (self).parameters = _List([])
        (self).fields = _List([])
        (self).methods = _List([mdk_protocol_ProtocolHandler_onOpen_Method(), mdk_protocol_ProtocolHandler_onClose_Method()])
        (self).parents = _List([u"quark.Object"])
    ...
    def _setField(self, name, value):
        pass
mdk_protocol_ProtocolHandler.singleton = mdk_protocol_ProtocolHandler()
class mdk_protocol_ProtocolEvent_construct_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_ProtocolEvent_construct_Method, self).__init__(u"mdk_protocol.ProtocolEvent", u"construct", _List([u"quark.String"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_protocol.ProtocolEvent);
        return mdk_protocol.ProtocolEvent.construct(_cast((args)[0], lambda: unicode))
...
class mdk_protocol_ProtocolEvent_dispatch_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_ProtocolEvent_dispatch_Method, self).__init__(u"quark.void", u"dispatch", _List([u"mdk_protocol.ProtocolHandler"]));
...
class mdk_protocol_ProtocolEvent_decodeClass_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_ProtocolEvent_decodeClass_Method, self).__init__(u"mdk_protocol.Serializable", u"decodeClass", _List([u"quark.reflect.Class", u"quark.String"]));
...
class mdk_protocol_ProtocolEvent_decodeClassName_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_ProtocolEvent_decodeClassName_Method, self).__init__(u"mdk_protocol.Serializable", u"decodeClassName", _List([u"quark.String", u"quark.String"]));
...
class mdk_protocol_ProtocolEvent_encode_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_ProtocolEvent_encode_Method, self).__init__(u"quark.String", u"encode", _List([]));
...
class mdk_protocol_ProtocolEvent(quark.reflect.Class):
    def _init(self):
        quark.reflect.Class._init(self)

    def __init__(self):
        super(mdk_protocol_ProtocolEvent, self).__init__(u"mdk_protocol.ProtocolEvent");
        (self).name = u"mdk_protocol.ProtocolEvent"
        (self).parameters = _List([])
        (self).fields = _List([])
        (self).methods = _List([mdk_protocol_ProtocolEvent_construct_Method(), mdk_protocol_ProtocolEvent_dispatch_Method(), mdk_protocol_ProtocolEvent_decodeClass_Method(), mdk_protocol_ProtocolEvent_decodeClassName_Method(), mdk_protocol_ProtocolEvent_encode_Method()])
        (self).parents = _List([u"mdk_protocol.Serializable"])
    ...
    def _setField(self, name, value):
        pass
mdk_protocol_ProtocolEvent.singleton = mdk_protocol_ProtocolEvent()
class mdk_protocol_Open_dispatch_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_Open_dispatch_Method, self).__init__(u"quark.void", u"dispatch", _List([u"mdk_protocol.ProtocolHandler"]));
...
class mdk_protocol_Open_construct_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_Open_construct_Method, self).__init__(u"mdk_protocol.ProtocolEvent", u"construct", _List([u"quark.String"]));
...
class mdk_protocol_Open_decodeClass_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_Open_decodeClass_Method, self).__init__(u"mdk_protocol.Serializable", u"decodeClass", _List([u"quark.reflect.Class", u"quark.String"]));
...
class mdk_protocol_Open(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"mdk_protocol.Discriminator", u"_discriminator"), quark.reflect.Field(u"quark.String", u"version"), quark.reflect.Field(u"quark.Map<quark.String,quark.String>", u"properties")])
        (self).methods = _List([mdk_protocol_Open_dispatch_Method(), mdk_protocol_Open_construct_Method(), mdk_protocol_Open_decodeClass_Method(), mdk_protocol_Open_decodeClassName_Method(), mdk_protocol_Open_encode_Method()])
        (self).parents = _List([u"mdk_protocol.ProtocolEvent"])
...
class mdk_protocol_Close_dispatch_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_Close_dispatch_Method, self).__init__(u"quark.void", u"dispatch", _List([u"mdk_protocol.ProtocolHandler"]));
...
class mdk_protocol_Close_construct_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_Close_construct_Method, self).__init__(u"mdk_protocol.ProtocolEvent", u"construct", _List([u"quark.String"]));
...
class mdk_protocol_Close_decodeClass_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_Close_decodeClass_Method, self).__init__(u"mdk_protocol.Serializable", u"decodeClass", _List([u"quark.reflect.Class", u"quark.String"]));
...
class mdk_protocol_Close(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"mdk_protocol.Discriminator", u"_discriminator"), quark.reflect.Field(u"mdk_protocol.ProtocolError", u"error")])
        (self).methods = _List([mdk_protocol_Close_dispatch_Method(), mdk_protocol_Close_construct_Method(), mdk_protocol_Close_decodeClass_Method(), mdk_protocol_Close_decodeClassName_Method(), mdk_protocol_Close_encode_Method()])
        (self).parents = _List([u"mdk_protocol.ProtocolEvent"])
...
class mdk_protocol_WSClient_url_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_WSClient_url_Method, self).__init__(u"quark.String", u"url", _List([]));
...
class mdk_protocol_WSClient_token_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_WSClient_token_Method, self).__init__(u"quark.String", u"token", _List([]));
...
class mdk_protocol_WSClient_onOpen_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_WSClient_onOpen_Method, self).__init__(u"quark.void", u"onOpen", _List([u"mdk_protocol.Open"]));
...
class mdk_protocol_WSClient_onClose_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_protocol_WSClient_onClose_Method, self).__init__(u"quark.void", u"onClose", _List([u"mdk_protocol.Close"]));
...
class mdk_protocol_WSClient_doHeartbeat_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_WSClient_doHeartbeat_Method, self).__init__(u"quark.void", u"doHeartbeat", _List([]));
...
class mdk_protocol_WSClient_open_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_WSClient_open_Method, self).__init__(u"quark.void", u"open", _List([u"quark.String"]));
...
class mdk_protocol_WSClient_heartbeat_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_WSClient_heartbeat_Method, self).__init__(u"quark.void", u"heartbeat", _List([]));
...
class mdk_protocol_WSClient_shutdown_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_WSClient_shutdown_Method, self).__init__(u"quark.void", u"shutdown", _List([]));
...
class mdk_protocol_WSClient_onWSMessage_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_protocol_WSClient_onWSMessage_Method, self).__init__(u"quark.void", u"onWSMessage", _List([u"quark.String"]));
...
class mdk_protocol_WSClient(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.Logger", u"logger"), quark.reflect.Field(u"quark.float", u"firstDelay"), quark.reflect.Field(u"quark.float", u"maxDelay"), quark.reflect.Field(u"quark.float", u"reconnectDelay"), quark.reflect.Field(u"quark.float", u"ttl"), quark.reflect.Field(u"quark.float", u"tick"), quark.reflect.Field(u"mdk_runtime.WSActor", u"sock"), quark.reflect.Field(u"quark.String", u"sockUrl"), quark.reflect.Field(u"quark.long", u"lastConnectAttempt"), quark.reflect.Field(u"quark.long", u"lastHeartbeat"), quark.reflect.Field(u"mdk_runtime.Time", u"timeService"), quark.reflect.Field(u"mdk_runtime.actors.Actor", u"schedulingActor"), quark.reflect.Field(u"mdk_runtime.WebSockets", u"websockets"), quark.reflect.Field(u"mdk_runtime.actors.MessageDispatcher", u"dispatcher")])
        (self).methods = _List([mdk_protocol_WSClient_url_Method(), mdk_protocol_WSClient_token_Method(), mdk_protocol_WSClient_isStarted_Method(), mdk_protocol_WSClient_isConnected_Method(), mdk_protocol_WSClient_schedule_Method(), mdk_protocol_WSClient_scheduleReconnect_Method(), mdk_protocol_WSClient_onOpen_Method(), mdk_protocol_WSClient_doBackoff_Method(), mdk_protocol_WSClient_onClose_Method(), mdk_protocol_WSClient_onStart_Method(), mdk_protocol_WSClient_onStop_Method(), mdk_protocol_WSClient_onMessage_Method(), mdk_protocol_WSClient_onScheduledEvent_Method(), mdk_protocol_WSClient_doOpen_Method(), mdk_protocol_WSClient_doHeartbeat_Method(), mdk_protocol_WSClient_open_Method(), mdk_protocol_WSClient_startup_Method(), mdk_protocol_WSClient_pump_Method(), mdk_protocol_WSClient_heartbeat_Method(), mdk_protocol_WSClient_shutdown_Method(), mdk_protocol_WSClient_onWSMessage_Method(), mdk_protocol_WSClient_onWSConnected_Method(), mdk_protocol_WSClient_onWSError_Method(), mdk_protocol_WSClient_onWSClosed_Method()])
        (self).parents = _List([u"quark.Object"])
...
class mdk_tracing_SharedContextInitializer_getValue_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_SharedContextInitializer_getValue_Method, self).__init__(u"mdk_protocol.SharedContext", u"getValue", _List([]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_tracing.SharedContextInitializer);
        return (obj).getValue()
...
class mdk_tracing_SharedContextInitializer(quark.reflect.Class):
    def _init(self):
        quark.reflect.Class._init(self)

    def __init__(self):
        super(mdk_tracing_SharedContextInitializer, self).__init__(u"mdk_tracing.SharedContextInitializer");
        (self).name = u"mdk_tracing.SharedContextInitializer"
        (self).parameters = _List([])
        (self).fields = _List([])
        (self).methods = _List([mdk_tracing_SharedContextInitializer_getValue_Method()])
        (self).parents = _List([u"quark.Object"])
    ...
    def _setField(self, name, value):
        pass
mdk_tracing_SharedContextInitializer.singleton = mdk_tracing_SharedContextInitializer()
...
class mdk_tracing_Tracer__openIfNeeded_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_Tracer__openIfNeeded_Method, self).__init__(u"quark.void", u"_openIfNeeded", _List([]));
...
class mdk_tracing_Tracer_stop_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_Tracer_stop_Method, self).__init__(u"quark.void", u"stop", _List([]));
...
class mdk_tracing_Tracer_initContext_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_Tracer_initContext_Method, self).__init__(u"quark.void", u"initContext", _List([]));
...
class mdk_tracing_Tracer_joinContext_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_Tracer_joinContext_Method, self).__init__(u"quark.void", u"joinContext", _List([u"mdk_protocol.SharedContext"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_tracing.Tracer);
        (obj).joinContext(_cast((args)[0], lambda: mdk_protocol.SharedContext));
        return None
...
class mdk_tracing_Tracer_joinEncodedContext_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_Tracer_joinEncodedContext_Method, self).__init__(u"quark.void", u"joinEncodedContext", _List([u"quark.String"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_tracing.Tracer);
        (obj).joinEncodedContext(_cast((args)[0], lambda: unicode));
        return None
...
class mdk_tracing_Tracer_getContext_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_Tracer_getContext_Method, self).__init__(u"mdk_protocol.SharedContext", u"getContext", _List([]));
...
class mdk_tracing_Tracer_setContext_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_Tracer_setContext_Method, self).__init__(u"quark.void", u"setContext", _List([u"mdk_protocol.SharedContext"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_tracing.Tracer);
        (obj).setContext(_cast((args)[0], lambda: mdk_protocol.SharedContext));
        return None
...
class mdk_tracing_Tracer_start_span_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_Tracer_start_span_Method, self).__init__(u"quark.void", u"start_span", _List([]));
...
class mdk_tracing_Tracer_finish_span_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_Tracer_finish_span_Method, self).__init__(u"quark.void", u"finish_span", _List([]));
...
class mdk_tracing_Tracer_log_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_tracing_Tracer_log_Method, self).__init__(u"quark.void", u"log", _List([u"quark.String", u"quark.String", u"quark.String", u"quark.String"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_tracing.Tracer);
        (obj).log(_cast((args)[0], lambda: unicode), _cast((args)[1], lambda: unicode), _cast((args)[2], lambda: unicode), _cast((args)[3], lambda: unicode));
        return None
...
class mdk_tracing_Tracer_poll_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_Tracer_poll_Method, self).__init__(u"quark.Promise", u"poll", _List([]));
...
class mdk_tracing_Tracer_deresultify_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_Tracer_deresultify_Method, self).__init__(u"quark.List<mdk_tracing.protocol.LogEvent>", u"deresultify", _List([u"mdk_tracing.api.GetLogEventsResult"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_tracing.Tracer);
        return (obj).deresultify(_cast((args)[0], lambda: mdk_tracing.api.GetLogEventsResult))
...
class mdk_tracing_Tracer_query_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_Tracer_query_Method, self).__init__(u"quark.Promise", u"query", _List([u"quark.long", u"quark.long"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_tracing.Tracer);
        return (obj).query(_cast((args)[0], lambda: long), _cast((args)[1], lambda: long))
...
class mdk_tracing_Tracer_handleQueryResponse_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_Tracer_handleQueryResponse_Method, self).__init__(u"quark.Object", u"handleQueryResponse", _List([u"quark.HTTPResponse"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_tracing.Tracer);
        return (obj).handleQueryResponse(_cast((args)[0], lambda: quark.HTTPResponse))
...
class mdk_tracing_Tracer(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.Logger", u"logger"), quark.reflect.Field(u"quark.String", u"url"), quark.reflect.Field(u"quark.String", u"queryURL"), quark.reflect.Field(u"quark.String", u"token"), quark.reflect.Field(u"quark.long", u"lastPoll"), quark.reflect.Field(u"quark.concurrent.TLS<mdk_protocol.SharedContext>", u"_context"), quark.reflect.Field(u"mdk_tracing.protocol.TracingClient", u"_client"), quark.reflect.Field(u"mdk_runtime.MDKRuntime", u"runtime")])
        (self).methods = _List([mdk_tracing_Tracer_withURLsAndToken_Method(), mdk_tracing_Tracer__openIfNeeded_Method(), mdk_tracing_Tracer_stop_Method(), mdk_tracing_Tracer_initContext_Method(), mdk_tracing_Tracer_joinContext_Method(), mdk_tracing_Tracer_joinEncodedContext_Method(), mdk_tracing_Tracer_getContext_Method(), mdk_tracing_Tracer_setContext_Method(), mdk_tracing_Tracer_start_span_Method(), mdk_tracing_Tracer_finish_span_Method(), mdk_tracing_Tracer_log_Method(), mdk_tracing_Tracer_poll_Method(), mdk_tracing_Tracer_subscribe_Method(), mdk_tracing_Tracer_deresultify_Method(), mdk_tracing_Tracer_query_Method(), mdk_tracing_Tracer_handleQueryResponse_Method()])
        (self).parents = _List([u"quark.Object"])

    def construct(self, args):
        return mdk_tracing.Tracer(_cast((args)[0], lambda: mdk_runtime.MDKRuntime))
...
class mdk_tracing_api_GetLogEventsRequest_decodeClass_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_api_GetLogEventsRequest_decodeClass_Method, self).__init__(u"mdk_protocol.Serializable", u"decodeClass", _List([u"quark.reflect.Class", u"quark.String"]));
...
class mdk_tracing_api_GetLogEventsRequest(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).methods = _List([mdk_tracing_api_GetLogEventsRequest_decode_Method(), mdk_tracing_api_GetLogEventsRequest_decodeClass_Method(), mdk_tracing_api_GetLogEventsRequest_decodeClassName_Method(), mdk_tracing_api_GetLogEventsRequest_encode_Method()])
        (self).parents = _List([u"mdk_protocol.Serializable"])
...
class mdk_tracing_api_GetLogEventsResult_decodeClass_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_api_GetLogEventsResult_decodeClass_Method, self).__init__(u"mdk_protocol.Serializable", u"decodeClass", _List([u"quark.reflect.Class", u"quark.String"]));
...
class mdk_tracing_api_GetLogEventsResult(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).methods = _List([mdk_tracing_api_GetLogEventsResult_decode_Method(), mdk_tracing_api_GetLogEventsResult_decodeClass_Method(), mdk_tracing_api_GetLogEventsResult_decodeClassName_Method(), mdk_tracing_api_GetLogEventsResult_encode_Method()])
        (self).parents = _List([u"mdk_protocol.Serializable"])
...
class mdk_tracing_protocol_TracingHandler_onLogEvent_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingHandler_onLogEvent_Method, self).__init__(u"quark.void", u"onLogEvent", _List([u"mdk_tracing.protocol.LogEvent"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_tracing.protocol.TracingHandler);
...
class mdk_tracing_protocol_TracingHandler_onLogAck_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingHandler_onLogAck_Method, self).__init__(u"quark.void", u"onLogAck", _List([u"mdk_tracing.protocol.LogAck"]));
...
class mdk_tracing_protocol_TracingHandler_onSubscribe_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingHandler_onSubscribe_Method, self).__init__(u"quark.void", u"onSubscribe", _List([u"mdk_tracing.protocol.Subscribe"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_tracing.protocol.TracingHandler);
        (obj).onSubscribe(_cast((args)[0], lambda: mdk_tracing.protocol.Subscribe));
        return None
...
class mdk_tracing_protocol_TracingHandler_onOpen_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingHandler_onOpen_Method, self).__init__(u"quark.void", u"onOpen", _List([u"mdk_protocol.Open"]));
...
class mdk_tracing_protocol_TracingHandler_onClose_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingHandler_onClose_Method, self).__init__(u"quark.void", u"onClose", _List([u"mdk_protocol.Close"]));
...
class mdk_tracing_protocol_TracingHandler(quark.reflect.Class):
    def _init(self):
        quark.reflect.Class._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingHandler, self).__init__(u"mdk_tracing.protocol.TracingHandler");
        (self).name = u"mdk_tracing.protocol.TracingHandler"
        (self).parameters = _List([])
        (self).fields = _List([])
        (self).methods = _List([mdk_tracing_protocol_TracingHandler_onLogEvent_Method(), mdk_tracing_protocol_TracingHandler_onLogAck_Method(), mdk_tracing_protocol_TracingHandler_onSubscribe_Method(), mdk_tracing_protocol_TracingHandler_onOpen_Method(), mdk_tracing_protocol_TracingHandler_onClose_Method()])
        (self).parents = _List([u"quark.Object"])
    ...
    def _setField(self, name, value):
        pass
mdk_tracing_protocol_TracingHandler.singleton = mdk_tracing_protocol_TracingHandler()
class mdk_tracing_protocol_TracingEvent_construct_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingEvent_construct_Method, self).__init__(u"mdk_protocol.ProtocolEvent", u"construct", _List([u"quark.String"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_tracing.protocol.TracingEvent);
        return mdk_tracing.protocol.TracingEvent.construct(_cast((args)[0], lambda: unicode))
...
class mdk_tracing_protocol_TracingEvent_decode_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingEvent_decode_Method, self).__init__(u"mdk_protocol.ProtocolEvent", u"decode", _List([u"quark.String"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_tracing.protocol.TracingEvent);
        return mdk_tracing.protocol.TracingEvent.decode(_cast((args)[0], lambda: unicode))
...
class mdk_tracing_protocol_TracingEvent_dispatch_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingEvent_dispatch_Method, self).__init__(u"quark.void", u"dispatch", _List([u"mdk_protocol.ProtocolHandler"]));
...
class mdk_tracing_protocol_TracingEvent_dispatchTracingEvent_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingEvent_dispatchTracingEvent_Method, self).__init__(u"quark.void", u"dispatchTracingEvent", _List([u"mdk_tracing.protocol.TracingHandler"]));

    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_tracing.protocol.TracingEvent);
        (obj).dispatchTracingEvent(_cast((args)[0], lambda: mdk_tracing.protocol.TracingHandler));
        return None
...
class mdk_tracing_protocol_TracingEvent_decodeClass_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingEvent_decodeClass_Method, self).__init__(u"mdk_protocol.Serializable", u"decodeClass", _List([u"quark.reflect.Class", u"quark.String"]));
...
class mdk_tracing_protocol_TracingEvent_decodeClassName_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingEvent_decodeClassName_Method, self).__init__(u"mdk_protocol.Serializable", u"decodeClassName", _List([u"quark.String", u"quark.String"]));
...
class mdk_tracing_protocol_TracingEvent_encode_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingEvent_encode_Method, self).__init__(u"quark.String", u"encode", _List([]));
...
class mdk_tracing_protocol_TracingEvent(quark.reflect.Class):
    def _init(self):
        quark.reflect.Class._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingEvent, self).__init__(u"mdk_tracing.protocol.TracingEvent");
        (self).name = u"mdk_tracing.protocol.TracingEvent"
        (self).parameters = _List([])
        (self).fields = _List([])
        (self).methods = _List([mdk_tracing_protocol_TracingEvent_construct_Method(), mdk_tracing_protocol_TracingEvent_decode_Method(), mdk_tracing_protocol_TracingEvent_dispatch_Method(), mdk_tracing_protocol_TracingEvent_dispatchTracingEvent_Method(), mdk_tracing_protocol_TracingEvent_decodeClass_Method(), mdk_tracing_protocol_TracingEvent_decodeClassName_Method(), mdk_tracing_protocol_TracingEvent_encode_Method()])
        (self).parents = _List([u"mdk_protocol.ProtocolEvent"])
    ...
    def _setField(self, name, value):
        pass
mdk_tracing_protocol_TracingEvent.singleton = mdk_tracing_protocol_TracingEvent()
class mdk_tracing_protocol_LogEvent_dispatchTracingEvent_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_LogEvent_dispatchTracingEvent_Method, self).__init__(u"quark.void", u"dispatchTracingEvent", _List([u"mdk_tracing.protocol.TracingHandler"]));
...
class mdk_tracing_protocol_LogEvent_construct_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_LogEvent_construct_Method, self).__init__(u"mdk_protocol.ProtocolEvent", u"construct", _List([u"quark.String"]));
...
class mdk_tracing_protocol_LogEvent_decode_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_LogEvent_decode_Method, self).__init__(u"mdk_protocol.ProtocolEvent", u"decode", _List([u"quark.String"]));
...
class mdk_tracing_protocol_LogEvent_dispatch_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_LogEvent_dispatch_Method, self).__init__(u"quark.void", u"dispatch", _List([u"mdk_protocol.ProtocolHandler"]));
...
class mdk_tracing_protocol_LogEvent_decodeClass_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_LogEvent_decodeClass_Method, self).__init__(u"mdk_protocol.Serializable", u"decodeClass", _List([u"quark.reflect.Class", u"quark.String"]));
...
class mdk_tracing_protocol_LogEvent(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"mdk_protocol.Discriminator", u"_discriminator"), quark.reflect.Field(u"mdk_protocol.SharedContext", u"context"), quark.reflect.Field(u"quark.long", u"timestamp"), quark.reflect.Field(u"quark.String", u"node"), quark.reflect.Field(u"quark.String", u"level"), quark.reflect.Field(u"quark.String", u"category"), quark.reflect.Field(u"quark.String", u"contentType"), quark.reflect.Field(u"quark.String", u"text"), quark.reflect.Field(u"quark.long", u"sequence"), quark.reflect.Field(u"quark.int", u"sync")])
        (self).methods = _List([mdk_tracing_protocol_LogEvent_dispatchTracingEvent_Method(), mdk_tracing_protocol_LogEvent_toString_Method(), mdk_tracing_protocol_LogEvent_construct_Method(), mdk_tracing_protocol_LogEvent_decode_Method(), mdk_tracing_protocol_LogEvent_dispatch_Method(), mdk_tracing_protocol_LogEvent_decodeClass_Method(), mdk_tracing_protocol_LogEvent_decodeClassName_Method(), mdk_tracing_protocol_LogEvent_encode_Method()])
        (self).parents = _List([u"mdk_tracing.protocol.TracingEvent"])
...
class mdk_tracing_protocol_Subscribe_dispatchTracingEvent_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_Subscribe_dispatchTracingEvent_Method, self).__init__(u"quark.void", u"dispatchTracingEvent", _List([u"mdk_tracing.protocol.TracingHandler"]));
...
class mdk_tracing_protocol_Subscribe_construct_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_Subscribe_construct_Method, self).__init__(u"mdk_protocol.ProtocolEvent", u"construct", _List([u"quark.String"]));
...
class mdk_tracing_protocol_Subscribe_decode_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_Subscribe_decode_Method, self).__init__(u"mdk_protocol.ProtocolEvent", u"decode", _List([u"quark.String"]));
...
class mdk_tracing_protocol_Subscribe_dispatch_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_Subscribe_dispatch_Method, self).__init__(u"quark.void", u"dispatch", _List([u"mdk_protocol.ProtocolHandler"]));
...
class mdk_tracing_protocol_Subscribe_decodeClass_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_Subscribe_decodeClass_Method, self).__init__(u"mdk_protocol.Serializable", u"decodeClass", _List([u"quark.reflect.Class", u"quark.String"]));
...
class mdk_tracing_protocol_Subscribe(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"mdk_protocol.Discriminator", u"_discriminator")])
        (self).methods = _List([mdk_tracing_protocol_Subscribe_dispatchTracingEvent_Method(), mdk_tracing_protocol_Subscribe_toString_Method(), mdk_tracing_protocol_Subscribe_construct_Method(), mdk_tracing_protocol_Subscribe_decode_Method(), mdk_tracing_protocol_Subscribe_dispatch_Method(), mdk_tracing_protocol_Subscribe_decodeClass_Method(), mdk_tracing_protocol_Subscribe_decodeClassName_Method(), mdk_tracing_protocol_Subscribe_encode_Method()])
        (self).parents = _List([u"mdk_tracing.protocol.TracingEvent"])
...
class mdk_tracing_protocol_LogAck_dispatchTracingEvent_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_LogAck_dispatchTracingEvent_Method, self).__init__(u"quark.void", u"dispatchTracingEvent", _List([u"mdk_tracing.protocol.TracingHandler"]));
...
class mdk_tracing_protocol_LogAck_construct_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_LogAck_construct_Method, self).__init__(u"mdk_protocol.ProtocolEvent", u"construct", _List([u"quark.String"]));
...
class mdk_tracing_protocol_LogAck_decode_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_LogAck_decode_Method, self).__init__(u"mdk_protocol.ProtocolEvent", u"decode", _List([u"quark.String"]));
...
class mdk_tracing_protocol_LogAck_dispatch_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_LogAck_dispatch_Method, self).__init__(u"quark.void", u"dispatch", _List([u"mdk_protocol.ProtocolHandler"]));
...
class mdk_tracing_protocol_LogAck_decodeClass_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_LogAck_decodeClass_Method, self).__init__(u"mdk_protocol.Serializable", u"decodeClass", _List([u"quark.reflect.Class", u"quark.String"]));
...
class mdk_tracing_protocol_LogAck(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"mdk_protocol.Discriminator", u"_discriminator"), quark.reflect.Field(u"quark.long", u"sequence")])
        (self).methods = _List([mdk_tracing_protocol_LogAck_dispatchTracingEvent_Method(), mdk_tracing_protocol_LogAck_toString_Method(), mdk_tracing_protocol_LogAck_construct_Method(), mdk_tracing_protocol_LogAck_decode_Method(), mdk_tracing_protocol_LogAck_dispatch_Method(), mdk_tracing_protocol_LogAck_decodeClass_Method(), mdk_tracing_protocol_LogAck_decodeClassName_Method(), mdk_tracing_protocol_LogAck_encode_Method()])
        (self).parents = _List([u"mdk_tracing.protocol.TracingEvent"])
...
class mdk_tracing_protocol_TracingClient__debug_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingClient__debug_Method, self).__init__(u"quark.void", u"_debug", _List([u"quark.String"]));
...
class mdk_tracing_protocol_TracingClient_url_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingClient_url_Method, self).__init__(u"quark.String", u"url", _List([]));
...
class mdk_tracing_protocol_TracingClient_token_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingClient_token_Method, self).__init__(u"quark.String", u"token", _List([]));
...
class mdk_tracing_protocol_TracingClient_isStarted_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingClient_isStarted_Method, self).__init__(u"quark.bool", u"isStarted", _List([]));
...
class mdk_tracing_protocol_TracingClient__startIfNeeded_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingClient__startIfNeeded_Method, self).__init__(u"quark.void", u"_startIfNeeded", _List([]));
...
class mdk_tracing_protocol_TracingClient_startup_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingClient_startup_Method, self).__init__(u"quark.void", u"startup", _List([]));
...
class mdk_tracing_protocol_TracingClient_pump_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingClient_pump_Method, self).__init__(u"quark.void", u"pump", _List([]));
...
class mdk_tracing_protocol_TracingClient_onWSMessage_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingClient_onWSMessage_Method, self).__init__(u"quark.void", u"onWSMessage", _List([u"quark.String"]));
...
class mdk_tracing_protocol_TracingClient_isConnected_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingClient_isConnected_Method, self).__init__(u"quark.bool", u"isConnected", _List([]));
...
class mdk_tracing_protocol_TracingClient_schedule_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingClient_schedule_Method, self).__init__(u"quark.void", u"schedule", _List([u"quark.float"]));
...
class mdk_tracing_protocol_TracingClient_scheduleReconnect_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingClient_scheduleReconnect_Method, self).__init__(u"quark.void", u"scheduleReconnect", _List([]));
...
class mdk_tracing_protocol_TracingClient_onOpen_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingClient_onOpen_Method, self).__init__(u"quark.void", u"onOpen", _List([u"mdk_protocol.Open"]));
...
class mdk_tracing_protocol_TracingClient_doBackoff_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingClient_doBackoff_Method, self).__init__(u"quark.void", u"doBackoff", _List([]));
...
class mdk_tracing_protocol_TracingClient_onClose_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingClient_onClose_Method, self).__init__(u"quark.void", u"onClose", _List([u"mdk_protocol.Close"]));
...
class mdk_tracing_protocol_TracingClient_onScheduledEvent_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingClient_onScheduledEvent_Method, self).__init__(u"quark.void", u"onScheduledEvent", _List([]));
...
class mdk_tracing_protocol_TracingClient_doOpen_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingClient_doOpen_Method, self).__init__(u"quark.void", u"doOpen", _List([]));
...
class mdk_tracing_protocol_TracingClient_doHeartbeat_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingClient_doHeartbeat_Method, self).__init__(u"quark.void", u"doHeartbeat", _List([]));
...
class mdk_tracing_protocol_TracingClient_open_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingClient_open_Method, self).__init__(u"quark.void", u"open", _List([u"quark.String"]));
...
class mdk_tracing_protocol_TracingClient_heartbeat_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingClient_heartbeat_Method, self).__init__(u"quark.void", u"heartbeat", _List([]));
...
class mdk_tracing_protocol_TracingClient_shutdown_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingClient_shutdown_Method, self).__init__(u"quark.void", u"shutdown", _List([]));
...
class mdk_tracing_protocol_TracingClient_onWSConnected_Method(quark.reflect.Method):
    ...
    def __init__(self):
        super(mdk_tracing_protocol_TracingClient_onWSConnected_Method, self).__init__(u"quark.void", u"onWSConnected", _List([u"mdk_runtime.WSActor"]));
...
class mdk_tracing_protocol_TracingClient_onWSError_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingClient_onWSError_Method, self).__init__(u"quark.void", u"onWSError", _List([u"quark.error.Error"]));
...
class mdk_tracing_protocol_TracingClient_onWSClosed_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingClient_onWSClosed_Method, self).__init__(u"quark.void", u"onWSClosed", _List([]));
...
class mdk_tracing_protocol_TracingClient_onSubscribe_Method(quark.reflect.Method):
    def _init(self):
        quark.reflect.Method._init(self)

    def __init__(self):
        super(mdk_tracing_protocol_TracingClient_onSubscribe_Method, self).__init__(u"quark.void", u"onSubscribe", _List([u"mdk_tracing.protocol.Subscribe"]));
...
class mdk_tracing_protocol_TracingClient(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.Logger", u"logger"), quark.reflect.Field(u"quark.float", u"firstDelay"), quark.reflect.Field(u"quark.float", u"maxDelay"), quark.reflect.Field(u"quark.float", u"reconnectDelay"), quark.reflect.Field(u"quark.float", u"ttl"), quark.reflect.Field(u"quark.float", u"tick"), quark.reflect.Field(u"mdk_runtime.WSActor", u"sock"), quark.reflect.Field(u"quark.String", u"sockUrl"), quark.reflect.Field(u"quark.long", u"lastConnectAttempt"), quark.reflect.Field(u"quark.long", u"lastHeartbeat"), quark.reflect.Field(u"mdk_runtime.Time", u"timeService"), quark.reflect.Field(u"mdk_runtime.actors.Actor", u"schedulingActor"), quark.reflect.Field(u"mdk_runtime.WebSockets", u"websockets"), quark.reflect.Field(u"mdk_runtime.actors.MessageDispatcher", u"dispatcher"), quark.reflect.Field(u"mdk_tracing.Tracer", u"_tracer"), quark.reflect.Field(u"quark.bool", u"_started"), quark.reflect.Field(u"quark.concurrent.Lock", u"_mutex"), quark.reflect.Field(u"quark.UnaryCallable", u"_handler"), quark.reflect.Field(u"mdk_runtime.actors.MessageDispatcher", u"_dispatcher"), quark.reflect.Field(u"quark.long", u"_syncRequestPeriod"), quark.reflect.Field(u"quark.int", u"_syncInFlightMax"), quark.reflect.Field(u"quark.List<mdk_tracing.protocol.LogEvent>", u"_buffered"), quark.reflect.Field(u"quark.List<mdk_tracing.protocol.LogEvent>", u"_inFlight"), quark.reflect.Field(u"quark.long", u"_logged"), quark.reflect.Field(u"quark.long", u"_sent"), quark.reflect.Field(u"quark.long", u"_failedSends"), quark.reflect.Field(u"quark.long", u"_recorded"), quark.reflect.Field(u"quark.long", u"_lastSyncTime"), quark.reflect.Field(u"quark.Logger", u"_myLog")])
        (self).methods = _List([mdk_tracing_protocol_TracingClient__debug_Method(), mdk_tracing_protocol_TracingClient_url_Method(), mdk_tracing_protocol_TracingClient_token_Method(), mdk_tracing_protocol_TracingClient_isStarted_Method(), mdk_tracing_protocol_TracingClient__startIfNeeded_Method(), mdk_tracing_protocol_TracingClient_subscribe_Method(), mdk_tracing_protocol_TracingClient_onStart_Method(), mdk_tracing_protocol_TracingClient_onStop_Method(), mdk_tracing_protocol_TracingClient_startup_Method(), mdk_tracing_protocol_TracingClient_pump_Method(), mdk_tracing_protocol_TracingClient_onWSMessage_Method(), mdk_tracing_protocol_TracingClient_onLogEvent_Method(), mdk_tracing_protocol_TracingClient_onLogAck_Method(), mdk_tracing_protocol_TracingClient_log_Method(), mdk_tracing_protocol_TracingClient_isConnected_Method(), mdk_tracing_protocol_TracingClient_schedule_Method(), mdk_tracing_protocol_TracingClient_scheduleReconnect_Method(), mdk_tracing_protocol_TracingClient_onOpen_Method(), mdk_tracing_protocol_TracingClient_doBackoff_Method(), mdk_tracing_protocol_TracingClient_onClose_Method(), mdk_tracing_protocol_TracingClient_onMessage_Method(), mdk_tracing_protocol_TracingClient_onScheduledEvent_Method(), mdk_tracing_protocol_TracingClient_doOpen_Method(), mdk_tracing_protocol_TracingClient_doHeartbeat_Method(), mdk_tracing_protocol_TracingClient_open_Method(), mdk_tracing_protocol_TracingClient_heartbeat_Method(), mdk_tracing_protocol_TracingClient_shutdown_Method(), mdk_tracing_protocol_TracingClient_onWSConnected_Method(), mdk_tracing_protocol_TracingClient_onWSError_Method(), mdk_tracing_protocol_TracingClient_onWSClosed_Method(), mdk_tracing_protocol_TracingClient_onSubscribe_Method()])
        (self).parents = _List([u"mdk_protocol.WSClient"])

    def construct(self, args):
        return mdk_tracing.protocol.TracingClient(_cast((args)[0], lambda: mdk_tracing.Tracer), _cast((args)[1], lambda: mdk_runtime.MDKRuntime))
...
Root.mdk_discovery_protocol_DiscoHandler_md = mdk_discovery_protocol_DiscoHandler.singleton
Root.mdk_discovery_protocol_DiscoveryEvent_md = mdk_discovery_protocol_DiscoveryEvent.singleton
...
Root.mdk_protocol_Discriminator_md = mdk_protocol_Discriminator.singleton
...
Root.mdk_protocol_ProtocolHandler_md = mdk_protocol_ProtocolHandler.singleton
Root.mdk_protocol_ProtocolEvent_md = mdk_protocol_ProtocolEvent.singleton
...
Root.mdk_tracing_SharedContextInitializer_md = mdk_tracing_SharedContextInitializer.singleton
...
Root.mdk_tracing_protocol_TracingHandler_md = mdk_tracing_protocol_TracingHandler.singleton
Root.mdk_tracing_protocol_TracingEvent_md = mdk_tracing_protocol_TracingEvent.singleton
