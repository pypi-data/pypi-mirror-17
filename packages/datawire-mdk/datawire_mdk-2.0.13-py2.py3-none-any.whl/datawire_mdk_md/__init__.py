...
class mdk_MDKImpl(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.String", u"CONTEXT_HEADER"), quark.reflect.Field(u"quark.Logger", u"logger"), quark.reflect.Field(u"quark.Map<quark.String,quark.Object>", u"_reflection_hack"), quark.reflect.Field(u"mdk_runtime.MDKRuntime", u"_runtime"), quark.reflect.Field(u"mdk_discovery.Discovery", u"_disco"), quark.reflect.Field(u"mdk_discovery.DiscoverySource", u"_discoSource"), quark.reflect.Field(u"mdk_tracing.Tracer", u"_tracer"), quark.reflect.Field(u"quark.String", u"procUUID"), quark.reflect.Field(u"quark.bool", u"_running")])
        (self).methods = _List([mdk_MDKImpl_getDiscoveryFactory_Method(), mdk_MDKImpl_getFailurePolicy_Method(), mdk_MDKImpl__timeout_Method(), mdk_MDKImpl_start_Method(), mdk_MDKImpl_stop_Method(), mdk_MDKImpl_register_Method(), mdk_MDKImpl_session_Method(), mdk_MDKImpl_join_Method()])
        (self).parents = _List([u"quark.Object"])
...
class mdk_SessionImpl(quark.reflect.Class):
    ...
    def __init__(self):
        ...
        (self).parameters = _List([])
        (self).fields = _List([quark.reflect.Field(u"quark.Map<quark.String,quark.int>", u"_levels"), quark.reflect.Field(u"quark.concurrent.TLS<quark.bool>", u"_inLogging"), quark.reflect.Field(u"mdk.MDKImpl", u"_mdk"), quark.reflect.Field(u"quark.List<quark.List<mdk_discovery.Node>>", u"_resolved"), quark.reflect.Field(u"mdk_protocol.SharedContext", u"_context"), quark.reflect.Field(u"quark.bool", u"_experimental")])
...
class mdk_tracing_Tracer_query_Method(quark.reflect.Method):
    ...
    def invoke(self, object, args):
        obj = _cast(object, lambda: mdk_tracing.Tracer);
        return (obj).query(_cast((args)[0], lambda: int), _cast((args)[1], lambda: int))
