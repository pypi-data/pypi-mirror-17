...
class FileUtils:
    ...
    @staticmethod
    def remove_skip_rows(multiline_str, skip_str_starting_array, skip_empty_lines):
        outr = ''
    ...
    def check_header_string_array(multiline_str, header_str_array):
        for header_str_array_pos in header_str_array:
            if header_str_array[header_str_array_pos] in multiline_str:
                return True, header_str_array_pos
        return False, -1
    ...
    def remove_before_header_string(multiline_str, header_str):
        ...
        :return:
        """
        return str[multiline_str.find(header_str + '\n') + len(header_str + '\n'):]
    ...
    def remove_after_footer_string(multiline_str, footer_str):
        ...
        :return:
        """
        return str[:multiline_str.find(footer_str)]
