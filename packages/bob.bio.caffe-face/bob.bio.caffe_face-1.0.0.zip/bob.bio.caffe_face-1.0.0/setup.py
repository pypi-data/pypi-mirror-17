...
setup(
    ...
    description='Tools for running face recognition experiments using VGG face model',

    url='https://www.gitlab.idiap.ch/bob/bob.bio.caffe_face',
    license='BSD',
    ...
    entry_points={
        ...
        'bob.bio.extractor': [
            'vgg_features        = bob.bio.caffe_face.config.extractor.vgg_features:extractor',  #VGG
        ],
