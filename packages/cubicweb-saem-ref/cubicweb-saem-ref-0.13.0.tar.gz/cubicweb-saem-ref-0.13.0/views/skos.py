...
class SKOSActivityTabView(tabs.TabsMixin, EntityView):
    ...
    __regid__ = 'saem_ref_vocabulary_lifecycle'
...
afs.tag_object_of(('*', 'seda_keyword_scheme', 'ConceptScheme'), 'main', 'hidden')

skos.ConceptSchemePrimaryView.tabs.append(_('saem_ref_vocabulary_lifecycle'))
skos.ConceptPrimaryView.tabs.append(_('saem_ref_vocabulary_lifecycle'))
