...
from djmessenger.utils.decorators import synchronized
from djmessenger.utils.filelock import SecureOpen
...
class Serializable(object):
    ...
    def serialize(self, pretty=False):
        """
        Serialize the object into a valid json-formated string after applying
    ...
    def json(self):
        """
        Returns a dict representation of the object, after applying includes
        and excludes policies
    ...
    def deserialize(cls, json_data):
        ...
        not define them in _obj_map, you need to override deserialize()
        ...
        for key in json_data:
            ...
            if key in obj_map:
                ...
                # if key is not in _obj_map, either it is primitive type or
                # definition not provided, we simply put it as a dict
...
class SerializableEnum(Serializable):
    ...
    def __init__(self, name, description=""):
        ...
        @param name: unique identifier, in uppercase strings
        @type name: str
