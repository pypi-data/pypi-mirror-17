...
class Endpoint(object):
  ...
  thrift_spec = (
    ...
    (3, TType.STRING, 'inet', None, None, ), # 3
    (4, TType.STRING, 'inet6', None, None, ), # 4
  )

  def __init__(self, host=None, port=None, inet=None, inet6=None,):
    self.host = host
    self.port = port
    self.inet = inet
    self.inet6 = inet6
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.inet = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.STRING:
          self.inet6 = iprot.readString();
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.port != None:
      ...
      oprot.writeFieldEnd()
    if self.inet != None:
      oprot.writeFieldBegin('inet', TType.STRING, 3)
      oprot.writeString(self.inet)
      oprot.writeFieldEnd()
    if self.inet6 != None:
      oprot.writeFieldBegin('inet6', TType.STRING, 4)
      oprot.writeString(self.inet6)
      oprot.writeFieldEnd()
