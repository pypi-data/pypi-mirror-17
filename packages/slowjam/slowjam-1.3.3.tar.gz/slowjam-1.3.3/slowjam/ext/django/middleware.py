...
from slowjam.statsd_client import graphite_duration
logger = logging.getLogger(__name__)


class SlowjamMiddleware(MiddlewareMixin):

    time_recorder = graphite_duration
    ...
    def process_view(self, request, view_func, view_args, view_kwargs):
        ...
        if slowjam_context:
            ...
            slowjam_context.start('request', extras=extras, time_recorder=self.time_recorder)
