...
# Target: PythonLibrary(BuildFileAddress(BuildFile(tests/python/pants_test/BUILD, FileSystemProjectTree(/Users/stuhood/src/pants)), test_infra))
...
{   'classifiers': [   'Intended Audience :: Developers',
    ...
    'packages': [   'pants_test',
                    ...
                    'pants_test.jvm',
                    'pants_test.option',
                    'pants_test.option.util',
                    'pants_test.subsystem',
                    'pants_test.tasks',
                    'pants_test.testutils'],
