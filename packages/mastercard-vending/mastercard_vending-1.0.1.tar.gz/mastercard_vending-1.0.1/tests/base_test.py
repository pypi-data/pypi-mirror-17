...
class BaseTest(unittest.TestCase):
	responses = {}
	authentications = {
		"default": OAuthAuthentication("L5BsiPgaF-O3qA36znUATgQXwJB6MRoMSdhjd7wt50c97279!50596e52466e3966546d434b7354584c4975693238513d3d", join(dirname(realpath(__file__)),"resources", "mcapi_sandbox_key.p12"), "test", "password"),
		"send_1": OAuthAuthentication("-mzBAF1UFssV7H1VDrJuXQ45AZlkmfNEoMUxocsGae1f9f59!cba9cef300b64e3e812698fd7a8b6bff0000000000000000", join(dirname(realpath(__file__)),"resources", "send_sdk_ci_1_sandbox.p12"), "keyalias", "keystorepassword"),
		"send_2": OAuthAuthentication("3nSpMB_IjYzyLhUbK37cHsYHVy7b3goCk1Q1DEinb60951d6!1b1af7c5aa1a4d5792ee9e707f9b87d60000000000000000", join(dirname(realpath(__file__)),"resources", "send_sdk_ci_2_sandbox.p12"), "keyalias", "keystorepassword"),
		"send_3": OAuthAuthentication("qPG4eNdxSW2pT1M5YdsyBoQs1CeyYmQ2JvYL2qq_a2b027f3!c6350fb087cc4df58700e117636e16c90000000000000000", join(dirname(realpath(__file__)),"resources", "send_sdk_ci_3_sandbox.p12"), "keyalias", "keystorepassword"),
		"vending_1": OAuthAuthentication("8RouBXU0XtrqkbTmjmE3ddGNut1zieMX46TJMtMPe4318c15!dfe3346cdfdd497582ed9c88a5371c100000000000000000", join(dirname(realpath(__file__)),"resources", "vending_sdk_ci_sandbox.p12"), "keyalias", "keystorepassword"),
