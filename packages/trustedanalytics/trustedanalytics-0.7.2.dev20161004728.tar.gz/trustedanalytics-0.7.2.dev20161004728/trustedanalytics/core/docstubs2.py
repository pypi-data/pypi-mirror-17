...
# Auto-generated file for API static documentation stubs (2016-10-04T16:19:02.749610)
#
# **DO NOT EDIT**
...
class GmmModel(object):
    ...
    @doc_stub
    def train(self, frame, observation_columns, column_scalings, k=2, max_iterations=100, convergence_tol=0.01, seed=5644079305518711895):
        """
        ...
        :param seed: (default=5644079305518711895)  Random seed
        :type seed: int64
...
class RandomForestClassifierModel(object):
    ...
    @doc_stub
    def train(self, frame, label_column, observation_columns, num_classes=2, num_trees=1, impurity='gini', max_depth=4, max_bins=100, seed=1166764430, categorical_features_info=None, feature_subset_category=None):
        """
        ...
        :type max_bins: int32
        :param seed: (default=1166764430)  Random seed for bootstrapping and choosing feature subsets. Default is a randomly chosen seed.
        :type seed: int32
...
class RandomForestRegressorModel(object):
    ...
    @doc_stub
    def train(self, frame, value_column, observation_columns, num_trees=1, impurity='variance', max_depth=4, max_bins=100, seed=1187123560, categorical_features_info=None, feature_subset_category=None):
        """
        ...
        :param max_bins: (default=100)  Maximum number of bins used for splitting features. Default is 100.
        :type max_bins: int32
        :param seed: (default=1187123560)  Random seed for bootstrapping and choosing feature subsets. Default is a randomly chosen seed.
        :type seed: int32
        :param categorical_features_info: (default=None)  Arity of categorical features. Entry (n-> k) indicates that feature 'n' is categorical with 'k' categories indexed from 0:{0,1,...,k-1}
        :type categorical_features_info: dict
