...
_CONSTRAINTSOLVERPARAMETERS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_sequence_high_demand_tasks', full_name='operations_research.ConstraintSolverParameters.use_sequence_high_demand_tasks', index=24,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_all_possible_disjunctions', full_name='operations_research.ConstraintSolverParameters.use_all_possible_disjunctions', index=25,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_edge_finder_size', full_name='operations_research.ConstraintSolverParameters.max_edge_finder_size', index=26,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='diffn_use_cumulative', full_name='operations_research.ConstraintSolverParameters.diffn_use_cumulative', index=27,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_element_rmq', full_name='operations_research.ConstraintSolverParameters.use_element_rmq', index=28,
