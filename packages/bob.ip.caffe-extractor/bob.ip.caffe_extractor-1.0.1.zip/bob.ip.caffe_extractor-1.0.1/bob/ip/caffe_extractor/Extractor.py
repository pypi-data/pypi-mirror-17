...
class Extractor(object):
    ...
    def __init__(self, deploy_architecture, model, end_cnn):
        ...
        **Parameters**
         ...
         model: The path of the trained caffe model
         deploy_architecture: The path of the `prototxt` architecture file used for deployment.
                              ...
                              input_dim: w
                              input_dim: h
                              Where :math:`c` is the number of channels, :math:`w` is the width and $h$ is the height
    ...
    def __call__(self, image):
        ...
        **Returns**
        ...
        if len(image.shape) == 3:
            formatted_image = numpy.reshape(image, (1, image.shape[0], image.shape[1], image.shape[2]))
        else:
            formatted_image = numpy.reshape(image, (1, 1, image.shape[1], image.shape[2]))
        ...
        return self.net.forward(data=formatted_image, end=self.end_cnn)[self.end_cnn][0]
