...
setup(
    ...
    name = 'bob.ip.caffe_extractor',
    version = open("version.txt").read().rstrip(),
    description = 'Feature extractor using caffe CNNs',

    url = 'https://gitlab.idiap.ch/tiago.pereira/bob.bio.caffe_extractor',
    license = 'BSD',
    ...
    entry_points={
      ...
      'console_scripts': [
        'download_VGG.py         = bob.ip.caffe_extractor.script.download_VGG:main',
      ],
