...
setup(
    description='Rask Mailgun Connector',
    install_requires=[
        'rask',
    ],
    license='https://gitlab.com/vikingmakt/rask_njord_mailgun/raw/master/LICENSE',
    maintainer='Umgeher Torgersen',
    maintainer_email='me@umgeher.org',
    name='rask_njord_mailgun',
    packages=find_packages(),
    url='https://gitlab.com/vikingmakt/rask_njord_mailgun',
    version=git_version()
)
