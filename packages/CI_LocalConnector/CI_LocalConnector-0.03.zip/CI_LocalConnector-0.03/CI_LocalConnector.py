...
def showHelp():
    ...
    print ('CI_LocalConnector.py getCloudTags : Get Tags defenition from Cloud and save into file')
    print ('CI_LocalConnector.py showSavedTags : Show the tags saved in file')
