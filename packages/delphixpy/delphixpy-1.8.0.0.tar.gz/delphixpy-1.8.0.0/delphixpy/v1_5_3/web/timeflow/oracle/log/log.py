...
def get_all(engine, to_date=None, page_offset=None, page_size=None, missing=None, timeflow=None, database=None, from_scn=None, from_date=None, snapshot=None, to_scn=None):
    """
