...
def get(engine, ref):
    ...
    :param ref: Reference to a :py:class:`blackbox.web.vo.FaultEffect` object
    :type ref: ``str``
...
def get_all(engine, root_cause=None, bundle_id=None, target=None, severity=None):
    """
    ...
    query_params = {"rootCause": root_cause, "severity": severity, "target": target, "bundleID": bundle_id}
