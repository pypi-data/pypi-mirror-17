...
Package "action"
"""
# pylint: disable=W0403,W0611,W0622
API_VERSION = "1.8.0"
...
def get(engine, ref):
    ...
    :param ref: Reference to a :py:class:`blackbox.web.vo.Action` object
    :type ref: ``str``
...
def get_all(engine, to_date=None, page_offset=None, search_text=None, page_size=None, root_action_only=None, parent_action=None, ascending=None, state=None, from_date=None, sort_by=None, user=None):
    """
    ...
    query_params = {"toDate": to_date, "pageOffset": page_offset, "searchText": search_text, "pageSize": page_size, "state": state, "rootActionOnly": root_action_only, "ascending": ascending, "parentAction": parent_action, "fromDate": from_date, "sortBy": sort_by, "user": user}
