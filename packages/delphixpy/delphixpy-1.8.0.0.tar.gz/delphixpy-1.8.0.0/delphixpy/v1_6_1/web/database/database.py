...
def get(engine, ref):
    ...
    :param ref: Reference to a :py:class:`blackbox.web.vo.Container` object
    :type ref: ``str``
...
def get_all(engine, group=None, restoration=None, provision_container=None, no_js_container_data_source=None, no_js_data_source=None):
    """
    ...
    query_params = {"provisionContainer": provision_container, "restoration": restoration, "group": group, "noJSContainerDataSource": no_js_container_data_source, "noJSDataSource": no_js_data_source}
