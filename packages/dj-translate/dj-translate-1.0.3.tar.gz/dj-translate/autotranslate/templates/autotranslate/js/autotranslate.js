...
{% if autotranslate_settings.ENABLE_TRANSLATION_SUGGESTIONS %}
   {% if autotranslate_settings.AZURE_CLIENT_ID and autotranslate_settings.AZURE_CLIENT_SECRET or autotranslate_settings.GOOGLE_TRANSLATE %}
    $('a.suggest').click(function(e){
        ...
        var sourceLang = '{{ autotranslate_settings.MESSAGES_SOURCE_LANGUAGE_CODE }}';
        var destLang = '{{ autotranslate_i18n_lang_code }}';
   ...
   {% if autotranslate_settings.YANDEX_TRANSLATE_KEY %}
    $('a.suggest').click(function(e){
        e.preventDefault();
        var a = $(this);
        var str = a.html();
        ...
        var destLangRoot = '{{ autotranslate_i18n_lang_code }}'.split('-')[0];
        var lang = '{{ autotranslate_settings.MESSAGES_SOURCE_LANGUAGE_CODE }}-' + destLangRoot;
        ...
        var apiData = {
            ...
            lang: lang,
            key: '{{ autotranslate_settings.YANDEX_TRANSLATE_KEY }}',
            format: 'html',
            text: orig
        };
