...
class OWMHTTPClient(object):
    ...
    def call_API(self, API_endpoint_URL, params_dict,
        ...
        """
        url = self._build_full_URL(self._API_root_URL, API_endpoint_URL, params_dict)
    ...
    def _build_full_URL(self, API_root_URL, API_endpoint_URL, params_dict):
        """
        ...
        """
        url = API_root_URL + API_endpoint_URL
