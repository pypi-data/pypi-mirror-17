...
# /etc/footmark/logging.conf and ~/.footmark/logging.conf (which works on Windows and Unix).
FootmarkConfigPath = '/etc/footmark/logging.conf'
FootmarkConfigLocations = [FootmarkConfigPath]
UserConfigPath = os.path.join(expanduser('~'), '.footmark/logging.conf')
