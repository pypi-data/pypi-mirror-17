...
class Connection:
    ...
    def get_system_sourceconfigs_url(self, system_id):
        return self.get_system_url(system_id) + "/sourceconfigs"

    def get_system_sinkconfigs_url(self, system_id):
        return self.get_system_url(system_id) + "/sinkconfigs"
    ...
    def get_secrets(self):
        response = self.do_get_request(self.secrets_url)
        utils.validate_response_is_ok(response, allowable_response_status_codes=[200])
