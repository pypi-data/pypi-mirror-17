...
class TestDLCHighLevel3(unittest.TestCase):

    def setUp(self):
        unittest.TestCase.setUp(self)
        self.tfp = os.path.join(os.path.dirname(__file__), 'test_files/')  # test file path
        self.dlc_hl = DLCHighLevel(self.tfp + 'DLC_test3.xlsx')

    def test_variables(self):
        self.assertEqual(self.dlc_hl.vref, 50)
        self.assertEqual(os.path.realpath(self.dlc_hl.res_path), os.path.realpath(self.tfp + "res"))
    ...
    def test_file_hour_lst(self):
        ...
        os.path.abspath(os.path.join(self.tfp, 'res\\dlc12_iec61400-1ed3\\dlc12_wsp04_wdir350_s3001.sel'))
    ...
    def test_file_hour_lst_count(self):
        ...
        self.assertEqual(f, os.path.abspath(os.path.join(self.tfp, 'res\\dlc31_iec61400-1ed3\\dlc31_wsp25_wdir000_s0000.sel')))
        self.assertAlmostEqual(h, 0.0087201928 * 1 * (50. / 1100) * 20 * 365 * 24)


    def test_dlc_lst(self):
        self.assertEqual(self.dlc_hl.dlc_lst(), ['12', '13', '14a', '31'])
    ...
    def test_fail_on_res_not_found(self):
        self.dlc_hl = DLCHighLevel(self.tfp + 'DLC_test.xlsx', fail_on_resfile_not_found=True)
