...
def bhawc2_st19_to_bhawc_st13_converter(st19_filename, set_nr):
    ...
    st13 = StSet(np.array([st(1),  # 1 Radius [m]
                  ...
                  st(1) * (st(5) ** 2 + st(6) ** 2),  # 3 Polar mass moment of inertia [kgm] (r_iy^2+r_ix^2)*m
                  - st(18),  # 4 x_elastic center [m] converted from PE coordinates to Blade coordinates (rotate 180 around y)
...
if __name__ == "__main__":
    bhawc2_st19_to_bhawc_st13_converter(r'C:\mmpe\HAWC2\models\SWT3.6-107\original_data\B52 data from SWT/BH_Blade_st.b52', 14)
