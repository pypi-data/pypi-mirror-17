...
class RequestConverter(BaseConverter):
    """
    Converts the elements of :class:`~pyrocumulus.web.handlers.PyroRequest`
    into the correct type according to a subclass of
    :class:`mogomotor.Document` used as model
    """

    def __init__(self, obj, model):
        """
        :param obj: An instance of
          :class:`~pyrocumulus.web.handlers.PyroRequest`.
