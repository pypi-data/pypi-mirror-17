...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ChartGroup.name'
        db.delete_column(u'hidash_chartgroup', 'name')

        # Adding field 'ChartGroup.group'
        db.add_column(u'hidash_chartgroup', 'group',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'ChartGroup.name'
        db.add_column(u'hidash_chartgroup', 'name',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=128),
                      keep_default=False)

        # Deleting field 'ChartGroup.group'
        db.delete_column(u'hidash_chartgroup', 'group_id')
