    ...
    .directive('hiDashReports', ['$http','urlProcessor', function($http, urlProcessor) {
        return {
            ...
            template:
                    ...
                    '<div ng-repeat="chart in data track by $index" class={{"col-md-"+chart.grid_width}}'+
                    ...
                    '<div ng-if="chart.handler_type===\'googlechart\'" google-chart chart="chartData[$index]"style="height: {{chart.height}}px"></div>'+
                    '</div></section>'
        };
    }])
