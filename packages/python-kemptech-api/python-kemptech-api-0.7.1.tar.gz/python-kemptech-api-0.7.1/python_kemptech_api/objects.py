...
class Fqdn(BaseKempObject):
    ...
    def get_sites(self):
        ...
        try:
            ...
            data = get_data(response)
            xml_object = data["fqdn"].get(self.API_TAG, [])
...
class Interface(BaseKempObject):
    ...
    def address(self, value):
        self.addr = value + "/" + self.cidr if value is not None else None
    ...
    @cidr.setter
    def cidr(self, value):
        self.addr = self.address + "/" + value if value is not None else None
