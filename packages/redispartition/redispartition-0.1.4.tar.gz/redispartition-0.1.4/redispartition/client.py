...
class RedisCluster(object):
    ...
    @pipeiflist
    def hset(self, name, key, value, conn=None):
        return conn.hset(name, key, value)

    @pipeiflist
    def hexists(self, name, key, conn=None):
        return conn.hexists(name, key)

    @pipeiflist
    def hget(self, name, key, conn=None):
        return conn.hget(name, key)

    @pipeiflist
    def hgetall(self, name, conn=None):
