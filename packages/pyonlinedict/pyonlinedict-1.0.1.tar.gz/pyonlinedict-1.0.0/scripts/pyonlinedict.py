...
def usage():
	print 'Copyright (c) 2016 pyonlinedict ' + version + ' by 4ido10n'
	print 'Blog: https://www.hackfun.org'
	print 'Home: https://github/4ido10n/pyonlinedict\n'
	...
	print '  ' + sys.argv[0] + ' -l'
	print '  ' + sys.argv[0] + ' -v'
	print '  ' + sys.argv[0] + ' -q hello'
	print '  ' + sys.argv[0] + ' -q hello -f en -t zh'
	print '  ' + sys.argv[0] + " -q 'Hello word!' -f en -t zh"
