...
"""Usage: kaptl init <name> <rules> --license=KEY [--build] [--recipe=RECIPENAME] [--backend=STACK] [--frontend=STACK]
...
def checkLicense():
    ...
    print
    "Use of KAPTL requires a license key. Obtain a valid key at www.kaptl.com and use --license" \
