...
import rollbar
if (os.environ.get('ROLLBAR_KEY')):
    rollbar.init(os.environ.get('ROLLBAR_KEY'), os.environ.get('ENVIRONMENT', 'unknown_environment'))
else:
    logging.info("Rollbar key not set")
        ...
        if trace_string:
            ...
            if (os.environ.get('ROLLBAR_KEY')):
                try:
                    ...
                    logging.info("Exception calling rollbar")
