...
import dfasat.lib.dfasat as dfasat
import dfasat.eval as e
import sys
...
class DFASATEstimator(BaseEstimator):
    ...
    def __init__(self, **kwargs):
        ...
        self.parameters = dfasat.parameters()
...
#                raise ValueError("argument cannot contain info or NaN")
    ...
    def fit_(self, dfa_file=None, dfa_data=None, output_file="dfa"):
        ...
        dfasat.init_with_params(self.parameters)
        a = dfasat.apta()
        l = getattr(dfasat, self.parameters.hName)()

        self.merger = dfasat.state_merger(l, a)
        ...
        print('starting dfasat')
        dfasat.dfasat(self.merger, self.parameters.sat_program, output_dot_file, output_aut_file)
        print('dfasat done')
