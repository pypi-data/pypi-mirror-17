...
-------------
    ...
    - `Initialisation from lists or parameter lists`_.
    - `Initialisation from JSON strings`_.
    - `Initialisation from dict, OrderedDict, or key word arguments`_.
...
be overridden without disturbing the __JSON__ method.
