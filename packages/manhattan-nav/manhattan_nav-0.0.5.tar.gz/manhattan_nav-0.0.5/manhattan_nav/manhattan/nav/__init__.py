...
class Nav:
    ...
    def menu(self, name):
        ...
        returned, if not it's generated, stored and returned.
        """
    ...
    def query(cls, endpoint, **view_args):
        ...
        return QueryResult(
            ...
            active_sub=flask.request.path.startswith(url + '/' if url else '-'),
            url=url
            )
...
class NavItem:
    ...
    described as menus, e.g:
        ...
        menu.add_item(NavItem('Some link', 'some.endpoint'))
