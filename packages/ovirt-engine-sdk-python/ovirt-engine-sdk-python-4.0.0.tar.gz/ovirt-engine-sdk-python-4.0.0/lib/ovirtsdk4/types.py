...
class Action(Identified):
    ...
    def exclussive(self):
        """
        Returns the value of the `exclussive` property.
        """
        return self._exclussive

    @exclussive.setter
    def exclussive(self, value):
        """
        Sets the value of the `exclussive` property.
        """
        self._exclussive = value
