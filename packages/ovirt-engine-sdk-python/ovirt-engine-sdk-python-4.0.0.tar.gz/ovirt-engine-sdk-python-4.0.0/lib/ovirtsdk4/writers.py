...
class ActionWriter(Writer):
    ...
    def write_one(obj, writer, singular=None):
        ...
        if obj.exclussive is not None:
            Writer.write_boolean(writer, 'exclussive', obj.exclussive)
        ...
        if obj.iscsi_targets is not None and len(obj.iscsi_targets) > 0:
...
class BootWriter(Writer):
    ...
    def write_one(obj, writer, singular=None):
        ...
        if href is not None:
            writer.write_attribute('href', href)
        if obj.devices is not None and len(obj.devices) > 0:
...
class ClusterWriter(Writer):
    ...
    def write_one(obj, writer, singular=None):
        ...
        if obj.required_rng_sources is not None and len(obj.required_rng_sources) > 0:
...
class GlusterVolumeWriter(Writer):
    ...
    def write_one(obj, writer, singular=None):
        ...
        if obj.transport_types is not None and len(obj.transport_types) > 0:
...
class HardwareInformationWriter(Writer):
    ...
    def write_one(obj, writer, singular=None):
        ...
        if obj.supported_rng_sources is not None and len(obj.supported_rng_sources) > 0:
...
class MethodWriter(Writer):
    ...
    def write_one(obj, writer, singular=None):
        ...
        if href is not None:
            writer.write_attribute('href', href)
        if obj.id is not None:
            writer.write_element('id', obj.id.value)
        writer.write_end()
...
class NetworkWriter(Writer):
    ...
    def write_one(obj, writer, singular=None):
        ...
        if obj.usages is not None and len(obj.usages) > 0:
            writer.write_start('usages')
            for item in obj.usages:
                if item is not None:
                    Writer.write_string(writer, 'usage', item)
            writer.write_end()
        if obj.vlan is not None:
            VlanWriter.write_one(obj.vlan, writer, 'vlan')
        if obj.cluster is not None:
...
class OpenStackSubnetWriter(Writer):
    ...
    def write_one(obj, writer, singular=None):
        ...
        if obj.description is not None:
            Writer.write_string(writer, 'description', obj.description)
        if obj.dns_servers is not None and len(obj.dns_servers) > 0:
...
class SshWriter(Writer):
    ...
    def write_one(obj, writer, singular=None):
        ...
        if obj.authentication_method is not None:
            Writer.write_string(writer, 'authentication_method', obj.authentication_method)
        if obj.comment is not None:
            Writer.write_string(writer, 'comment', obj.comment)
        if obj.description is not None:
            Writer.write_string(writer, 'description', obj.description)
