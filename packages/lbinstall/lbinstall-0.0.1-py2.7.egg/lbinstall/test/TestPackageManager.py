...
class Test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.url = "http://lhcbproject.web.cern.ch/lhcbproject/dist/rpm/lhcb/%s" % self.filename
        logging.basicConfig()
    ...
    def testProvides(self):
        ...
        res = pm._getProvides()
        ref = [('/bin/sh', '', None), ('BRUNEL_v51r0_x86_64_slc6_gcc49_opt', '1.0.0-1', 'EQ')]
    ...
    def testGetTopDir(self):
        ...
        pm = PackageManager(self.filename)
        ref = "./opt/LHCbSoft/lhcb/BRUNEL/BRUNEL_v51r0/InstallArea/x86_64-slc6-gcc49-opt"
        self.assertEquals(pm.getTopDir(), ref, "Checking the topdir for the package")
