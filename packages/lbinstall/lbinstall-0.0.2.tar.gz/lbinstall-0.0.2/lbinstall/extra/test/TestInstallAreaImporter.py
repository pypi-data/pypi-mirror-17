...
class Test(unittest.TestCase):
    ...
    def testMatchRPMs(self):
        rpmlist = lookupRPMsForProject(self.installer, "GAUDI", "v27r1", ["x86_64-slc6-gcc49-opt", "x86_64-slc6-gcc49-dbg"])
        for p in rpmlist:
            print p.rpmName()
        self.assertEquals(len(rpmlist), 4, "There should be 4 packages, 2 source/2 bins")
