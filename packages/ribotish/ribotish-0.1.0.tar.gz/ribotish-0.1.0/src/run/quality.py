...
def set_parser(parser):
  ...
  parser.add_argument("-o", type=str, dest="output", required=True, help="Output data file")
  # alt input options
  ...
  parser.add_argument("-f", type=str, dest="figpdfpath", help="Output pdf figure file")
  parser.add_argument("-r", type=str, dest="parapath", help="Output offset parameter file")
  # other options
