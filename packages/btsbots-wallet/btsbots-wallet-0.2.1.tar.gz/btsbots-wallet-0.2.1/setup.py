...
#
#     from btsbots_wallet import metadata
#
# However, when we do this, we also import `btsbots_wallet/__init__.py'. If
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'btsbots_wallet_cli = btsbots_wallet.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'btsbots_wallet_gui = btsbots_wallet.gui:entry_point'
        # ]
    }
)
