...
def setup():
    ...
    subprocess.call("cp edisionnet/* " + HOME, shell=True)
    subprocess.call("cp edisionnet/wpa_cli-actions.sh /etc/wpa_supplicant/wpa_cli-actions.sh", shell=True)
    subprocess.call("chmod 755 /etc/wpa_supplicant/wpa_cli-actions.sh", shell=True)
    subprocess.call("cp edisionnet/network_remote_config.service /lib/systemd/system/network_remote_config.service", shell=True)
