...
from wagtail_model_tools import __version__
...
def get_parser():
    ...
    """
    parser = argparse.ArgumentParser('wagtail-model-tools')
...
def main(args=None):
    """
    Called with ``python -m wagtail_model_tools.tests``: run main test suite.
    """
    ...
    import wagtail_model_tools.tests as test_module
