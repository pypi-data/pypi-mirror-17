...
def wrap_with_request(view_funcs):
...
class View(object):
    ...
    def recieve_request(cls, request):
        uri_params = request.context.get('uri_params', {})
        func = wrap_with_request(cls.get_or_post_functions())
        return func(request, **uri_params)
