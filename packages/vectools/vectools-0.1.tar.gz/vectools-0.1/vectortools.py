#!/usr/bin/env python
""" Vectortools - A samtools inspired package for machine learning applications in bioinformatics.
"""
...
def generatehelpstr():
    ...
    Makes a help string for all the functions. If the help string is not present in the tmp, a string is generated.
