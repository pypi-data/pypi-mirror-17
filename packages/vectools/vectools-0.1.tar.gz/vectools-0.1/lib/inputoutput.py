...
class ParseVectors:
    ...
    def __init__(self, file_name="", has_col_names=False, has_row_names=False,
                 col_titles=None, row_titles=None,
                 delimiter="\t", only_apply_on_columns=None):
    ...
    def generate(self, save_row_names=False, return_type=None):
        ...
        for line in file_obj:
            ...
            # np.array(line_split, dtype=self.return_type)
