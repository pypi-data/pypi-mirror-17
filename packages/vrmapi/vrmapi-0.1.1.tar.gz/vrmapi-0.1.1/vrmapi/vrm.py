...
class VRM_API:
    ...
    def __init__(self, username=None, password=None, demo=False, debug=False):
        """
...
if __name__ == '__main__':
    ...
    config = {'vrm_username':'alp@gle.solar',
              'vrm_password':'$%^12345',
              'api_endpoint':'my_endpoint'
            }

    vrm = VRM_API(config=config)

    #vrm.get_attributes()
    now = datetime.now()
    vrm.get_counters_site(4470, yesterday_epoch, now_epoch)
