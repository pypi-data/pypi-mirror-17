...
#     field = Field(dataset.ens[0, member, :], geogrid, levels=[5640], fill_colors=None,
...
# geogrid = Geogrid('1deg-global')
# # Create an empty map
# map = Map(cbar_type='tercile')
# # Create a Field to plot on the Map
# heights_field = Field(heights, geogrid, levels=np.arange(5000, 6000, 50), contour_colors='black',
#                       smoothing_factor=0.5, contour_labels=True)
# field = Field(combined_forecast, geogrid, fill_colors=combined_colors, smoothing_factor=0.5,
...
# # Create an empty map
# map = Map(title='Example - Default Options')
# # Create a Field to plot on the Map
...
#
# # Create an empty map
# map = Map(title='Example - Mercator Global', projection='mercator', domain='global')
# # Create a Field to plot on the Map
# field = Field(data, geogrid)
# # Plot the Field on the Map
# map.plot(field)
...
# ]
# # Create an empty map
# map = Map(title='Example - Tercile Data/Colorbar', cbar_type='tercile')
# # Create a Field to plot on the Map
...
# field = Field(terciles, geogrid, fill_colors=tercile_colors, smoothing_factor=0.5,
#               levels=[-90, -80, -70, -60, -50, -40, -33, 33, 40, 50, 60, 70, 80, 90])
# # Plot the Field on the Map
# map.plot(field)
# # Save the plot to a PNG
...
#
# # Create an empty map
# map = Map(title='Example - Specified Levels')
# # Create a Field to plot on the Map
# field = Field(data, geogrid, levels=range(5000, 6000, 60))
# # Plot the Field on the Map
# map.plot(field)
# # Save the plot to a PNG
...
#
# # Create an empty map
# map = Map(title='Example - Colored Contours')
# # Create a Field to plot on the Map
# field = Field(data, geogrid, levels=range(5000, 6000, 60), smoothing_factor=1, fill_colors=None)
# # Plot the Field on the Map
# map.plot(field)
# # Save the plot to a PNG
...
#
# # Create an empty map
# map = Map(title='Example - B & W Contours')
# # Create a Field to plot on the Map
# field = Field(data, geogrid, levels=range(5000, 6000, 60), smoothing_factor=1, fill_colors=None,
...
#
# # Create an empty map
# map = Map(title='Example - Specified Fill Colors')
# # Create a Field to plot on the Map
# field = Field(data, geogrid, levels=[5400, 5600], smoothing_factor=1,
...
# Create an empty map
map = Map(title='Example - Two Fields')
# Create a Field to plot on the Map
field1 = Field(data, geogrid, levels=[5400, 5600], smoothing_factor=1,
              fill_colors=['blue', 'grey', 'red'])
field2 = Field(data, geogrid, levels=range(5000, 6000, 60), smoothing_factor=1,
               contour_colors='black', contour_labels=True)
# Plot the Field on the Map
map.plot(field1, field2)
# Save the plot to a PNG
map.save('example-two-fields.png', dpi=100)

from cpc.geoplot.map import Map, get_supported_domains, get_supported_projections

for proj in get_supported_projections():
    for dom in get_supported_domains():
        try:
            Map(projection=proj, domain=dom).save('empty-Map-{}-{}.png'.format(proj, dom), dpi=100)
