        ...
        "children": [
            {
                ...
                "file": ["https://archive.org/petersethics00arisrich/petersethics00arisrich.pdf"],
                ...
                "children": [
                    {
                        ...
                        "id": "8326cc",
                        "related_to": ["aaaa4d"],
                        "file": "archive.org/download/critique_pure_reason_0709_librivox/critique_of_pure_reason_01_kant.mp3",
                    ...
                    },
                    {
                        ...
                        "id": "aaaa4d",
                        "author": "Immanuel Kant",
                        "file": "https://ia801406.us.archive.org/wonderland_ch_01.mp3",
                        "author": "Immanuel Kant",
                        "license": licenses.PUBLIC_DOMAIN,
                    }
                ]
    ...
    },
    {
        ...
        "children": [
            ...
            },
            {
                ...
                "thumbnail":"storage/10a205796fb430812a21a545673645b4.jpg",
                "questions": [
                    {
                        "id": "eeeee",
                    ...
                    {
                        "id": "11111",
                        "question": "<h3 id='rainbow'><b>RRRRRIIIIICCCCCEEEEE!!!!</b></h3>![](https://lh3.googleusercontent.com/-7RWJSqJLzQw/AAAAAAAAAAI/AAAAAAAAAAU/ELjZcGQCm8s/photo.jpg)><script type='text/javascript'><!-- setInterval(function() {$('#rainbow').css('color', '#'+((1<<24)*Math.random()|0).toString(16));}, 800); --></script>",
                        "type":exercises.FREE_RESPONSE,
...
def construct_channel(**kwargs):
    ...
    channel = Channel(
        ...
        channel_id="another-sample-channel",
