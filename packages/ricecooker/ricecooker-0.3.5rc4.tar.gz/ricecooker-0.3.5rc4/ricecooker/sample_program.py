        ...
        "children": [
            ...
            },
            {
                ...
                "questions": [
                    ...
                    {
                        "id": "11111",
                        "question": "<h3 id='rainbow'><b>RRRRRIIIIICCCCCEEEEE!!!!</b></h3>![](https://lh3.googleusercontent.com/-7RWJSqJLzQw/AAAAAAAAAAI/AAAAAAAAAAU/ELjZcGQCm8s/photo.jpg)<script type='text/javascript'><!-- setInterval(function() {$('#rainbow').css('color', '#'+((1<<24)*Math.random()|0).toString(16));}, 100); --></script>",
                        "type":exercises.FREE_RESPONSE,
