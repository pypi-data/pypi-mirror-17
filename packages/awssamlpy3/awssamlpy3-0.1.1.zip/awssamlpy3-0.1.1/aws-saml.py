...
idpentryurl = 'https://sts.pega.com/adfs/ls/IdpInitiatedSignOn.aspx?loginToRp=urn:amazon:webservices'
...
s3conn = boto.s3.connect_to_region(region,aws_access_key_id=token.credentials.access_key,aws_secret_access_key=token.credentials.secret_key,security_token=token.credentials.session_token)
