...
setup(
    description='Rask Mercadolivre Connector',
    install_requires=[
        'rask',
    ],
    license='https://gitlab.com/vikingmakt/rask_njord_mercadolivre/raw/master/LICENSE',
    maintainer='Umgeher Torgersen',
    maintainer_email='me@umgeher.org',
    name='rask_njord_mercadolivre',
    packages=find_packages(),
    url='https://gitlab.com/vikingmakt/rask_njord_mercadolivre',
    version=git_version()
)
