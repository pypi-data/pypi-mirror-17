...
.. |Tecplot License| replace:: `Tecplot 360 EX License <http://www.tecplot.com/my/license-keys>`__
    ...
    for name, obj in matches:
        if obj[1] == 'module':
            ...
            results.append(('py:' + self.role_for_objtype(obj[1]),
                            sphinx.util.nodes.make_refnode(builder, fromdocname, obj[0], name,
                                         contnode, name)))
...
sphinx.domains.python.PythonDomain.resolve_any_xref = python_resolve_any_xref
