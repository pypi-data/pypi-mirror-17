...
- Rather than assuming the requested ActivationDate is "now" or "as soon as possible", allow
the start and end dates to be set as parameters.

- Allow the user to set a value for the AgreementIdentifier
