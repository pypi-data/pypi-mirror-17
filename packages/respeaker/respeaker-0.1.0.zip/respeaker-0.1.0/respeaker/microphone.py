...
pocketsphinx_data = os.getenv('POCKETSPHINX_DATA', current_file_dir)
...
class Microphone:
    ...
    def create_decoder():
        ...
        config.set_string('-hmm', os.path.join(pocketsphinx_data, 'pocketsphinx-data/hmm'))
        config.set_string('-dict', os.path.join(pocketsphinx_data, 'pocketsphinx-data/en.dic'))
        config.set_string('-kws', os.path.join(pocketsphinx_data, 'pocketsphinx-data/keywords.txt'))
