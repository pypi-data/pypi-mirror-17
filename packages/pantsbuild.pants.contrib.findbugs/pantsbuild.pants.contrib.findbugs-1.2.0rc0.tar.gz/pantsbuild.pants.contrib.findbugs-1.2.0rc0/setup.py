...
# Target: ContribPlugin(BuildFileAddress(BuildFile(contrib/findbugs/src/python/pants/contrib/findbugs/BUILD, FileSystemProjectTree(/Users/benjyw/src/pants)), plugin))
