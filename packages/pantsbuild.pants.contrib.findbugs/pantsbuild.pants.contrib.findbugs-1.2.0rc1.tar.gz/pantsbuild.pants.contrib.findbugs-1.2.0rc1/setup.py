...
# Target: ContribPlugin(BuildFileAddress(BuildFile(contrib/findbugs/src/python/pants/contrib/findbugs/BUILD, FileSystemProjectTree(/Users/stuhood/src/pants)), plugin))
...
{   'classifiers': [   'Intended Audience :: Developers',
    ...
    'entry_points': {   'pantsbuild.plugin': [   'register_goals = pants.contrib.findbugs.register:register_goals']},
    ...
    'name': 'pantsbuild.pants.contrib.findbugs',
