...
class UCB1Tuned(UCBInterface):
    ...
    def __init__(
        ...
        """Construct an UCB1-tuned object. See superclass :class:`moe.bandit.ucb.ucb_interface.UCBInterface` for details."""
    ...
    def get_ucb_payoff(self, sampled_arm, number_sampled):
        ...
        where :math:`\sigma^2` is the sample variance of arm *j* (the given ``sampled_arm``),
        ...
        where :math:`\mu` is the average payoff obtained from arm *j* and 1/4 is
        an upper bound on the variance of a Bernoulli random variable.
