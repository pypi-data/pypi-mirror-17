...
def read_changelog(file_path):
    with open(file_path, 'r') as fh:
        log = fh.read()
        log = log.lstrip('# Change Log').strip()
        log = log.rstrip('\* *This Change Log was automatically generated by [github_changelog_generator](https://github.com/skywinder/Github-Changelog-Generator)*')
        return parse(log)
