...
class ServerService(rpyc.Service):
	...
	def exposed_align(self,pir_sequence_file,template):
			...
			teste = Align(self.pdb_folder, PFAMDatabase, self.workdir, os.path.basename(template),os.path.basename(pir_sequence_file))
	...
	def exposed_model(self, ali_ali, template):
		teste = Modeler(self.pdb_folder, self.workdir, os.path.basename(template), os.path.basename(ali_ali))
