from AutomodelServerModules.pdb import pdb
import os
from Modeller_Caller import modeller_caller
from RunCommand import RunCommand
from Bio import SearchIO
from AutomodelServerModules.AlignmentBuilder import AlignmentBuilder
class Align:
    def __init__(self, modeldir,pdb_file,seq_ali):
        self.seq_ali = modeldir + seq_ali
        # self.pfam_database = pfam_database
        # self.pdb_folder = pdb_folder
        self.modeldir = modeldir
        self.pdb_file = pdb(modeldir + pdb_file)
