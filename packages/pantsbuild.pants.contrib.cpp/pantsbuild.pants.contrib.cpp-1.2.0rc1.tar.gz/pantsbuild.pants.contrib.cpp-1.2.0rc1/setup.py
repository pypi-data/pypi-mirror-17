...
# Target: ContribPlugin(BuildFileAddress(BuildFile(contrib/cpp/src/python/pants/contrib/cpp/BUILD, FileSystemProjectTree(/Users/stuhood/src/pants)), plugin))
...
{   'classifiers': [   'Intended Audience :: Developers',
    ...
    'entry_points': {   'pantsbuild.plugin': [   'build_file_aliases = pants.contrib.cpp.register:build_file_aliases',
                                                 'register_goals = pants.contrib.cpp.register:register_goals']},
    ...
    'packages': [   'pants',
                    'pants.contrib',
                    'pants.contrib.cpp',
                    'pants.contrib.cpp.targets',
                    'pants.contrib.cpp.tasks',
                    'pants.contrib.cpp.toolchain'],
