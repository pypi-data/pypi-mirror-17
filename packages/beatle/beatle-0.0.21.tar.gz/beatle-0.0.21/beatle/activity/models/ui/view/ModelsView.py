...
from activity.models.ui import ui
from activity.models.ui import dlg as ui_dlg
import app.clipboard as clipboard
...
class clip_item_model(object):
    ...
    def __init__(self, object):
        ...
        """
        # self.copyType = type(object)
        #self.copyArgs = object.get_kwargs()
        self.proj = object.project
        self.lang = self.proj._language
        self.type = type(object)
        self.args = object.get_kwargs()
...
class ModelsView(BaseView, ui.ModelsView):
    ...
    def _create_menus(self):
        ...
        # add project
        self._addProject = wx.MenuItem(self._menuAdd, app.ID_NEW_PROJECT, u"Project ...", u"Add new project", wx.ITEM_NORMAL)
    ...
    def _bind_events(self):
        ...
        self.BindSpecial(wx.EVT_UPDATE_UI, self.OnUpdateEditOpen, id=app.ID_EDIT_OPEN)
        self.BindSpecial(wx.EVT_MENU, self.OnEditOpen, id=app.ID_EDIT_OPEN)

        self.BindSpecial(wx.EVT_UPDATE_UI, self.OnUpdateEditContext, id=app.ID_EDIT_CONTEXT)
        self.BindSpecial(wx.EVT_MENU, self.OnEditContext, id=app.ID_EDIT_CONTEXT)

        self.BindSpecial(wx.EVT_UPDATE_UI, self.OnUpdateEditUserSections, id=app.ID_EDIT_USER_SECTIONS)
        self.BindSpecial(wx.EVT_MENU, self.OnEditUserSections, id=app.ID_EDIT_USER_SECTIONS)
    ...
    def OnDelete(self, event):
        ...
        obj = self.selected
        aliasMap = {
            model.cc.Class: "c++ class {0}", model.py.Class: "python class {0}",
            model.cc.Inheritance: "inheritance {0}", model.py.Inheritance: "c++ inheritance from {0}",
            model.py.Inheritance: "inheritance {0}", model.py.Inheritance: "python inheritance from {0}",
            ...
            model.cc.Destructor: "destructor {0}", model.Folder: "folder {0}",
            model.cc.IsClassMethod: "method {0}", model.cc.Friendship: "friend {0}",
            model.cc.MemberData: "member {0}", model.cc.MemberMethod: "c++ method {0}",
            model.py.MemberMethod: "python method {0}",
            model.ClassDiagram: "diagram {0}", model.Project: "project {0}",
            model.cc.RelationFrom: "relation {0}", model.cc.RelationTo: "relation {0}",
            model.cc.Namespace: "namespace {0}", model.cc.Type: "type {0}",
            model.cc.Module: 'c++ module "{0}"', model.cc.Function: "c++ function {0}",
            model.cc.pyBoostModule: 'c++ boost.python "{0}"',
            model.py.Function: 'python function {0}',
            model.py.Module: 'python module "{0}"', model.Library: "library {0}",
            model.cc.Data: 'c++ variable {0}', model.py.Data: 'python variable {0}',
            model.py.Import: 'python import {0}', model.py.Decorator: 'python decorator {0}',
    ...
    @wxx.EditionDialog(ui_dlg.UserSectionsDialog)
    ...
    @wxx.CreationDialog(ui_dlg.SelectLibrariesDialog, model.Library)
    ...
    @wxx.CreationDialog(app.ui.dlg.FolderDialog, model.Folder)
    ...
    @wxx.CreationDialog(ui_dlg.ModuleDialog, model.cc.Module)
    ...
    @wxx.CreationDialog(ui_dlg.NamespaceDialog, model.cc.Namespace)
    ...
    @wxx.CreationDialog(ui_dlg.TypeDialog, model.cc.Type)
    ...
    @wxx.CreationDialog(ui_dlg.EnumDialog, model.cc.Enum)
    ...
    @wxx.CreationDialog(ui_dlg.ClassDialog, model.cc.Class)
    ...
    @wxx.CreationDialog(ui_dlg.InheritanceDialog, model.cc.Inheritance)
    ...
    @wxx.CreationDialog(ui_dlg.SelectFriendsDialog, model.cc.Friendship)
    ...
    @wxx.CreationDialog(ui_dlg.MemberDialog, model.cc.MemberData)
    ...
    @wxx.CreationDialog(ui_dlg.ConstructorDialog, model.cc.Constructor)
    ...
    @wxx.CreationDialog(ui_dlg.MemberMethodDialog, model.cc.MemberMethod)
    ...
    @wxx.CreationDialog(ui_dlg.DestructorDialog, model.cc.Destructor)
    ...
    @wxx.CreationDialog(ui_dlg.ArgumentDialog, model.cc.Argument)
    ...
    @wxx.CreationDialog(ui_dlg.FunctionDialog, model.cc.Function)
    ...
    @wxx.CreationDialog(ui_dlg.VariableDialog, model.cc.Data)
    ...
    @wxx.CreationDialog(ui_dlg.VirtualMethodsDialog, model.cc.MemberMethod)
    ...
    @wxx.CreationDialog(ui_dlg.IsClassMethods, model.cc.IsClassMethod)
    ...
    @wxx.CreationDialog(ui_dlg.RelationDialog, model.cc.Relation)
    ...
    @wxx.CreationDialog(ui_dlg.BoostPythonModuleDialog, model.cc.pyBoostModule)
    ...
    @deco.with_python_export
    @tran.TransactionalMethod('add python pakage {0}')
    @wxx.CreationDialog(ui_dlg.PyPackageDialog, model.py.Package)
    ...
    @wxx.CreationDialog(ui_dlg.PyModuleDialog, model.py.Module)
    ...
    @wxx.CreationDialog(ui_dlg.PyImportDialog, model.py.Import)
    ...
    @wxx.CreationDialog(ui_dlg.PyClassDialog, model.py.Class)
    ...
    @wxx.CreationDialog(ui_dlg.PyInheritanceDialog, model.py.Inheritance)
    ...
    @wxx.CreationDialog(ui_dlg.PyMemberMethodDialog, model.py.MemberMethod)
    ...
    @wxx.CreationDialog(ui_dlg.PyArgumentDialog, model.py.Argument)
    ...
    @wxx.CreationDialog(ui_dlg.PyMemberDialog, model.py.MemberData)
    ...
    @wxx.CreationDialog(ui_dlg.PyFunctionDialog, model.py.Function)
    ...
    @wxx.CreationDialog(ui_dlg.PyVariableDialog, model.py.Data)
    ...
    @wxx.CreationDialog(ui_dlg.EditDecoratorsDialog, model.py.Decorator)
