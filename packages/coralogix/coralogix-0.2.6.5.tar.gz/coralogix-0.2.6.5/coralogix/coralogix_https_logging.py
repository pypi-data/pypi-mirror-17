...
class CoralogixHTTPSHandler(Handler, object):
    ...
    _get_time_uri = "{}/sdk/v1/time"  # URL to get server timedelta
    # POST command parameters:
    _post_uri = "{}/api/v1/logs"  # Coralogix URL for http-post requests
    ...
    def emit(self, record):
        try:
            ...
            log_entry["threadId"] = record.__dict__["override_thread"] if "override_thread" in record else record.thread
