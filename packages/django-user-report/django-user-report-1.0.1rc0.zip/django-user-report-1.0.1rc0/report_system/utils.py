...
def get_email_receiver(target_object):
    target_name = "{0}.{1}".format(target_object._meta.app_label, target_object._meta.object_name)
    for object_name, field_name in list(settings.REPORT_EMAIL_RECEIVER_FIELDNAME):
