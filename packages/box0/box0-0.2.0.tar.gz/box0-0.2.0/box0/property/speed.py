...
from box0.property import Property, WithValues, GetSetUInt32

class Speed(Property, WithValues, GetSetUInt32):
	_info = libbox0.b0_speed_info
	_cache_flush = libbox0.b0_speed_cache_flush

	_set = libbox0.b0_speed_set
	_get = libbox0.b0_speed_get
