...
from box0.property import Property, WithValue
from box0.exceptions import ResultException

class Buffer(Property, WithValue):
	_info = libbox0.b0_buffer_info
	_cache_flush = libbox0.b0_buffer_cache_flush

	def __init__(self, prop):
		Property.__init__(self, prop)
		WithValue.__init__(self)
