	...
	class _Users(_CommonAPIClass):
		...
		class _Mysoftware(_CommonAPIClass):
			...
			class _Licenses(_CommonAPIClass):
				...
				def Uploadfile(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/mysoftware/' + str(self._get('Msid')) + '/licenses/' + str(self._get('Mslid')) + '/' + str(self._get('Filename')) + '', 'POST', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/mysoftware/{msid}/licenses/{mslid}
				def Download(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/mysoftware/' + str(self._get('Msid')) + '/licenses/' + str(self._get('Mslid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/mysoftware/{msid}/licenses/{mslid}
				def Delete(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/mysoftware/' + str(self._get('Msid')) + '/licenses/' + str(self._get('Mslid')) + '', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/mysoftware/{msid}/licenses/{mslid}
				def Upload(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/mysoftware/' + str(self._get('Msid')) + '/licenses/' + str(self._get('Mslid')) + '', 'POST', body, element_name, streamingResponseFile, **kwargs)
			...
			class _Pkgs(_CommonAPIClass):
				...
				def Get(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/mysoftware/' + str(self._get('Msid')) + '/pkgs/' + str(self._get('Mspackid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/mysoftware/{msid}/pkgs/{mspackid}
				def Update(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/mysoftware/' + str(self._get('Msid')) + '/pkgs/' + str(self._get('Mspackid')) + '', 'PUT', body, element_name, streamingResponseFile, **kwargs)
				...
				def Getall(self, Filename=None, body=None, element_name=None, streamingResponseFile=None):
					...
					return self._REST('/users/' + str(self._get('Uid')) + '/mysoftware/' + str(self._get('Msid')) + '/pkgs', 'GET', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/mysoftware/{msid}/pkgs/{mspackid}
				def Delete(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/mysoftware/' + str(self._get('Msid')) + '/pkgs/' + str(self._get('Mspackid')) + '', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/mysoftware/{msid}/pkgs
				def Add(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/mysoftware/' + str(self._get('Msid')) + '/pkgs', 'POST', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/mysoftware/{msid}/pkgs
				def Deleteall(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/mysoftware/' + str(self._get('Msid')) + '/pkgs', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/mysoftware/{msid}/pkgs
				def Updateall(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/mysoftware/' + str(self._get('Msid')) + '/pkgs', 'PUT', body, element_name, streamingResponseFile, **kwargs)
				class _Bin(_CommonAPIClass):
					def __call__(self, Filename=None):
						self.Filename = Filename
						return self
					...
					def Download(self, Downloadid=None, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {'downloadId': Downloadid}
						return self._REST('/users/' + str(self._get('Uid')) + '/mysoftware/' + str(self._get('Msid')) + '/pkgs/' + str(self._get('Mspackid')) + '/bin', 'GET', body, element_name, streamingResponseFile, **kwargs)
					
					#URL: users/{uid}/mysoftware/{msid}/pkgs/{mspackid}/bin/{fileName}
					def Upload(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
						return self._REST('/users/' + str(self._get('Uid')) + '/mysoftware/' + str(self._get('Msid')) + '/pkgs/' + str(self._get('Mspackid')) + '/bin/' + str(self._get('Filename')) + '', 'POST', body, element_name, streamingResponseFile, **kwargs)
					
					#URL: users/{uid}/mysoftware/{msid}/pkgs/{mspackid}/bin/{fileName}
					def Downloadfile(self, Downloadid=None, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {'downloadId': Downloadid}
						return self._REST('/users/' + str(self._get('Uid')) + '/mysoftware/' + str(self._get('Msid')) + '/pkgs/' + str(self._get('Mspackid')) + '/bin/' + str(self._get('Filename')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
		...
		class _Scannedinstances(_CommonAPIClass):
			...
			class _Scans(_CommonAPIClass):
				...
				#URL: users/{uid}/scannedinstances/{siid}/scans
				def Getall(self, Query=None, Descending=None, Orderby=None, Count=None, Offset=None, Includestats=None, Delta=None, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {'query': Query, 'descending': Descending, 'orderBy': Orderby, 'count': Count, 'offset': Offset, 'includeStats': Includestats, 'delta': Delta}
	...
	class _Distributions(_CommonAPIClass):
		...
		class _Projects(_CommonAPIClass):
			...
			def Delete(self, Erase=None, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {'erase': Erase}
				return self._REST('/distributions/' + str(self._get('Id')) + '/projects/' + str(self._get('Pid')) + '', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
			
			#URL: distributions/{id}/projects/{pid}
			def Update(self, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {}
				return self._REST('/distributions/' + str(self._get('Id')) + '/projects/' + str(self._get('Pid')) + '', 'PUT', body, element_name, streamingResponseFile, **kwargs)
			
			#URL: distributions/{id}/projects
			def Getall(self, Query=None, Descending=None, Orderby=None, Count=None, Offset=None, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {'query': Query, 'descending': Descending, 'orderBy': Orderby, 'count': Count, 'offset': Offset}
				return self._REST('/distributions/' + str(self._get('Id')) + '/projects', 'GET', body, element_name, streamingResponseFile, **kwargs)
			
			#URL: distributions/{id}/projects/{pid}
			def Get(self, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {}
				return self._REST('/distributions/' + str(self._get('Id')) + '/projects/' + str(self._get('Pid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
			class _Licenses(_CommonAPIClass):
				def __call__(self, Lid=None, Filename=None):
					self.Lid = Lid
					self.Filename = Filename
				...
				#URL: distributions/{id}/projects/{pid}/licenses/{lid}
				def Download(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/distributions/' + str(self._get('Id')) + '/projects/' + str(self._get('Pid')) + '/licenses/' + str(self._get('Lid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: distributions/{id}/projects/{pid}/licenses/{lid}
				def Uploadchunk(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/distributions/' + str(self._get('Id')) + '/projects/' + str(self._get('Pid')) + '/licenses/' + str(self._get('Lid')) + '', 'POST', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: distributions/{id}/projects/{pid}/licenses/{lid}/{fileName}
				def Upload(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/distributions/' + str(self._get('Id')) + '/projects/' + str(self._get('Pid')) + '/licenses/' + str(self._get('Lid')) + '/' + str(self._get('Filename')) + '', 'POST', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: distributions/{id}/projects/{pid}/licenses/{lid}
				def Delete(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/distributions/' + str(self._get('Id')) + '/projects/' + str(self._get('Pid')) + '/licenses/' + str(self._get('Lid')) + '', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
				
			
			class _Pkgs(_CommonAPIClass):
				def __call__(self, Pkgid=None):
					self.Pkgid = Pkgid
					return self
				...
				def Delete(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/distributions/' + str(self._get('Id')) + '/projects/' + str(self._get('Pid')) + '/pkgs/' + str(self._get('Pkgid')) + '', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: distributions/{id}/projects/{pid}/pkgs
				def Getall(self, Filename=None, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {'filename': Filename}
					return self._REST('/distributions/' + str(self._get('Id')) + '/projects/' + str(self._get('Pid')) + '/pkgs', 'GET', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: distributions/{id}/projects/{pid}/pkgs/{pkgid}
				def Get(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/distributions/' + str(self._get('Id')) + '/projects/' + str(self._get('Pid')) + '/pkgs/' + str(self._get('Pkgid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: distributions/{id}/projects/{pid}/pkgs/{pkgid}
				def Update(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/distributions/' + str(self._get('Id')) + '/projects/' + str(self._get('Pid')) + '/pkgs/' + str(self._get('Pkgid')) + '', 'PUT', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: distributions/{id}/projects/{pid}/pkgs
				def Deleteall(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/distributions/' + str(self._get('Id')) + '/projects/' + str(self._get('Pid')) + '/pkgs', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: distributions/{id}/projects/{pid}/pkgs
				def Create(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/distributions/' + str(self._get('Id')) + '/projects/' + str(self._get('Pid')) + '/pkgs', 'POST', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: distributions/{id}/projects/{pid}/pkgs
				def Update(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/distributions/' + str(self._get('Id')) + '/projects/' + str(self._get('Pid')) + '/pkgs', 'PUT', body, element_name, streamingResponseFile, **kwargs)
				class _Bin(_CommonAPIClass):
					def __call__(self, Filename=None):
						self.Filename = Filename
						return self
					...
					def Downloadfile(self, Downloadid=None, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {'downloadId': Downloadid}
						return self._REST('/distributions/' + str(self._get('Id')) + '/projects/' + str(self._get('Pid')) + '/pkgs/' + str(self._get('Pkgid')) + '/bin/' + str(self._get('Filename')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
					
					#URL: distributions/{id}/projects/{pid}/pkgs/{pkgid}/bin/{fileName}
					def Upload(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
						return self._REST('/distributions/' + str(self._get('Id')) + '/projects/' + str(self._get('Pid')) + '/pkgs/' + str(self._get('Pkgid')) + '/bin/' + str(self._get('Filename')) + '', 'POST', body, element_name, streamingResponseFile, **kwargs)
					
					#URL: distributions/{id}/projects/{pid}/pkgs/{pkgid}/bin
					def Download(self, Downloadid=None, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {'downloadId': Downloadid}
						return self._REST('/distributions/' + str(self._get('Id')) + '/projects/' + str(self._get('Pid')) + '/pkgs/' + str(self._get('Pkgid')) + '/bin', 'GET', body, element_name, streamingResponseFile, **kwargs)
