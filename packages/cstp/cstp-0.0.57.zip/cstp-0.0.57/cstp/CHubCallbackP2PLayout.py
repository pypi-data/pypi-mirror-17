...
'''
import sys
from weberFuncs import GetCurrentTime,PrintTimeMsg,PrintAndSleep,printCmdString
...
class CHubCallbackP2PLayout(CHubCallbackQueueBase):
    ...
    def BroadcastP2PMsgToSuffixSet(self, sPairId, setSuffix, CmdIStr):
        ...
        bVerbosePrintCmdStr = self.GetHubAttrValue('bVerbosePrintCmdStr',True)
        if not bVerbosePrintCmdStr:
            printCmdString("BroadcastP2PMsg.Return(%s)" % CmdOStrRet[0],CmdIStr)
        return CmdOStrRet
