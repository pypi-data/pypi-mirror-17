...
def StartCmdStringSckP2PLayoutSH(dictPeerByParam, sHostName4Param, sSuffix, clsSckP2PLayout, *args, **kwargs):
    ...
    if sIPPort and sHubId and sSuffix and sAcctPwd:
        ...
        cssa = clsSckP2PLayout(sHubId,sIPPort,sPairId,sSuffix,sAcctPwd,sClientInfo, *args, **kwargs)
        cssa.StartMainThreadLoop()
        return True
    else:
