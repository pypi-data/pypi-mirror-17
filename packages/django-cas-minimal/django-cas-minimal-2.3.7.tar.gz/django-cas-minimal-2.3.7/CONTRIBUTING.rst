...
django-cas could always use more documentation, whether as part of the 
official django-cas docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 2.7 and for Django version 1.7.4. Check 
   https://travis-ci.org/ParthKolekar/django-cas/pull_requests
