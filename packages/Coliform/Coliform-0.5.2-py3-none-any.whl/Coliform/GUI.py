...
def startGUI():
    ...
    ttk.Button(f5, text="Take Picture", command=picturetaken).grid(column=2, row=1, sticky=E)
    ttk.Button(f5, text="Choose Directory", command=directorychosen).grid(column=2, row=4, sticky=E)
    ttk.Label(f5, text="Intensity: ").grid(column=1, row=1, sticky=W)
    intensitylabel = ttk.Label(f5, text='Not Taken')
    intensitylabel.grid(column=1, row=2, sticky=W)
    ttk.Button(f5, text="Show Plots", command=showimageplot).grid(column=2, row=2, sticky=E)
    ttk.Button(f5, text="Show Image", command=showimage).grid(column=2, row=3, sticky=E)
