...
def startCameraGUI():
    ...
    ttk.Button(f5, text="Show Green", command=showblueimage).grid(column=3, row=2, sticky=(W, E))
    ttk.Button(f5, text="Show Blue", command=showgreenimage).grid(column=3, row=3, sticky=(W, E))
