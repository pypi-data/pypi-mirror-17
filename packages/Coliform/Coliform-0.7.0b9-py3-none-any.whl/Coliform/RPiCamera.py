...
def showImage(rgb_array, color='true'):
    ...
    if color == 'all':
        ...
        fname = Canvas(app, bg='black', height=600, width=1000)

        trueimage = PhotoImage(master=fname, file='true.png')
        redimage = PhotoImage(master=fname, file='red.png')
        greenimage = PhotoImage(master=fname, file='green.png')
        blueimage = PhotoImage(master=fname, file='blue.png')
