...
def startCameraGUI():
    ...
    ttk.Label(f1, text='ISO: (max=800)').grid(column=1, row=1, sticky=E)
    iso_variable = ttk.Entry(f1, width=4, textvariable=isovar)
    iso_variable.grid(column=1, row=2, sticky=E)
    ...
    xresolution_variable.grid(column=2, row=2, sticky=E)
    ttk.Label(f1, text='x').grid(column=3, row=2)
    yresolution_variable = ttk.Entry(f1, width=4, textvariable=resolutionvary)
    yresolution_variable.grid(column=4, row=2, sticky=E)

    exposuremode_variable = ttk.Checkbutton(f1, text='Exposure Mode', variable=exposuremodevar)
    exposuremode_variable.grid(column=1, row=4, sticky=E)

    ttk.Label(f1, text='Capture Delay:').grid(column=2, row=3, sticky=E)
    delay_variable = ttk.Entry(f1, width=4, textvariable=delayvar)
    delay_variable.grid(column=2, row=4, sticky=E)
