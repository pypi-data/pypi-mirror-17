...
def showPlot(rgb_array):
    img_hsv = colors.rgb_to_hsv(rgb_array[..., :3])
    rgb_array_temp = rgb_array * 1
    rgb_array_temp2 = rgb_array * 1
    rgb_array_temp3 = rgb_array * 1
    lu1 = setImageColor(rgb_array_temp, 'r')
    plt.subplot2grid((2, 4), (0, 0))
    plt.imshow(lu1)

    lu2 = setImageColor(rgb_array_temp2, 'g')
    plt.subplot2grid((2, 4), (0, 1))
    plt.imshow(lu2)

    lu3 = setImageColor(rgb_array_temp3, 'b')
