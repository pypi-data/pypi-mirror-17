...
def startCameraGUI():
    ...
    ttk.Label(f3, text='Framerate: ').grid(column=8, row=1, sticky=E)
    delay_variable = ttk.Entry(f3, width=4, textvariable=frameratevar)
    delay_variable.grid(column=9, row=1, sticky=W)
    ...
    ttk.Label(f3, text='Resolution:').grid(column=5, row=2, sticky=E)
    xresolution_variable = ttk.Entry(f3, width=4, textvariable=resolutionvarx)
    xresolution_variable.grid(column=6, row=2, sticky=E)
    ttk.Label(f3, text='x').grid(column=7, row=2)
    yresolution_variable = ttk.Entry(f3, width=4, textvariable=resolutionvary)
    yresolution_variable.grid(column=8, row=2, sticky=W)

    ttk.Label(f3, text='Preview Timeout: ').grid(column=9, row=2, sticky=E)
    delay_variable = ttk.Entry(f3, width=4, textvariable=previewtimeout)
    delay_variable.grid(column=10, row=2, sticky=W)
    ...
    ttk.Button(f5, text="Save All", command=saveallimages).grid(column=2, row=4, sticky=(W, E))
