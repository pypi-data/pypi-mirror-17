...
from gym_vnc.vncdriver import auth, constants, error, screen, server_messages
...
class Framebuffer(object):
    ...
    def apply_format(self, server_pixel_format):
        ...
        print 'setting color cycle: {}'.format(self.color_cycle)
