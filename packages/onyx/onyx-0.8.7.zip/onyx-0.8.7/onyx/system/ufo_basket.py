...
from onyx.core import RDate, DateRange, Curve, Interpolate
from onyx.core import UfoBase, SetField, DictField, GraphNodeVt
...
class Basket(UfoBase):
    ...
    # -------------------------------------------------------------------------
    @GraphNodeVt()
    def GetCurve(self, graph, start, end):
