   ...
   .. graphviz::
      ...
      digraph InheritanceGraph {
          ...
          subgraph cluster_documentationtools {
              ...
              "abjad.tools.documentationtools.GraphvizEdge.GraphvizEdge" [color=black,
                  fontcolor=white,
                  group=2,
                  label=<<B>GraphvizEdge</B>>,
                  shape=box,
                  style="filled, rounded"];
              "abjad.tools.documentationtools.GraphvizMixin.GraphvizMixin" [color=3,
                  group=2,
                  label=GraphvizMixin,
                  shape=oval,
                  style=bold];
...
.. only:: html
   ...
   .. autosummary::
      ...
      ~abjad.tools.documentationtools.GraphvizEdge.GraphvizEdge.attach
      ~abjad.tools.documentationtools.GraphvizEdge.GraphvizEdge.attributes
      ~abjad.tools.documentationtools.GraphvizEdge.GraphvizEdge.detach
...
.. automethod:: abjad.tools.documentationtools.GraphvizEdge.GraphvizEdge.attach

.. automethod:: abjad.tools.documentationtools.GraphvizEdge.GraphvizEdge.detach
