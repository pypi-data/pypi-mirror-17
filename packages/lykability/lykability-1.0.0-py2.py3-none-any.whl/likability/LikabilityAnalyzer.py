...
from likability.twitterAPI import getAPI
from likability.findSentiment import findSentiment
from likability.getTweets import getTweets
...
class analyzer(object):
	...
	def __init__(self,path,num_tweets):
		self.path = os.path.join(module_path, path)
