...
setup(
    ...
    description='Using empythy to score likability based on sentiment analysis of recent tweets about a given person',
    ...
    # Author details
    author='John Keck',
    author_email='robertjkeck2@gmail.com',
    ...
    install_requires=['nltk','scikit-learn','empythy','tweepy','pandas','numpy'],
