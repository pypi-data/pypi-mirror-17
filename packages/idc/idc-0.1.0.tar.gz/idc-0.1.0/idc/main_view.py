...
#
# Created: Sat Sep 17 16:24:44 2016
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.headband_text = QtGui.QLabel(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(16)
        self.headband_text.setFont(font)
        self.headband_text.setObjectName(_fromUtf8("headband_text"))
        self.formLayout.setWidget(0, QtGui.QFormLayout.LabelRole, self.headband_text)
        ...
        self.formLayout.setWidget(0, QtGui.QFormLayout.FieldRole, self.headband)
        self.hs0_text = QtGui.QLabel(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(16)
        self.hs0_text.setFont(font)
        self.hs0_text.setObjectName(_fromUtf8("hs0_text"))
        self.formLayout.setWidget(1, QtGui.QFormLayout.LabelRole, self.hs0_text)
        self.hs_0 = QtGui.QLabel(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(16)
        self.hs_0.setFont(font)
        self.hs_0.setObjectName(_fromUtf8("hs_0"))
        self.formLayout.setWidget(1, QtGui.QFormLayout.FieldRole, self.hs_0)
        self.hs1_text = QtGui.QLabel(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(16)
        self.hs1_text.setFont(font)
        self.hs1_text.setObjectName(_fromUtf8("hs1_text"))
        self.formLayout.setWidget(2, QtGui.QFormLayout.LabelRole, self.hs1_text)
        self.hs_1 = QtGui.QLabel(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(16)
        self.hs_1.setFont(font)
        self.hs_1.setObjectName(_fromUtf8("hs_1"))
        self.formLayout.setWidget(2, QtGui.QFormLayout.FieldRole, self.hs_1)
        ...
        self.formLayout.setWidget(3, QtGui.QFormLayout.FieldRole, self.hs_2)
        ...
        self.formLayout.setWidget(4, QtGui.QFormLayout.FieldRole, self.hs_3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.headband_text.setText(_translate("MainWindow", "HeadBand", None))
        self.headband.setText(_translate("MainWindow", "TextLabel", None))
        self.hs0_text.setText(_translate("MainWindow", "HS_0", None))
        self.hs_0.setText(_translate("MainWindow", "TextLabel", None))
        self.hs1_text.setText(_translate("MainWindow", "HS_1", None))
        self.hs_1.setText(_translate("MainWindow", "TextLabel", None))
        self.label_7.setText(_translate("MainWindow", "HS_2", None))
        self.hs_2.setText(_translate("MainWindow", "TextLabel", None))
        self.label_9.setText(_translate("MainWindow", "HS_3", None))
        self.hs_3.setText(_translate("MainWindow", "TextLabel", None))
