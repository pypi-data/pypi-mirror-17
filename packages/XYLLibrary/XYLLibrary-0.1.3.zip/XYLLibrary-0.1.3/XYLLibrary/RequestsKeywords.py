...
from XYLLibrary import XYLKeywords
import requests
import robot
...
class RequestsKeywords(object):
    ...
    def to_json(self, content, pretty_print=True):
        ...
        if pretty_print:
            ...
            json_ = json.loads(content)
        logger.debug('To JSON using : content=%s ' % (content))
        ...
        if isinstance(data,str) and (isinstance(headers,str) or  headers is None):
            ...
            if headers is None:
                if self._is_json(data):
                    ...
                    data=XYLKeywords().FormData_to_Dict(data)
    ...
    def should_be_equal_as_jsonschema(self, json, schema):
        """
        :param json: like respons.tojson
        :param schema: look key words  'create json schema'

        """
        validate(json, schema)

    def should_be_equal_as_jsonschema_simple(self, json_str, property_name, property_type):
        """

        :param property_name: name
        :param property_type: number
        :return:
        """
        schema={
        'type' : "object",
...
if __name__ == '__main__':
    ...
    json1={
    "code": "00",
    "message": "45f61449a98e4dfc95658b351e9ffe09",
    "result": {
        "dealer": "",
        "latitude": "29.88525897",
        "leader": "",
        "leaderName": "",
        "loginTime": 1475905535834,
        "longitude": "121.57900597",
        "marketAccount": "",
        "marketUrl": "",
        "menuFirstLevel": [],
        "mobile": "13967880231",
        ...
        "roleDataType": 2,
        "roleId": "55c349bc70d24db1b37b6a5f841eb13a",
        "roleName": "测试",
        "roleWeight": 4,
        "sex": "M",
        "status": "01",
        "telephone": "",
        "title": "",
        "token": "6s2xfZeslpkhmRWJPMmsJm+lzz4MrCSk8Yz/6zlvhu+1RCq9RsbOiQ==",
        "userId": "008d731d52e2435ba88bf962dd1d9f52",
        "userMenu": [],
        "userName": "测试-张瑜"
    },
    "success": True
    ...
    #validate(json1,schema)
    #RequestsKeywords().should_be_equal_as_jsonschema_simple(json1, "price", "string", "data1")
