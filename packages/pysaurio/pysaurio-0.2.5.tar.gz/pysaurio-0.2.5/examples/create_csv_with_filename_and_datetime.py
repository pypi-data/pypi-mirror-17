...
# -*- coding: utf-8 -*-
#
# name:        create_csv_with_filename_and_datetime.py (Python 3.x)
# description: Creates .csv file with data from multiple text files
#              It includes record number, file name and file datetime:
...
__title__= 'create_csv_with_filename_and_datetime'
__date__ = '2016-09-09'
__version__ = '0.2.5'
...
def main():
    ...
    rap1.output_file = 'users_with_filename_and_datetime.csv'
    rap1.delimiter = ','
    rap1.quotechar = '"'
