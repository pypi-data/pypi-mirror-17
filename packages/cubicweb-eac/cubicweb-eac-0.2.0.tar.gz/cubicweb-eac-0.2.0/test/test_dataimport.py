    ...
    def test_parse_FRAD033_EAC_00001(self):
        ...
        self.assertEqual(not_visited,
                         {'maintenanceStatus': set([12]),
                          ...
                          'localControl': set([54]),
                          'source': set([76]),  # empty.
                          'nameEntry': set([114]),  # alternative form.
                          'structureOrGenealogy': set([188]),  # empty.
                          'biogHist': set([203]),  # empty.
                          })
...
class EACDataImportTC(CubicWebTC):
    ...
    def test_FRAD033_EAC_00001(self):
        ...
        with self.admin_access.repo_cnx() as cnx:
            ...
            self.assertEqual(len(created), 38)
    ...
    def _check_eac_relations(self, cnx, record):
        ...
        self.assertEqual(relation.printable_value('description',
                                                  format='text/plain'),
                         u'Coucou')
        other_record = cnx.find('AuthorityRecord', name=u"Gironde. Conseil général. Direction de "
