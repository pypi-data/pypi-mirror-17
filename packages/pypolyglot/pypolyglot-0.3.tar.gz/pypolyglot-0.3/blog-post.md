...
Documentation for polyglot is hosted by [Read the Docs](http://polyglot.readthedocs.org/en/stable/) (last [stable version](http://polyglot.readthedocs.org/en/stable/) and [latest version](http://polyglot.readthedocs.org/en/latest/)).
