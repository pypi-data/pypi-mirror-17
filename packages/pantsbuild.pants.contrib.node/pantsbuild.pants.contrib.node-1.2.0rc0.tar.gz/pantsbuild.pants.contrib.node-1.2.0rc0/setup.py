...
# Target: ContribPlugin(BuildFileAddress(BuildFile(contrib/node/src/python/pants/contrib/node/BUILD, FileSystemProjectTree(/Users/benjyw/src/pants)), plugin))
...
{   'classifiers': [   'Intended Audience :: Developers',
    ...
    'install_requires': ['pantsbuild.pants==1.2.0rc0', 'six>=1.9.0,<2'],
