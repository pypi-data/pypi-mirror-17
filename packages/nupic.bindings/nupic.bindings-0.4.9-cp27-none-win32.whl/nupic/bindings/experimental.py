...
class ExtendedTemporalMemory(object):
    ...
    def __init__(self, *args):
        ...
        __init__(self, columnDimensions, cellsPerColumn=32, activationThreshold=13, initialPermanence=0.21, connectedPermanence=0.50, minThreshold=10, maxNewSynapseCount=20, permanenceIncrement=0.10, permanenceDecrement=0.10, predictedSegmentDecrement=0.0, formInternalBasalConnections=True, learnOnOneCell=False, seed=42, maxSegmentsPerCell=255, maxSynapsesPerSegment=255) -> ExtendedTemporalMemory
        """
    ...
    def initialize(self, *args, **kwargs):
        """initialize(self, columnDimensions, cellsPerColumn=32, activationThreshold=13, initialPermanence=0.21, connectedPermanence=0.50, minThreshold=10, maxNewSynapseCount=20, permanenceIncrement=0.10, permanenceDecrement=0.10, predictedSegmentDecrement=0.0, formInternalBasalConnections=True, learnOnOneCell=False, seed=42, maxSegmentsPerCell=255, maxSynapsesPerSegment=255)"""
    ...
    def activateCells(self, activeColumnsSize, activeColumns, prevActiveExternalCellsBasalSize, prevActiveExternalCellsBasal, activeExternalCellsApicalSize, activeExternalCellsApical, learn):
        """activateCells(self, activeColumnsSize, activeColumns, prevActiveExternalCellsBasalSize, prevActiveExternalCellsBasal, activeExternalCellsApicalSize, activeExternalCellsApical, learn)"""
        return _experimental.ExtendedTemporalMemory_activateCells(self, activeColumnsSize, activeColumns, prevActiveExternalCellsBasalSize, prevActiveExternalCellsBasal, activeExternalCellsApicalSize, activeExternalCellsApical, learn)


    def activateDendrites(self, activeExternalCellsBasalSize, activeExternalCellsBasal, activeExternalCellsApicalSize, activeExternalCellsApical, learn=True):
        """activateDendrites(self, activeExternalCellsBasalSize, activeExternalCellsBasal, activeExternalCellsApicalSize, activeExternalCellsApical, learn=True)"""
        return _experimental.ExtendedTemporalMemory_activateDendrites(self, activeExternalCellsBasalSize, activeExternalCellsBasal, activeExternalCellsApicalSize, activeExternalCellsApical, learn)


    def compute(self, activeColumnsSize, activeColumns, prevActiveExternalCellsBasalSize=0, prevActiveExternalCellsBasal=0, activeExternalCellsBasalSize=0, activeExternalCellsBasal=0, prevActiveExternalCellsApicalSize=0, prevActiveExternalCellsApical=0, activeExternalCellsApicalSize=0, activeExternalCellsApical=0, learn=True):
        """compute(self, activeColumnsSize, activeColumns, prevActiveExternalCellsBasalSize=0, prevActiveExternalCellsBasal=0, activeExternalCellsBasalSize=0, activeExternalCellsBasal=0, prevActiveExternalCellsApicalSize=0, prevActiveExternalCellsApical=0, activeExternalCellsApicalSize=0, activeExternalCellsApical=0, learn=True)"""
        return _experimental.ExtendedTemporalMemory_compute(self, activeColumnsSize, activeColumns, prevActiveExternalCellsBasalSize, prevActiveExternalCellsBasal, activeExternalCellsBasalSize, activeExternalCellsBasal, prevActiveExternalCellsApicalSize, prevActiveExternalCellsApical, activeExternalCellsApicalSize, activeExternalCellsApical, learn)
    ...
    def convertedActivateCells(self, py_activeColumns, py_prevActiveExternalCellsBasal, py_prevActiveExternalCellsApical, learn):
        """convertedActivateCells(self, py_activeColumns, py_prevActiveExternalCellsBasal, py_prevActiveExternalCellsApical, learn)"""
        return _experimental.ExtendedTemporalMemory_convertedActivateCells(self, py_activeColumns, py_prevActiveExternalCellsBasal, py_prevActiveExternalCellsApical, learn)


    def convertedActivateDendrites(self, py_activeExternalCellsBasal, py_activeExternalCellsApical, learn):
        """convertedActivateDendrites(self, py_activeExternalCellsBasal, py_activeExternalCellsApical, learn)"""
        return _experimental.ExtendedTemporalMemory_convertedActivateDendrites(self, py_activeExternalCellsBasal, py_activeExternalCellsApical, learn)


    def convertedCompute(self, py_activeColumns, py_prevActiveExternalCellsBasal, py_activeExternalCellsBasal, py_prevActiveExternalCellsApical, py_activeExternalCellsApical, learn):
        """convertedCompute(self, py_activeColumns, py_prevActiveExternalCellsBasal, py_activeExternalCellsBasal, py_prevActiveExternalCellsApical, py_activeExternalCellsApical, learn)"""
        return _experimental.ExtendedTemporalMemory_convertedCompute(self, py_activeColumns, py_prevActiveExternalCellsBasal, py_activeExternalCellsBasal, py_prevActiveExternalCellsApical, py_activeExternalCellsApical, learn)
