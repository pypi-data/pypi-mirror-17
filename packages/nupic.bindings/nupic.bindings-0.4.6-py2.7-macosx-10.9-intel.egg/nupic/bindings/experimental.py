...
class ExtendedTemporalMemory(object):
    ...
    def activateBasalDendrites(self, *args, **kwargs):
        """activateBasalDendrites(self, activeExternalCells, learn=True)"""
        return _experimental.ExtendedTemporalMemory_activateBasalDendrites(self, *args, **kwargs)

    def activateApicalDendrites(self, *args, **kwargs):
        """activateApicalDendrites(self, activeExternalCells, learn=True)"""
        return _experimental.ExtendedTemporalMemory_activateApicalDendrites(self, *args, **kwargs)

    def compute(self, *args):
        """
        compute(self, activeColumnsSize, activeColumns, learn=True)
        compute(self, activeColumnsUnsorted, prevActiveExternalCellsBasal, activeExternalCellsBasal, prevActiveExternalCellsApical, 
