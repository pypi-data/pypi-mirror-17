...
class SegmentOverlap(object):
    """Proxy of C++ nupic::algorithms::connections::SegmentOverlap class"""
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    segment = _swig_property(_algorithms.SegmentOverlap_segment_get, _algorithms.SegmentOverlap_segment_set)
    overlap = _swig_property(_algorithms.SegmentOverlap_overlap_get, _algorithms.SegmentOverlap_overlap_set)

    def __init__(self):
        """__init__(self) -> SegmentOverlap"""
        this = _algorithms.new_SegmentOverlap()
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _algorithms.delete_SegmentOverlap
SegmentOverlap_swigregister = _algorithms.SegmentOverlap_swigregister
SegmentOverlap_swigregister(SegmentOverlap)
...
class Connections(object):
    ...
    def computeActivity(self, input, activePermanenceThreshold, activeSynapseThreshold, matchingPermanenceThreshold, matchingSynapseThreshold, activeSegmentsOut, matchingSegmentsOut):
        """computeActivity(self, input, activePermanenceThreshold, activeSynapseThreshold, matchingPermanenceThreshold, matchingSynapseThreshold, activeSegmentsOut, matchingSegmentsOut)"""
        return _algorithms.Connections_computeActivity(self, input, activePermanenceThreshold, activeSynapseThreshold, matchingPermanenceThreshold, matchingSynapseThreshold, activeSegmentsOut, matchingSegmentsOut)
...
class SegmentExcitationTally(object):
    """Proxy of C++ nupic::algorithms::connections::SegmentExcitationTally class"""
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def __init__(self, connections, activePermanenceThreshold, matchingPermanenceThreshold):
        """__init__(self, connections, activePermanenceThreshold, matchingPermanenceThreshold) -> SegmentExcitationTally"""
        this = _algorithms.new_SegmentExcitationTally(connections, activePermanenceThreshold, matchingPermanenceThreshold)
        try:
            self.this.append(this)
        except:
            self.this = this

    def addActivePresynapticCell(self, cellIdx):
        """addActivePresynapticCell(self, cellIdx)"""
        return _algorithms.SegmentExcitationTally_addActivePresynapticCell(self, cellIdx)


    def getResults(self, activeSynapseThreshold, matchingSynapseThreshold, activeSegmentsOut, matchingSegmentsOut):
        """getResults(self, activeSynapseThreshold, matchingSynapseThreshold, activeSegmentsOut, matchingSegmentsOut)"""
        return _algorithms.SegmentExcitationTally_getResults(self, activeSynapseThreshold, matchingSynapseThreshold, activeSegmentsOut, matchingSegmentsOut)

    __swig_destroy__ = _algorithms.delete_SegmentExcitationTally
SegmentExcitationTally_swigregister = _algorithms.SegmentExcitationTally_swigregister
SegmentExcitationTally_swigregister(SegmentExcitationTally)
...
class TemporalMemory(object):
    ...
    def activateCells(self, activeColumns, learn=True):
        """activateCells(self, activeColumns, learn=True)"""
        return _algorithms.TemporalMemory_activateCells(self, activeColumns, learn)
