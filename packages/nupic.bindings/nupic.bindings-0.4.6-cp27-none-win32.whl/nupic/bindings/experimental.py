...
class ExtendedTemporalMemory(object):
    ...
    def activateCells(self, activeColumns, prevActiveExternalCellsBasal, prevActiveExternalCellsApical, learn):
        """activateCells(self, activeColumns, prevActiveExternalCellsBasal, prevActiveExternalCellsApical, learn)"""
        return _experimental.ExtendedTemporalMemory_activateCells(self, activeColumns, prevActiveExternalCellsBasal, prevActiveExternalCellsApical, learn)


    def activateBasalDendrites(self, activeExternalCells, learn=True):
        """activateBasalDendrites(self, activeExternalCells, learn=True)"""
        return _experimental.ExtendedTemporalMemory_activateBasalDendrites(self, activeExternalCells, learn)


    def activateApicalDendrites(self, activeExternalCells, learn=True):
        """activateApicalDendrites(self, activeExternalCells, learn=True)"""
        return _experimental.ExtendedTemporalMemory_activateApicalDendrites(self, activeExternalCells, learn)


    def compute(self, *args):
        """
        compute(self, activeColumnsSize, activeColumns, learn=True)
        compute(self, activeColumnsUnsorted, prevActiveExternalCellsBasal, activeExternalCellsBasal, prevActiveExternalCellsApical, activeExternalCellsApical, learn=True)
        """
        return _experimental.ExtendedTemporalMemory_compute(self, *args)
