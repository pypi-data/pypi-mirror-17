...
from OrderCloud.apis.spec_api import SpecApi


class TestSpecApi(unittest.TestCase):
    """ SpecApi unit test stubs """

    def setUp(self):
        self.api = OrderCloud.apis.spec_api.SpecApi()
