...
class LineItem(object):
    ...
    """
    def __init__(self, id=None, product_id=None, quantity=None, date_added=None, quantity_shipped=None, unit_price=None, line_total=None, cost_center=None, date_needed=None, shipping_account=None, shipping_address_id=None, shipping_address=None, ship_from_address_id=None, ship_from_address=None, specs=None, xp=None):
        """
