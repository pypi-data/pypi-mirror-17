...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.PlainmapModel = exports.WeightedHeatmapLayerModel = exports.SimpleHeatmapLayerModel = exports.DirectionsLayerModel = exports.GMapsLayerModel = exports.PlainmapView = exports.MarkerLayerView = exports.WeightedHeatmapLayerView = exports.SimpleHeatmapLayerView = exports.DirectionsLayerView = undefined;
	...
	var PlainmapView = exports.PlainmapView = _jupyterJsWidgets2.default.DOMWidgetView.extend({
	    render: function render() {
	        ...
	        this.on("displayed", function () {
	            _googleMaps2.default.load(function (google) {
	                _this4.map = new google.maps.Map(_this4.el);
	                _this4.updateBounds(initialBounds);
	
	                _this4.layerViews.update(_this4.model.get("layers"));
	    ...
	    updateBounds: function updateBounds() {
	        var _model$get = this.model.get("data_bounds");
	
	        var _model$get2 = _slicedToArray(_model$get, 2);
	
	        var _model$get2$ = _slicedToArray(_model$get2[0], 2);
	
	        var latBL = _model$get2$[0];
	        var lngBL = _model$get2$[1];
	
	        var _model$get2$2 = _slicedToArray(_model$get2[1], 2);
	
	        var latTR = _model$get2$2[0];
	        var lngTR = _model$get2$2[1];
