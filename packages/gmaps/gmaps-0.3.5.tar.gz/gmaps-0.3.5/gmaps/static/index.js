...
/***/ function(module, exports, __webpack_require__) {
	...
	var SymbolView = exports.SymbolView = BaseMarkerView.extend({
	    ...
	    setStyleEvents: function setStyleEvents() {
	        ...
	        iconProperties.forEach(function (_ref11) {
	            ...
	            var callback = function callback() {
	                var newIcon = Object.assign({}, _this5.marker.getIcon());
	                newIcon[nameInView] = _this5.model.get(nameInModel);
	                _this5.marker.setIcon(newIcon);
	            };
	...
	var MarkerView = exports.MarkerView = BaseMarkerView.extend({
	    ...
	    setStyleEvents: function setStyleEvents() {
	        ...
	        properties.forEach(function (_ref13) {
	            ...
	            var callback = function callback() {
	                _this6.marker.set(nameInView, _this6.model.get(nameInModel));
	            };
	...
	var PlainmapView = exports.PlainmapView = _jupyterJsWidgets2.default.DOMWidgetView.extend({
	    render: function render() {
	        ...
	        this.on("displayed", function () {
	            _googleMaps2.default.load(function (google) {
	                _this8.map = new google.maps.Map(_this8.el);
	                _this8.updateBounds(initialBounds);
	
	                _this8.layerViews.update(_this8.model.get("layers"));
	
	                // hack to force the map to redraw
	                setTimeout(function () {
	                    google.maps.event.trigger(_this8.map, 'resize');
	                    _this8.updateBounds(initialBounds);
	                }, 500);
	            });
	        });
