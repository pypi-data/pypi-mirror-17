...
setup(
    ...
    package_data={'kvhosting': ['erl_src/*']},
    description='Python client for keyvaluehosting.com',
    ...
    test_suite='kvhosting.tests.suite',
    url='https://github.com/shikolay/riak-python-client',
    cmdclass={
