...
class Cluster(object):
    ...
    """
    def __init__(self, id=None, name=None, uuid=None, hints=None, credential=None, public_key=None, status=None, hosts_ids=None, hosts_ips=None, master_node_id=None, master_node_ip=None, user_id=None, appliance=None, appliance_impl=None):
        """
