...
from appdynamics.agent.pb import ConfigResponse, merge_protobuf, serialize_message
...
class ConfigService(threading.Thread):
    ...
    def generate_config_string(self, config):
    ...
    def _update_config(self, new_config):
        ...
        # comparison.
        new_config_string = self.generate_config_string(self.config)
