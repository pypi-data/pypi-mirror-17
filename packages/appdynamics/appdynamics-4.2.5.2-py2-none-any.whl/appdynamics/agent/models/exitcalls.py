...
from appdynamics.lib import iteritems, make_name_value_pairs, utf8
...
class Backend(object):
    ...
    __slots__ = (
        ...
        'name', 'registered_id', 'component_id', 'optional_properties',
        'is_foreign_app', 'correlation_enabled'
    )
...
class ExitCall(object):
    ...
    __slots__ = (
        ...
        'caller', '__weakref__', 'was_assigned', 'was_added'
    )
    ...
    def __init__(self, sequence_info, timer, backend, category, params, caller, operation=None):
        ...
        if operation is not None and len(operation) > operation_max_length:
