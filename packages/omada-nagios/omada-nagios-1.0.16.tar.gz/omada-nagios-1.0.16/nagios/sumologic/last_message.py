...
class CustomSumoLogic(SumoLogic):
    def __init__(self, accessId, accessKey, endpoint=None, cookieFile='cookies.txt', flockFile='/tmp/sumologic_api.lock'):
    ...
    def _get_endpoint(self):
        ...
        endpoint = self.response.url.replace('/collectors', '')
        self._flock_release()
        return endpoint
