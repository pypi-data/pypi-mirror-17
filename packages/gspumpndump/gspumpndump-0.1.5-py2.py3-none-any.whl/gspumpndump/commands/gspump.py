...
# encoding: utf-8
'''
 -- gspump commandline tool to push stored GeoServer configurations using RESTConfig API
...
def main(argv=None): # IGNORE:C0111
    ...
    program_shortdesc = 'gspump commandline tool to push stored GeoServer configurations using RESTConfig API'
    program_license = '''%s
