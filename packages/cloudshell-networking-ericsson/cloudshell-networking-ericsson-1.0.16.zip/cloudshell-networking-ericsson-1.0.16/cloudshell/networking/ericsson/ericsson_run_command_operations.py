...
class EricssonRunCommandOperations(RunCommandInterface):
    ...
    def run_custom_config_command(self, command, expected_str=None, expected_map=None, timeout=None, retries=None,
        ...
        return self.cli.send_config_command(command=command, expected_str=expected_str,
                                            expected_map=expected_map, timeout=timeout,
