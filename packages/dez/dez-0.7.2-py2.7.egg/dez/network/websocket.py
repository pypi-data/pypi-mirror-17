...
class WebSocketDaemon(SocketDaemon):
    def __init__(self, hostname, port, cb=None, b64=False, cbargs=[], report_cb=lambda x:None, isJSON=False, certfile=None):
        SocketDaemon.__init__(self, hostname, port, cb, False, cbargs, certfile)
        real_cb = self.cb
