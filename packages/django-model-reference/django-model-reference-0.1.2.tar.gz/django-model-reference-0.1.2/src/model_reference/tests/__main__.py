...
from model_reference import __version__
...
def get_parser():
    ...
    """
    parser = argparse.ArgumentParser('django-model-reference')
...
def main(args=None):
    """
    Called with ``python -m model_reference.tests``: run main test suite.
    """
    ...
    import model_reference.tests as test_module
