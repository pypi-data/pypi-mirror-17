"""Unit and regression tests for reading regular_latlon_surface.grib2."""
...
class TestGridDescriptionSection:
    ...
    section_number = 3
    fieldnames = {
        'section3Length', 'numberOfSection', 'sourceOfGridDefinition',
        'numberOfDataPoints', 'numberOfOctetsForNumberOfPoints',
        'interpretationOfNumberOfPoints', 'gridDefinitionTemplateNumber',
    }
...
class TestProductDefinitionSection:
    ...
    section_number = 4
    fieldnames = {
        'section4Length', 'numberOfSection', 'NV',
