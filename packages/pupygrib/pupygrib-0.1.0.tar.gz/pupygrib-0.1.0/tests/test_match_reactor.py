"""Unit and regression tests for reading match_reactor.grib."""
...
class TestProductDefinitionSection:
    ...
    section_number = 1
    fieldnames = {
        'section1Length', 'table2Version', 'centre',
        'generatingProcessIdentifier', 'gridDefinition', 'section1Flags',
        'indicatorOfParameter', 'indicatorOfTypeOfLevel', 'level',
        'yearOfCentury', 'month', 'day', 'hour', 'minute', 'unitOfTimeRange',
        'P1', 'P2', 'timeRangeIndicator', 'numberIncludedInAverage',
        'numberMissingFromAveragesOrAccumulations',
        'centuryOfReferenceTimeOfData', 'subCentre', 'decimalScaleFactor',
        'localDefinitionNumber', 'generatingProcess', 'sort', 'timeRepres',
        'landType', 'suplScale', 'molarMass', 'logTransform', 'threshold',
        'totalSizeClasses', 'sizeClassNumber', 'integerScaleFactor',
        'lowerRange', 'upperRange', 'meanSize', 'STDV',
    }
...
class TestGridDescriptionSection:
    ...
    section_number = 2
    fieldnames = {
        'section2Length', 'numberOfVerticalCoordinateValues', 'pvlLocation',
        'dataRepresentationType', 'Ni', 'Nj', 'latitudeOfFirstGridPoint',
        'longitudeOfFirstGridPoint', 'resolutionAndComponentFlags',
...
class TestBitMapSection:
    ...
    section_number = 3
    fieldnames = {
        'section3Length', 'numberOfUnusedBitsAtEndOfSection3',
        'tableReference', 'bitmap',
    }
...
class TestBinaryDataSection:
    ...
    section_number = 4
    fieldnames = {
        'section4Length', 'dataFlag', 'binaryScaleFactor', 'referenceValue',
        'bitsPerValue', 'values',
    }
