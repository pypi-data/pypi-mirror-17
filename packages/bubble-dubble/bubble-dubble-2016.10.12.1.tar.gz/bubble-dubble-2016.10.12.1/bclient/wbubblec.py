...
from bubble.bclient.ui.wbubble import Ui_WBubble
from bubble.bcommon import default
from bubble.bclient import connector, pyqt2bool, wplot, wsaxsparams, wmask, wdark, wabout
...
class WBubble(QtWidgets.QDialog, Ui_WBubble):
    ...
    def loadSettings(self, s=None):
        ...
        beamline = s.value('WBubble/beamline', 'Dubble')
        if beamline == 'SNBL':
