...
class TwitterAds:
    ...
    base_twitter_ads_url = 'https://ads-api.twitter.com/1/'
    ...
    def get_web_event_tags(self, account_id):
        assert account_id is not None, 'account_id is required'
        web_event_tags_response = self.twitter_ads.request(self.base_twitter_ads_url +\
                                                            'accounts/' + account_id + '/web_event_tags',
                                                            method='GET')
        return web_event_tags_response
