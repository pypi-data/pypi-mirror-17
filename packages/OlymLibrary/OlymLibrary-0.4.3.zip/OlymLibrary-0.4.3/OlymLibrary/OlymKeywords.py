...
if __name__ == '__main__':
    x='portComboGrid this loadPort value="NANJING"'
    test=OlymKeywords().re_search(x,'portComboGrid this loadPort value="','"')
    '''
    d="strCasenumbers=['25219362']&isCanclePub=true"
    '''
    print OlymKeywords().re_search(test)
    
   
    '''s={'loadport':'NINGBO'}
    test=OlymKeywords().dict_values(s)
    print OlymKeywords().dict_values(s)
    '''