...
BOOST_PYTHON_MODULE(mygraph)
{
    ...
    pyGraph.def("add_edge", add_edge_s, 
            "add_edge(edge_name, from_vertex_name, to_vertex_name)\n\n"
            "Add an edge by vertex strings\n\n"
            "Parameters\n"
            "----------\n"
            "edge_name, from_vertex_name, to_vertex_name : string\n"
            "   from_vertex and to_vertex_name must exist, you may use add_vertex to add them\n\n"
            "Returns\n"
            "----------\n"
            "None\n\n"
            "Examples\n"
