...
class TestStringMethods(unittest.TestCase):
    ...
    def test_function_return_0(self):
        ...
        dump_file  = './tests/dump_files_for_tests/test_it_function_return_0.cpp.dump'
    ...
    def test_function_return_1(self):
        ...
        '''
        cps_unit_checker = CPSUnitsChecker()
        dump_file  = './tests/dump_files_for_tests/test_it_function_return_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        for tw in cps_unit_checker.all_tree_walkers:
            so = tw.symbol_helper.function_dictionary['scopeObject']
    ...
    def test_comparisons_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST= False
        dump_file  = './tests/dump_files_for_tests/test_it_comparisons_1.cpp.dump'
        source_file  = './tests/dump_files_for_tests/test_it_comparisons_1.cpp'
        cps_unit_checker.main_run_check(dump_file, source_file)
    ...
    def test_logical_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_logical_1.cpp.dump'
        source_file  = './tests/dump_files_for_tests/test_it_logical_1.cpp'
        cps_unit_checker.main_run_check(dump_file, source_file)
        # TEST 1
        e = cps_unit_checker.errors[0]
        # ORACLES
    ...
    def test_abs_0(self):
        ...
        cps_unit_checker.debug = False
        #cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_known_function_abs.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
    ...
    def test_abs_namespace_std_0(self):
        ...
        cps_unit_checker.debug = False
        #cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_known_function_abs_namespace_std.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
    ...
    def test_abs_1(self):
        ...
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_known_function_abs_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 't'
        var_linenr = 9
    ...
    def test_abs_2(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_known_function_abs_2.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 's'
        var_linenr =11 
    ...
    def test_multiplication_assignment_in_multi_configurations_1(self):
        ...
        #cps_unit_checker.debug_verbose = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_multiplication_assignment_in_multi_configurations.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
    ...
    def test_unit_propagation_by_multiplication_1(self):
        ...
        #cps_unit_checker.debug_verbose = False
        #cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_unit_propagation_by_multiplication_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        for s in cps_unit_checker.current_configuration.scopes:
            if s.className == 'main':
    ...
    def test_unit_propagation_by_division_1(self):
        ...
        #cps_unit_checker.debug_verbose = False
        #cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_unit_propagation_by_division_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        actual_units = None
        for s in cps_unit_checker.current_configuration.scopes:
    ...
    def test_mulitple_units_assigned(self):
        ...
        #cps_unit_checker.debug_verbose = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_multiple_units_assigned_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
    ...
    def test_known_functions_sqrt_1(self):
        ...
        #cps_unit_checker.debug_verbose = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_known_function_sqrt_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        for s in cps_unit_checker.current_configuration.scopes:
            if s.className == 'main':
    ...
    def test_known_functions_sqrt_2(self):
        ...
        #cps_unit_checker.debug_verbose = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_known_function_sqrt_2.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        for s in cps_unit_checker.current_configuration.scopes:
            if s.className == 'main':
    ...
    def test_known_functions_sqrt_3(self):
        ...
        #cps_unit_checker.debug_verbose = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_known_function_sqrt_3.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        actual_units = None
        for s in cps_unit_checker.current_configuration.scopes:
    ...
    def test_known_functions_sqrt_4(self):
        ...
        #cps_unit_checker.debug_verbose = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_known_function_sqrt_4.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        for s in cps_unit_checker.current_configuration.scopes:
            if s.className == 'main':
    ...
    def test_known_functions_sqrt_5(self):
        ...
        #cps_unit_checker.debug_verbose = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_known_function_sqrt_5.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        for s in cps_unit_checker.current_configuration.scopes:
            if s.className == 'main':
    ...
    def test_known_functions_sqrt_half_units(self):
        ...
        #cps_unit_checker.debug_verbose = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_known_function_sqrt_half_units.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        for s in cps_unit_checker.current_configuration.scopes:
            if s.className == 'main':
    ...
    def test_known_functions_atan2_1(self):
        ...
        cps_unit_checker.debug_verbose = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_known_function_atan2_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        for s in cps_unit_checker.current_configuration.scopes:
            if s.className == 'main':
    ...
    def test_known_functions_atan2_2(self):
        ...
        #cps_unit_checker.debug_verbose = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_known_function_atan2_2.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        for s in cps_unit_checker.current_configuration.scopes:
            if s.className == 'main':
    ...
    def test_toSec(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_toSec_0.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        for s in cps_unit_checker.current_configuration.scopes:
            if s.className == 'main':
    ...
    def test_float_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_float_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        actual_units = None
        for s in cps_unit_checker.current_configuration.scopes:
    ...
    def test_float_2(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_float_2.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        actual_units = None
        for s in cps_unit_checker.current_configuration.scopes:
    ...
    def test_float_3(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_float_3.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        for s in cps_unit_checker.current_configuration.scopes:
            if s.className == 'main':
    ...
    def test_float_4(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_float_4.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        for s in cps_unit_checker.current_configuration.scopes:
            if s.className == 'main':
    ...
    def test_float_5(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_float_5.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        for s in cps_unit_checker.current_configuration.scopes:
            if s.className == 'main':
    ...
    def test_pow_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_known_function_pow_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 'f'
        var_linenr =10 
    ...
    def test_pow_2(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_known_function_pow_2.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 'f'
        var_linenr = 11 
    ...
    def test_pow_3(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_known_function_pow_3.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 'f'
        var_linenr = 10
    ...
    def test_floor_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_known_function_floor_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 's'
        var_linenr = 8 
    ...
    def test_ceil_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_known_function_ceil_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 's'
        var_linenr = 8 
    ...
    def test_acos_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_known_function_acos_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 'f'
        var_linenr = 7 
    ...
    def test_asin_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_known_function_asin_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 'f'
        var_linenr = 7 
    ...
    def test_atan_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_known_function_atan_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 'f'
        var_linenr = 7 
    ...
    def test_ternary_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_ternary_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 'f'
        var_linenr = 9 
    ...
    def test_function_args_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_function_args_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        # actual_units = None
    ...
    def test_function_args_2(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_function_args_2.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
    ...
    def test_function_args_3(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_function_args_3.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        my_oracle_1 = 4
        my_oracle_2 = [{'meter': 1}]
    ...
    def test_function_args_4(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_function_args_4.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        my_oracle = [{'meter': 1}]
        actual_units = None
    ...
    def test_function_args_5(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_function_args_5.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        my_oracle_1 = [{'meter': 1}]
        my_oracle_2 = 15
    ...
    def test_division_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_division_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 'x'
        var_linenr = 9 
    ...
    def test_division_2(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_division_2.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 'x'
        var_linenr = 9 
    ...
    def test_division_3(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_division_3.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 'x'
        var_linenr = 9 
    ...
    def test_division_4(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_division_4.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 'x'
        var_linenr =10
    ...
    def test_logical_2(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_logical_2.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
    ...
    def test_error_type_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_error_return_type_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
    ...
    def test_laser_scan_range_size_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_laser_scan_range_count_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 'x'
        var_linenr = 7
    ...
    def test_laser_scan_range_size_2(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_laser_scan_range_count_2.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 'x'
        var_linenr = 7
    ...
    def test_ros_duration_isZero_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_ros_duration_isZero_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 't'
        var_linenr = 6
    ...
    def test_ros_duration_isZero_2(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_ros_duration_isZero_2.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 't'
        var_linenr = 6
    ...
    def test_ros_header_include_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/src/test_it_header_include_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
    ...
    def test_ros_header_include_2(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/src/test_it_header_include_2.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        ...
        self.assertEqual('./tests/dump_files_for_tests/src/../include/test_it_header_include_2.h', e.get_file_URI_where_error_occured())
        e = cps_unit_checker.errors[1]
        self.assertEqual(5, e.linenr)
        self.assertEqual('./tests/dump_files_for_tests/src/test_it_header_include_2.cpp', e.get_file_URI_where_error_occured())
    ...
    def test_laser_range_empty_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_range_empty_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(0, len(cps_unit_checker.errors))
    ...
    def test_ros_isZero_3(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_ros_isZero_3.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(0, len(cps_unit_checker.errors))
    ...
    def test_multiple_initialization_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_multiple_initialization.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(0, len(cps_unit_checker.errors))
    ...
    def test_it_multiplication_with_constant_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_multiplication_with_constant_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        # self.assertEqual(0, len(cps_unit_checker.errors))
        var_name = 'f'
    ...
    def test_it_multiplication_with_constant_2(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_multiplication_with_constant_2.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        # self.assertEqual(0, len(cps_unit_checker.errors))
        var_name = 'f'
    ...
    def test_it_operator_with_unknown_variable_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_operator_with_unknown_variable_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        # self.assertEqual(0, len(cps_unit_checker.errors))
        var_name = 'f'
    ...
    def test_it_operator_with_unknown_variable_2(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_operator_with_unknown_variable_2.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(2, len(cps_unit_checker.errors))
    ...
    def test_it_operator_with_unknown_variable_3(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_operator_with_unknown_variable_3.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(2, len(cps_unit_checker.errors))
    ...
    def test_it_min_max_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_min_max_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 'f'
        var_linenr = 7
    ...
    def test_it_min_max_2(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_min_max_2.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 'f'
        var_linenr = 8
    ...
    def test_it_min_max_3(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_min_max_3.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 'f'
        var_linenr = 8
    ...
    def test_it_min_max_4(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_min_max_4.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 'f'
        var_linenr = 9
    ...
    def test_it_multiline_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_multiline_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 'f'
        var_linenr = 25
    ...
    def test_it_quatToRPY_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_quatToRPY_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
    ...
    def test_it_weak_inference_multiplication_1 (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_weak_inference_multiplication_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        # for e in cps_unit_checker.errors:
    ...
    def test_it_weak_inference_multiplication_2 (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_weak_inference_multiplication_2.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 'tw.linear.x'
        var_linenr = 22
    ...
    def test_it_weak_inference_addition_1 (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_weak_inference_addition_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        # for e in cps_unit_checker.errors:
    ...
    def test_it_weak_inference_addition_2 (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_weak_inference_addition_2.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        # for e in cps_unit_checker.errors:
            # print '\nweak inference addition : %s warning:%s ' % (e.var_name, str(e.is_warning))
    ...
    def test_it_weak_inference_addition_3 (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_weak_inference_addition_3.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        # for e in cps_unit_checker.errors:
            # print '\nweak inference addition : %s warning:%s ' % (e.var_name, str(e.is_warning))
    ...
    def test_it_addition_without_assignment_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_addition_without_assignment_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        # for e in cps_unit_checker.errors:
            # print '\nweak inference addition : %s warning:%s ' % (e.var_name, str(e.is_warning))
    ...
    def test_it_addition_without_assignment_2(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_addition_without_assignment_2.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        # for e in cps_unit_checker.errors:
            # print '\nweak inference addition : %s warning:%s ' % (e.var_name, str(e.is_warning))
    ...
    def test_it_addition_without_assignment_3(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_addition_without_assignment_3.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(1, len(cps_unit_checker.errors))
        self.assertEqual(UnitErrorTypes.ADDITION_OF_INCOMPATIBLE_UNITS, cps_unit_checker.errors[0].ERROR_TYPE)
    ...
    def test_it_addition_without_assignment_4(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_addition_without_assignment_4.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(1, len(cps_unit_checker.errors))
        self.assertEqual(UnitErrorTypes.ADDITION_OF_INCOMPATIBLE_UNITS, cps_unit_checker.errors[0].ERROR_TYPE)
    ...
    def test_it_radian_addition_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_radian_addition_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(2, len(cps_unit_checker.errors))
        self.assertEqual(UnitErrorTypes.VARIABLE_MULTIPLE_UNITS, cps_unit_checker.errors[0].ERROR_TYPE)
    ...
    def test_it_radian_addition_2(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_radian_addition_2.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(1, len(cps_unit_checker.errors))
        self.assertEqual(UnitErrorTypes.VARIABLE_MULTIPLE_UNITS, cps_unit_checker.errors[0].ERROR_TYPE)
    ...
    def test_it_radian_multiplication_1(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_radian_multiplication_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(0, len(cps_unit_checker.errors))
    ...
    def test_it_radian_multiplication_2(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_radian_multiplication_2.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(1, len(cps_unit_checker.errors))
        self.assertEqual(UnitErrorTypes.VARIABLE_MULTIPLE_UNITS, cps_unit_checker.errors[0].ERROR_TYPE)
    ...
    def test_it_radian_multiplication_3(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_radian_multiplication_3.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(0, len(cps_unit_checker.errors))
    ...
    def test_it_radian_multiplication_4(self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_radian_multiplication_4.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(1, len(cps_unit_checker.errors))
        self.assertEqual(UnitErrorTypes.VARIABLE_MULTIPLE_UNITS, cps_unit_checker.errors[0].ERROR_TYPE)
    ...
    def test_it_getXYZ_1 (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_getXYZ_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        # for e in cps_unit_checker.errors:
            # print '\nweak inference addition : %s warning:%s ' % (e.var_name, str(e.is_warning))
    ...
    def test_it_getXYZ_2 (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_getXYZ_2.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        # for e in cps_unit_checker.errors:
            # print '\nweak inference addition : %s warning:%s ' % (e.var_name, str(e.is_warning))
    ...
    def test_it_getXYZ_3 (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_getXYZ_3.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        var_name = 'tw.linear.x'
        var_linenr = 10
    ...
    def test_it_getXYZ_4 (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_getXYZ_4.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        # for e in cps_unit_checker.errors:
            # print '\nweak inference addition : %s warning:%s ' % (e.var_name, str(e.is_warning))
    ...
    def test_it_getXYZ_5 (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_getXYZ_5.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(1, len(cps_unit_checker.errors))
        self.assertEqual(UnitErrorTypes.VARIABLE_MULTIPLE_UNITS, cps_unit_checker.errors[0].ERROR_TYPE)
    ...
    def test_it_quaternion_addition_1 (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_quaternion_addition_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(2, len(cps_unit_checker.errors))
        self.assertEqual(UnitErrorTypes.VARIABLE_MULTIPLE_UNITS, cps_unit_checker.errors[0].ERROR_TYPE)
    ...
    def test_it_quaternion_addition_2 (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_quaternion_addition_2.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(1, len(cps_unit_checker.errors))
        self.assertEqual(UnitErrorTypes.VARIABLE_MULTIPLE_UNITS, cps_unit_checker.errors[0].ERROR_TYPE)
    ...
    def test_it_quaternion_addition_3 (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_quaternion_addition_3.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(0, len(cps_unit_checker.errors))
    ...
    def test_it_quaternion_addition_4 (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_quaternion_addition_4.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(0, len(cps_unit_checker.errors))
    ...
    def test_it_quaternion_multiplication_1 (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_quaternion_multiplication_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(0, len(cps_unit_checker.errors))
    ...
    def test_it_quaternion_multiplication_2 (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_quaternion_multiplication_2.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(0, len(cps_unit_checker.errors))
    ...
    def test_it_quaternion_multiplication_3 (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_quaternion_multiplication_3.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(0, len(cps_unit_checker.errors))
    ...
    def test_it_quaternion_multiplication_4 (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_quaternion_multiplication_4.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(0, len(cps_unit_checker.errors))
    ...
    def test_it_quaternion_closed_under_multiplication_1 (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_quaternion_closed_under_multiplication_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(0, len(cps_unit_checker.errors))
    ...
    def test_it_quaternion_closed_under_multiplication_2 (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_quaternion_closed_under_multiplication_2.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(1, len(cps_unit_checker.errors))
        self.assertEqual(UnitErrorTypes.VARIABLE_MULTIPLE_UNITS, cps_unit_checker.errors[0].ERROR_TYPE)
    ...
    def test_it_radian_closed_under_multiplication_1 (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_radian_closed_under_multiplication_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(0, len(cps_unit_checker.errors))
    ...
    def test_it_radian_closed_under_multiplication_2 (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_radian_closed_under_multiplication_2.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(1, len(cps_unit_checker.errors))
        self.assertEqual(UnitErrorTypes.VARIABLE_MULTIPLE_UNITS, cps_unit_checker.errors[0].ERROR_TYPE)
    ...
    def test_it_dt_heuristic (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_dt_heuristic_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(0, len(cps_unit_checker.errors))
    ...
    def test_it_plus_equals_1 (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_plus_equals_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(0, len(cps_unit_checker.errors))
    ...
    def test_it_range_1 (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_range_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(0, len(cps_unit_checker.errors))
    ...
    def test_it_scope_bug_1 (self):
        ...
        cps_unit_checker.debug = False
        cps_unit_checker.debug_print_AST = False
        dump_file  = './tests/dump_files_for_tests/test_it_cppcheck_scope_bug_at_argument_1.cpp.dump'
        source_file  = dump_file.replace('.dump','')
        cps_unit_checker.main_run_check(dump_file, source_file)
        self.assertEqual(0, len(cps_unit_checker.errors))
