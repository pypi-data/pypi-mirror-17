...
from payfort import Card
from payfort import Charge
from payfort import Customer
from payfort import Refund
from payfort import Token
from payfort import RequestError, BankingError, AuthenticationError
...
class TestRefunds(TestPayFortMixin):
    ...
    def test_create_refund(self):
        ...
        charge = self.get_response_data(
            Charge(API_KEY).retrieve(self.charge_id))
