...
class seq_alt_archive_unit_archive_unit_ref_id_management_content(RelationDefinition):
    name = 'seda_content'
    subject = 'SEDAContent'
    object = 'SEDASeqAltArchiveUnitArchiveUnitRefIdManagement'
    cardinality = '1+'
...
class content_restriction_end_date(RelationDefinition):
...
class content_description_level(RelationDefinition):
...
class content_system_id(RelationDefinition):
    name = 'seda_system_id'
...
class content_originating_system_id(RelationDefinition):
...
class content_language_from(RelationDefinition):
...
class content_description_language_from(RelationDefinition):
...
class content_keyword(RelationDefinition):
    name = 'seda_keyword'
    subject = 'SEDAKeyword'
    object = 'SEDAContent'
    cardinality = '1*'
...
class content_originating_agency_from(RelationDefinition):
...
class content_submission_agency_from(RelationDefinition):
...
class content_authorized_agent_from(RelationDefinition):
...
class content_writer_from(RelationDefinition):
...
class content_addressee_from(RelationDefinition):
...
class content_recipient_from(RelationDefinition):
...
class content_created_date(RelationDefinition):
...
class content_transacted_date(RelationDefinition):
...
class content_acquired_date(RelationDefinition):
...
class content_sent_date(RelationDefinition):
    name = 'seda_sent_date'
...
class content_received_date(RelationDefinition):
...
class content_registered_date(RelationDefinition):
...
class content_end_date(RelationDefinition):
    name = 'seda_end_date'
    subject = 'SEDAEndDate'
    object = 'SEDAContent'
    cardinality = '1?'
...
class content_event(RelationDefinition):
    name = 'seda_event'
    subject = 'SEDAEvent'
    object = 'SEDAContent'
    cardinality = '1*'
...
class content_gps_version_id(RelationDefinition):
...
class content_gps_altitude(RelationDefinition):
...
class content_gps_altitude_ref(RelationDefinition):
...
class content_gps_latitude(RelationDefinition):
...
class content_gps_latitude_ref(RelationDefinition):
...
class content_gps_longitude(RelationDefinition):
...
class content_gps_longitude_ref(RelationDefinition):
...
class content_gps_date_stamp(RelationDefinition):
