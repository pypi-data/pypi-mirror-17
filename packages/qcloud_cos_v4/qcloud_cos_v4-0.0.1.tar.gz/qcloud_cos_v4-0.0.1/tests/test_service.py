...
class TestCosService(TestCase):
    ...
    def setUp(self):
        ...
        secret_id = u'AKIDzn8wwKuXjxixQAkRBC2DRXBtPd7CrlJQ'  # 替换为用户的secret_id
        secret_key = u'wJJJZSsmb1s7TTF1sC6rcBkDF1OuZ8F4'  # 替换为用户的secret_key
        self.cos_client = CosClient(appid, secret_id, secret_key)

        self.bucket = u'liuchangtest'
