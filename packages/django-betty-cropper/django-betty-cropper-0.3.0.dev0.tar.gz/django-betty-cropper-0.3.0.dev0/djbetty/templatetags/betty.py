...
def betty_js_header():
    ...
    # This causes significant page speed improvements by allowing images to start loading ASAP (vs
    # waiting for "image.js" fetch) when combined with `betty_js_footer()` tag.
    #
    # FUTURE: Move 'image.js' source file directly into this project (instead of hosted by Betty).
