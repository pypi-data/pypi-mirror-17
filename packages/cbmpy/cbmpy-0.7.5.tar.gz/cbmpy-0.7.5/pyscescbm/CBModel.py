    ...
    def addFluxBound(self, fluxbound, fbexists=None):
        ...
        if fbexists == None:
            ...
            if GO:
                ...
                print('\n{} FluxBound for reaction {} exists, skipping'.format(fluxbound.is_bound, fluxbound.reaction))
                time.sleep(1)
        else:
...
class Group(Fbase):
    ...
    def assignAllSharedPropertiesToMembers(self):
        self.assignSharedSBOtermsToMembers()
        self.assignSharedNotesToMembers()
