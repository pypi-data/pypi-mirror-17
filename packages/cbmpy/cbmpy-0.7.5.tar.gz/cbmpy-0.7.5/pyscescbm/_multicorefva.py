...
Last edit: $Author: bgoli $ ($Id: _multicorefva.py 305 2015-04-23 15:18:31Z bgoli $)
...
def funcFVA(x,r):
    try:
        ...
        Args.insert(0, x)
        Args[1] = r
        fva, fvan = pyscescbm.CBSolver.FluxVariabilityAnalysis(*Args)
...
if __name__ == '__main__':
    ...
    pyscescbm.CBSolver.analyzeModel(cmod, oldlpgen=False)
