...
{'2D-PAGE protein': {'data_entry': 'http://2dbase.techfak.uni-bielefeld.de/cgi-bin/2d/2d.cgi?ac=$id',
 ...
 'BioCarta Pathway': {'data_entry': 'http://www.biocarta.com/pathfiles/$id.asp',
 ...
 'DEPOD': {'data_entry': 'http://www.koehn.embl.de/depod/showp.php?gene=$id',
           'example': 'PTPN1',
           'name': 'DEPOD',
           'pattern': '^[A-Z0-9]+$',
 ...
 'NONCODE v4 Gene': {'data_entry': 'http://www.noncode.org/show_gene.php?id=$id',
                     'example': 'NONHSAG00001',
                     'name': 'NONCODE v4 Gene',
                     'pattern': '^NONHSAG\\d{5}$',
                     'url': 'http://identifiers.org/noncodev4.gene/'},
 'NONCODE v4 Transcript': {'data_entry': 'http://www.noncode.org/show_rna.php?id=$id',
 ...
 'Odor Molecules DataBase': {'data_entry': 'http://senselab.med.yale.edu/OdorDB/eavData.aspx?o=$id',
                             'example': '74',
                             'name': 'Odor Molecules DataBase',
                             'pattern': '^\\d+$',
                             'url': 'http://identifiers.org/odor/'},
 'Olfactory Receptor Database': {'data_entry': 'http://senselab.med.yale.edu/OrDB/eavData.aspx?o=$id',
                                 'example': '8497',
 ...
 'PASS2': {'data_entry': 'http://caps.ncbs.res.in/pass2/superfamily/superfamilydetail.php?superfamilyId=$id',
           'example': '46977',
           'name': 'PASS2',
           'pattern': '^\\d+$',
 ...
 'SEED Subsystem': {'data_entry': 'http://seed-viewer.theseed.org/seedviewer.cgi?page=Subsystems&amp;amp;subsystem=Biotin_biosynthesis&amp;amp;organism=$id',
                    'example': '441768.4',
                    'name': 'SEED Subsystem',
                    'pattern': '^\\d+\\.\\d+$',
