...
# SERVICE
PAASMANAGER_SERVICE_TYPE = "paasmanager"
PAASMANAGER_ENDPOINT_TYPE = "publicURL"
...
class PaaSManagerClient():
    ...
    def __init__(self, username, password, tenant_id, auth_url, region_name, service_type=PAASMANAGER_SERVICE_TYPE,
        ...
        self.endpoint_url = self.get_paasmanager_endpoint_from_keystone(region_name, service_type, endpoint_type)
    ...
    def get_paasmanager_endpoint_from_keystone(self, region_name, service_type, endpoint_type):
        ...
        logger.debug("Getting PaaSManager endpoint")
        endpoint = None
            ...
            if service['name'] == service_type:
                for endpoint in service['endpoints']:
                    if endpoint['region'] == region_name:
                        ...
                        break
                break
        logger.debug("PaaSManager endpoint (Service: %s, Type: %s, Region: %s) is: %s", service_type, endpoint_type,
