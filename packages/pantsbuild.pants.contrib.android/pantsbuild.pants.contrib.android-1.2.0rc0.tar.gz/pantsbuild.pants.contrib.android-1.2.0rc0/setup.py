...
# Target: ContribPlugin(BuildFileAddress(BuildFile(contrib/android/src/python/pants/contrib/android/BUILD, FileSystemProjectTree(/Users/benjyw/src/pants)), plugin))
...
{   'classifiers': [   'Intended Audience :: Developers',
    ...
    'install_requires': [   'pantsbuild.pants==1.2.0rc0',
