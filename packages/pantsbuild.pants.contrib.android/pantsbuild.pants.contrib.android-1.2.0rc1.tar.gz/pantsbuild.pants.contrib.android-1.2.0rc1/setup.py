...
# Target: ContribPlugin(BuildFileAddress(BuildFile(contrib/android/src/python/pants/contrib/android/BUILD, FileSystemProjectTree(/Users/stuhood/src/pants)), plugin))
...
{   'classifiers': [   'Intended Audience :: Developers',
    ...
    'entry_points': {   'pantsbuild.plugin': [   'build_file_aliases = pants.contrib.android.register:build_file_aliases',
                                                 'register_goals = pants.contrib.android.register:register_goals']},
    ...
    'namespace_packages': [   'pants',
                              ...
                              'pants.contrib.android.distribution',
                              'pants.contrib.android.keystore',
                              'pants.contrib.android.targets',
                              'pants.contrib.android.tasks'],
    'package_data': {   },
    'package_dir': {   '': 'src'},
    'packages': [   'pants',
                    'pants.contrib',
