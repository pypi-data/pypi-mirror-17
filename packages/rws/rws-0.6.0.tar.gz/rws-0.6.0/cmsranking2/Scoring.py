...
from cmsranking2.Submission import store as submission_store
from cmsranking2.Subchange import store as subchange_store
from cmsranking2.Task import store as task_store
