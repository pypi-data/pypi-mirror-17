...
var CradminTabController = (function () {
    function CradminTabController(tabAttribute, tabContentAttribute, tabActivateAttribute) {
        if (tabAttribute === void 0) { tabAttribute = "cradmin_tab"; }
        if (tabContentAttribute === void 0) { tabContentAttribute = "cradmin_tab_content"; }
        if (tabActivateAttribute === void 0) { tabActivateAttribute = "cradmin_tab_activate"; }
        this.tabAttribute = tabAttribute;
        this.tabContentAttribute = tabContentAttribute;
        this.tabActivateAttribute = tabActivateAttribute;
        this.activeMap = {};
        this.tabs = {};
        this.addClickListeners();
        this.getTabElements();
    }
    CradminTabController.prototype.getTabElements = function () {
        var elements = Array.from(document.querySelectorAll("[" + this.tabAttribute + "]"));
        for (var _i = 0, elements_1 = elements; _i < elements_1.length; _i++) {
            var element = elements_1[_i];
            // let nodeDescriptor = {
            //   node: element,
    ...
    //   return clickable.attributes.getNamedItem(this.groupIdAttribute).nodeValue;
    // }
    CradminTabController.prototype.addClickListeners = function () {
