...
class AlohaInput(TextInput):
    ...
    def get_context(self, *args, **kwargs):
        """get context"""
        context = super(AlohaInput, self).get_context(*args, **kwargs)
    ...
    def _get_media(self):
        ...
        try:
            ...
            javascripts.append('html-editor/js/aloha-init.js')
            
            return Media(css=css, js=javascripts)
        except Exception as msg:
            django_logger = logging.getLogger('django')
            django_logger.error(u'## InlineHtmlInput._get_media Error {0}'.format(msg))
