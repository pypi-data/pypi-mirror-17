...
with open(os.path.join(os.path.dirname(__file__), 'utphy_richdocument', 'README.rst')) as readme:
    README = readme.read()
...
setup(
    ...
    license='BSD License',
    description='A Wagtail richdocument content type build with stremfield.',
