...
def deploy_test(client, args):
    ...
    return _restart_tasks(
        client, args.env, service_name, args.version, args.wait)
...
def run(args):
    ...
    if args.env == 'test':
        sys.exit(deploy_test(client, args) is True)
    elif args.env == 'stage':
        sys.exit(deploy_stage(client, args) is True)
    elif args.env == 'production':
        sys.exit(deploy_production(client, args) is True)
