...
class _FilesystemPlugins(_PluginManagerBase):
    def __init__(self):
        super(_FilesystemPlugins, self).__init__([Paths.plugin_path_filesystems()], {"Filesystem": IFilesystem})


class _StorageProviderPlugins(_PluginManagerBase):
    def __init__(self):
        super(_StorageProviderPlugins, self).__init__([Paths.plugin_path_storageproviders()], {"StorageProvider": IStorageProvider})
