...
def default_params():
    ...
    simulate_params['source_path'] = os.path.join(os.path.dirname(os.path.realpath(__file__)),'..','..')
    ...
    env_params['max_ana_free_energy'] = None
