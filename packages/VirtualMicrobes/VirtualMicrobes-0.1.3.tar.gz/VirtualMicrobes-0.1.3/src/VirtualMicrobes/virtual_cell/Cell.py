...
class Cell:
    ...
    def point_mutate_gene(self, chrom, pos, mut_dict, point_mut_ratios, environment, time, rand_gen):
    ...
    def point_mutate_genome(self, p_mutate, mut_dict, global_mut_mod, point_mut_ratios, 
    ...
    def stretch_mutate_genome(self, time, mutation_rates, global_mut_mod, rand_gen, rand_gen_np,
    ...
    def chromosome_mutate_genome(self, time, mutation_rates, global_mut_mod, rand_gen, rand_gen_np, verbose):    
