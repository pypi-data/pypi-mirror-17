...
def FermiFunction(m, z=None, logz=None):
    ...
    Notes for logz input:
        ...
        For low z: summation can be used optionally
            z < 0.1
            Summation expansion is used with first 6 terms
            Need to test speed of sum vs integral in this region.
