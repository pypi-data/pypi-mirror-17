...
try:
    ...
    import json
    warnings.warn('ujson is not installed, using standard json package (which is slower)')
...
class Connection(object):
    ...
    def get_fields(self, series_id, fields='*', snapshot_job_id=None, snapshot_date=None, reported_date=None):
        """
