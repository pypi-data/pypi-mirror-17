...
setup(
    description='Rask Mongodb Connector',
    install_requires=[
        'rask'
    ],
    license='https://gitlab.com/vikingmakt/rask_njord_mongodb/raw/master/LICENSE',
    maintainer='Umgeher Torgersen',
    maintainer_email='me@umgeher.org',
    name='rask_njord_mongodb',
    packages=find_packages(),
    url='https://gitlab.com/vikingmakt/rask_njord_mongodb',
    version=git_version()
)
