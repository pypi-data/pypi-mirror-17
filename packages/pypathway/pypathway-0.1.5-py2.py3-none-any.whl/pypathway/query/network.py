...
class NetworkRequest:
    ...
    def _request_get(self):
        try:
            ...
            # print "NR: NetwrokException {}".format(e.message)
            raise NetworkException(self.url, e.message)
        return text
...
if __name__ == '__main__':
    req = NetworkRequest("http://www.youtube.com",
                         NetworkMethod.GET, proxy=dict(https='socks5://127.0.0.1:1080',
