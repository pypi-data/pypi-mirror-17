...
from bullet_dodger.block import *
from bullet_dodger.bonus import Bonus
from bullet_dodger.bullet import *
from bullet_dodger.global_constants import *
...
pygame.display.set_icon(pygame.image.load('assets/bullet.png'))
# Timing
fps_clock = pygame.time.Clock()
FPS = 60

default_font = pygame.font.Font(None, 28)
background_img = pygame.image.load('assets/ground.png')
pygame.mixer.music.load('assets/Hitman.ogg')
...
def main_loop():
    ...
    while running:
        ...
        if square.collide(bullets):
            game_over = True
            sound = pygame.mixer.Sound('assets/gun_fire.ogg')
