...
from .exceptions import WebSocketError, SocketDeadError
...
class WebSocket(object):
    ...
    __slots__ = ('utf8validator', 'utf8validate_last', 'environ', 'closed',
                 'stream', 'raw_write', 'raw_read', 'handler', 'close_callbacks')
    ...
    def send_frame(self, message, opcode):
        ...
        try:
            ...
            raise SocketDeadError(MSG_SOCKET_DEAD)
    ...
    def add_close_callback(self, cb):
        """
        Add a no-arg function to be added to the list of callbacks to be called
        when the websocket is closed.  Useful for doing cleanup of backend
        connections.
        """
