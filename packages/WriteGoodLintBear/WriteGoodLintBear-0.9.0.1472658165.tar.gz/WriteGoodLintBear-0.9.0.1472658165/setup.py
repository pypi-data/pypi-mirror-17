...
if __name__ == "__main__":
    try:
        setup(name='WriteGoodLintBear',
              version='0.9.0.1472658165',
              description="'WriteGoodLintBear' bear for coala (http://coala.rtfd.org/)",
    ...
    """,
              entry_points={"coalabears": ["WriteGoodLintBear = coalaWriteGoodLintBear"]},
              classifiers=[
