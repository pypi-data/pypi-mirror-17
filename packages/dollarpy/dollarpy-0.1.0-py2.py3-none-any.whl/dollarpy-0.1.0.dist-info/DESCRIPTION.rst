dollarpy
========
*pydollar* is a python implementation of the $P Point-Cloud Recognizer [#]_.

| |License|
| |Python Compatibility| |PyPI Version| |Format|
| |Build Status| |Coverage Status|

.. |License| image:: https://img.shields.io/pypi/l/pydollar.svg?maxAge=3600
   :target: https://www.gnu.org/licenses/lgpl.html
.. |PyPI Version| image:: https://img.shields.io/pypi/v/pydollar.svg?maxAge=3600
   :target: https://pypi.python.org/pypi/pydollar/
.. |Python Compatibility| image:: https://img.shields.io/pypi/pyversions/pydollar.svg?maxAge=3600
   :target: https://pypi.python.org/pypi/pydollar/
.. |Format| image:: https://img.shields.io/pypi/format/pydollar.svg?maxAge=3600
   :target: https://pypi.python.org/pypi/pydollar/
.. |Build Status| image:: https://img.shields.io/travis/sonovice/pydollar.svg?maxAge=3600
   :target: https://travis-ci.org/sonovice/pydollar
.. |Coverage Status| image:: https://img.shields.io/codecov/c/github/sonovice/pydollar.svg?maxAge=3600
   :target: https://codecov.io/gh/sonovice/pydollar
...
Installation
------------
*pydollar* can be installed using pip:
