...
class MessageEntityEmail(MTProtoRequest):
    ...
    def __init__(self, offset, length):
        ...
        """
        super().__init__()
        self.constructor_id = 0x64e475c2
    ...
    def __str__(self):
        return '(messageEntityEmail (ID: 0x64e475c2) = (offset={}, length={}))'.format(str(self.offset), str(self.length))
