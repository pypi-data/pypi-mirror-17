...
class BotResults(MTProtoRequest):
    ...
    def __init__(self, query_id, results, gallery=None, next_offset=None, switch_pm=None):
        ...
        """
        super().__init__()
        self.constructor_id = 0x256709a6
