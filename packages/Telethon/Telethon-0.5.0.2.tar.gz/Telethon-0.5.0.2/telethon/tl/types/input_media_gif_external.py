...
class InputMediaGifExternal(MTProtoRequest):
    ...
    def __init__(self, url, q):
        ...
        """
        super().__init__()
        self.constructor_id = 0x4843b0fd
    ...
    def __str__(self):
        return '(inputMediaGifExternal (ID: 0x4843b0fd) = (url={}, q={}))'.format(str(self.url), str(self.q))
