...
class MessageEntityBold(MTProtoRequest):
    ...
    def __init__(self, offset, length):
        ...
        """
        super().__init__()
        self.constructor_id = 0xbd610bc9
    ...
    def __str__(self):
        return '(messageEntityBold (ID: 0xbd610bc9) = (offset={}, length={}))'.format(str(self.offset), str(self.length))
