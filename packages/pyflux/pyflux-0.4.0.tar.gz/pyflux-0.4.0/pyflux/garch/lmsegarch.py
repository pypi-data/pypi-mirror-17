    ...
    def _create_latent_variables(self):
        ...
        for component in range(2):
            ...
            for p_term in range(self.p):
                self.latent_variables.add_z("Component " + str(component+1) + ' p(' + str(p_term+1) + ')',ifr.Normal(0,0.5,transform=None),dst.q_Normal(0,3))
                if p_term == 0:
                    self.latent_variables.z_list[1+p_term+component*(self.p+self.q)].start = 0.00

            for q_term in range(self.q):
                self.latent_variables.add_z("Component " + str(component+1) + ' q(' + str(q_term+1) + ')',ifr.Normal(0,0.5,transform=None),dst.q_Normal(0,3))
