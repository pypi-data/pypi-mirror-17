...
class OkerrClient:
    ...
    def altkeypath(self,path):
        ...
        raise OkerrNoKey('Failed all {} keypath: {}'.format(ntried, path))
    ...
    def update(self,name,status,details=None,
        ...
        while not success:        
            try:
                ...
                if r.status_code == 200:
                    success = True
                    self.log.info(u'okerr send update OK textid:{}, {}={} {}'.\
                    ...
                    if self.retry:
                        ...
                        raise OkerrClientServer('okerr update error {} \'{:.50}\' textid:{}, {}={} {}'.\
