...
See the [Ingenico Connect Developer Hub](https://developer.globalcollect.com/documentation/sdk/server/python/) for more information on how to use the SDK.
...
1. Download the latest version of the Python SDK from the [Ingenico Connect Developer Hub](https://developer.globalcollect.com/documentation/sdk/server/) or download it from GitHub.
    * When downloading from GitHub, choose the `connect-sdk-python2-x.y.z.zip` file from the [releases](https://github.com/Ingenico-ePayments/connect-sdk-python2/releases) page, where `x.y.z` is the version number.
