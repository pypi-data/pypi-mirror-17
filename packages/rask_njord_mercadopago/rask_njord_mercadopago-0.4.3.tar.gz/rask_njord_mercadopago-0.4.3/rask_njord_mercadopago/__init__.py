...
class MP(Base):
    ...
    def config_get(self,uid,future):
        try:
            ...
            def on_response(_):
                try:
                    assert _.result()['header']['code'] in self.options['code']['config']['get'].values()
                except AssertionError:
    ...
    def config_save(self,payload,future):
        try:
            ...
            def on_response(_):
                try:
                    assert _.result()['header']['code'] in self.options['code']['config']['save'].values()
                except AssertionError:
                    future.set_result(False)
                except:
                    raise
    ...
    def customer_create(self,payload,future):
        try:
            ...
            def on_response(_):
                try:
                    assert _.result()['header']['code'] in self.options['code']['customer']['create'].values()
                except AssertionError:
                    future.set_result(False)
                except:
                    raise
    ...
    def customer_get(self,kuid,future):
        try:
            ...
            def on_response(_):
                try:
                    assert _.result()['header']['code'] in self.options['code']['customer']['get'].values()
                except AssertionError:
                    future.set_result(False)
                except:
                    raise
    ...
    def customer_kuid(self,cred,future):
        try:
            ...
            def on_response(_):
                try:
                    assert _.result()['header']['code'] in self.options['code']['customer']['kuid'].values()
                except AssertionError:
                    future.set_result(False)
                except:
                    raise
