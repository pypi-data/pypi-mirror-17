...
class WebsocketClient(BaseClient, WebSocketClient):
    def __init__(self, public_key, secret_key, url=None, subscription=None):
        ...
        """
        super(WebsocketClient, self).__init__(secret_key, public_key)
        if url:
...
class TickerWebcosketClient(WebsocketClient, WebSocketClient):
    def __init__(self, public_key, secret_key, url='wss://apiv2.bitcoinaverage.com/websocket/ticker', subscription=None):
        super(TickerWebcosketClient, self).__init__(public_key, secret_key, url, subscription)
...
class ExchangeWebsocketClient(WebsocketClient, WebSocketClient):
