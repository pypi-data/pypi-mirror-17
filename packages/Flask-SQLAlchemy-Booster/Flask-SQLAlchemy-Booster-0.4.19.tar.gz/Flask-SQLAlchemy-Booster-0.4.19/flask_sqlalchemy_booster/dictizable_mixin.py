...
from .utils import all_cols_including_subclasses, all_rels_including_subclasses
...
class DictizableMixin(object):
    ...
    def autogenerated_dict_structure(self):
        return {
            "attrs": self.__mapper__.columns.keys(),
        }
    ...
    def todict_using_struct(self, dict_struct={}):
        """
            dict_struct:
            {
                'attrs': ['id', 'created_at'],
        ...
        """
        result = self.serialize_attrs(*dict_struct.get('attrs', []))
        for rel, rel_dict_struct in dict_struct.get('rels', {}).items():
    ...
    def todict(self, attrs_to_serialize=None,
        ...
        if dict_struct is not None:
            return self.todict_using_struct(dict_struct)
        attrs_to_serialize = (
