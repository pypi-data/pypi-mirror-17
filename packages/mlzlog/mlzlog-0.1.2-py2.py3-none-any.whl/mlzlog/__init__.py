...
def initLogging(rootname='mlz', rootlevel='info', logdir='/tmp/log'):
    global log
...
class MLZLogger(Logger):
    ...
    def __init__(self, *args, **kwargs):
        ...
        MLZLogger._storeLoggerNameLength(self)
    ...
    def _storeLoggerNameLength(logObj):
        ...
        if len(logObj.name) > MLZLogger.maxLogNameLength:
            MLZLogger.maxLogNameLength = len(logObj.name)
