...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.published_interviews_count'
        db.add_column('interviews_product', 'published_interviews_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.published_interviews_count'
        db.delete_column('interviews_product', 'published_interviews_count')
