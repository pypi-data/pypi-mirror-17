...
README = '''Welcome to Flask-WhooshAlchemyPlus!
===================================
...
setup(
    ...
    version='0.7.5r3',
    description='Whoosh extension to Flask/SQLAlchemy which used in sina container',
    long_description=README,
    py_modules=['container_whooshalchemyplus'],
    provides=['container_whooshalchemyplus'],
    zip_safe=False,
