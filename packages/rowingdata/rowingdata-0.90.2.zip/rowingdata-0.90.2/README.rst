...
On Windows, there seem to be installation issues related to scipy and numpy. A workaround is to install Anaconda, as described here: https://www.scipy.org/install.html
