...
setup(
    description='Rask HTTP Client',
    install_requires=[
        'rask',
    ],
    license='https://gitlab.com/vikingmakt/rask_njord_http/raw/master/LICENSE',
    maintainer='Umgeher Torgersen',
    maintainer_email='me@umgeher.org',
    name='rask_njord_http',
    packages=find_packages(),
    url='https://gitlab.com/vikingmakt/rask_njord_http',
    version=git_version()
)
