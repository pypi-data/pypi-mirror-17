    ...
    **Usage:**
    ...
    def _get_data_to_send(
        ...
        **Return:**
        ...
        if docType == "pdf":
            sqlQuery = u"""
                select * from `reading-list` where  kind = "imported-pdf" and sentToKindle =0 and workflowStage = "reading" and pdfName is not null order by dateCreated limit 10 
            """ % locals()
        elif docType == "web":
            sqlQuery = u"""
    ...
    def update_database_for_sent_item(
        ...
        **Usage:**
        ...
        if success == True:
            ...
            sqlQuery = u"""
                update `reading-list` set sentToKindle = 404 where primaryId = %(primaryId)s
            """ % locals()
            writequery(
                log=self.log,
                sqlQuery=sqlQuery,
    ...
    def send_webarticles(
        ...
        **Usage:**
        ...
        for article in articlesToSend:
            ...
            if success == True:
                self.update_database_for_sent_item(
