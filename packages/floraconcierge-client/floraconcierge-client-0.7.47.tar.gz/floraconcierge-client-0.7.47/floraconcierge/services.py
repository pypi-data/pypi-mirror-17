...
class Shop(Service):
    ...
    def get_categories_list(self, parent_id=None, hidden=None):
        """
    ...
    def submit_order_started(self, postObject):
        """
        :rtype : bool
        """
        return self._callapi("shop/order/submit/started", post=postObject)
    ...
    def get_delivery_time(self):
        ...
        :rtype : list
        """
        return self._callapi("shop/order/time")
    ...
    def get_products_archive(self):
        """
        :rtype : list
        """
        return self._callapi("shop/products/archive")

    def get_products_by_count(self, count):
        """
        :rtype : list of Product|Collection
        """
        return self._callapi("shop/products/count", get={"count": count})
    ...
    def get_products_random(self, postObject):
        """
        :rtype : list of Stdclass|list
        """
        return self._callapi("shop/products/random", post=postObject)
    ...
    def get_products_top(self, city_id):
        """
        :rtype : list of Product|Collection
        """
        return self._callapi("shop/products/top", get={"city_id": city_id})
...
class Users(Service):
    ...
    def calendar_holidays(self):
        ...
        """
        return self._callapi("users/calendar/holidays")
    ...
    def get_info_by_email(self, email):
        ...
        """
        return self._callapi("users/info", get={"email": email})
    ...
    def registration(self, email, name=None):
        """
        :rtype : bool
        """
        return self._callapi(
    ...
    def subscribe(self, email):
        ...
        :rtype : bool
        """
        return self._callapi("users/subscribe", get={"email": email})

    def update_data(self, postObject):
        """
        :rtype : User
        """
        return self._callapi("users/updatedata", post=postObject)
...
class Phone(Service):
    ...
    def search(self, phone, short=None):
        """
        :rtype : Stdclass
        """
        return self._callapi(
...
class System(Service):
    ...
    def get_inflect_count(self, count, word):
        """
        :rtype : Count
        """
        return self._callapi(
    ...
    def get_inflect(self, word):
        """
        :rtype : Inflect
        """
        return self._callapi("system/inflect", get={"word": word})
    ...
    def get_setting_by_id(self, slug):
        """
        :rtype : str
        """
        return self._callapi("system/setting", get={"slug": slug})

    def get_site_map(self):
        """
        :rtype : list
        """
        return self._callapi("system/sitemap")
...
class Auth(Service):
    ...
    def login(self, app_id, email, password=None, remember=None, checkip=None):
        """
        :rtype : User
        """
        return self._callapi(
    ...
    def reset_password(self, email, app_id):
        """
        :rtype : User
        """
        return self._callapi(
...
class Discount(Service):
    ...
    def count_month(self):
        ...
        :rtype : int
        """
        return self._callapi("discount/countmonth")
...
class Partner(Service):
    ...
    def code(self, code, partner_id=None):
        """
        :rtype : bool
        """
        return self._callapi(
    ...
    def orders(self, from_datetime=None, to_datetime=None, ids=None):
        """
        :rtype : Collection
        """
        return self._callapi(
