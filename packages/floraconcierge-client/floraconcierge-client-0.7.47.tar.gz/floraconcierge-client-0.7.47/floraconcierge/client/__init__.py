...
class Environment(object):
    def __init__(self):
        ...
        self.country = None
        self.city = None
        self._date = ApiClient.get_timestamp()
        self.currency = 'usd'
        self.ip = '127.0.0.1'
        self.promo = None
    ...
    def set_date(self, value):
        if isinstance(value, int):
            ...
            self._date = ApiClient.get_timestamp(value)
...
class ApiResult(object):
    ...
    @property
    def value(self):
        if self._data and self._data.result is not None:
            return self._data and self._data.result
        else:
            return None
...
class ApiClient(object):
    ...
    def call(self, func, get=None, post=None):
        ...
        get.update(dict((self.str(k), self.fix_type(v)) for k, v in self.env.params.iteritems() if v is not None))
