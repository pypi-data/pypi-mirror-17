...
class MPI_Pool(object):
    ...
    def stop(self):
        ...
        if self.comm is not None:
            ...
            # Stop children
            self.comm.bcast(("STOP", None, None, None, None, None, None,
                             None), root=MPI.ROOT)
    ...
    def split_data(self, x_list, kw_list):
    ...
    def eval(self, f, obj_scatter=None, obj_bcast=None,
        ...
        # Broadcast function and parameters
        self.comm.bcast((obj_dill, f_in, obj_bcast, dmem_key_in_list, dmem_arg_in_list,
                         dmem_key_out_list, red_obj_dill, import_set), root=MPI.ROOT)
