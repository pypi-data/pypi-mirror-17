...
class AcwSettings(object):
    ...
    def __init__(self):
        """
        AcwSettings - a model defined in Swagger
    ...
    def wrapup_prompt(self):
        """
        Gets the wrapup_prompt of this AcwSettings.


        :return: The wrapup_prompt of this AcwSettings.
        :rtype: str
        """
    ...
    def wrapup_prompt(self, wrapup_prompt):
        """
        Sets the wrapup_prompt of this AcwSettings.


        :param wrapup_prompt: The wrapup_prompt of this AcwSettings.
        :type: str
        """
        allowed_values = ["MANDATORY", "OPTIONAL", "MANDATORY_TIMEOUT", "MANDATORY_FORCED_TIMEOUT"]
        if wrapup_prompt not in allowed_values:
            raise ValueError(
                "Invalid value for `wrapup_prompt`, must be one of {0}"
