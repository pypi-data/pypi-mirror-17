...
class PresenceApi(object):
    ...
    def get_presencedefinitions(self, **kwargs):
        ...
        all_params = ['page_number', 'page_size', 'deleted']
        all_params.append('callback')
    ...
    def patch_user_id_presences_source_id(self, user_id, source_id, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.patch_user_id_presences_source_id(user_id, source_id, body, callback=callback_function)
        ...
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `patch_user_id_presences_source_id`")
