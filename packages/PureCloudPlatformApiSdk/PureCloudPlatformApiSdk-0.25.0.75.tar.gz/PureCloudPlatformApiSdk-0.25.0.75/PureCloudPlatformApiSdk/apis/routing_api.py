...
class RoutingApi(object):
    ...
    def get_queues_queue_id_users(self, queue_id, **kwargs):
        ...
        all_params = ['queue_id', 'page_size', 'page_number', 'sort_by', 'expand', 'joined', 'name', 'skills', 'languages', 'routing_status', 'presence']
        all_params.append('callback')
    ...
    def post_queues_queue_id_wrapupcodes(self, queue_id, code_id, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_queues_queue_id_wrapupcodes(queue_id, code_id, body, callback=callback_function)
