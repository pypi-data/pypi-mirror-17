...
class VideoConversationNotificationVideoMediaParticipant(object):
    ...
    def disconnect_type(self, disconnect_type):
        ...
        :type: str
        """
        allowed_values = ["endpoint", "client", "system", "transfer", "timeout", "transfer.conference", "transfer.consult", "transfer.forward", "transport.failure", "transport.noanswer", "transport.notavailable", "error", "peer", "other", "spam"]
