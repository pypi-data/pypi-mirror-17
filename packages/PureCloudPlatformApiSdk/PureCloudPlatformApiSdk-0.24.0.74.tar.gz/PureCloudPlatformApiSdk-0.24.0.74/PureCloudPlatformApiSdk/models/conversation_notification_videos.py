...
class ConversationNotificationVideos(object):
    ...
    def provider(self, provider):
        ...
        :type: str
        """
        allowed_values = ["PureCloud WebRTC", "PureCloud Email", "PureCloud Webchat", "PureCloud Co-browse", "PureCloud VR", "PureCloud Callback", "PureCloud Social Channel Management", "PureCloud Fax", "Edge", "Twillio", "Bifrost", "Unknown"]
    ...
    def disconnect_type(self, disconnect_type):
        ...
        :type: str
        """
        allowed_values = ["ENDPOINT", "CLIENT", "SYSTEM", "TIMEOUT", "TRANSFER", "TRANSFER_CONFERENCE", "TRANSFER_CONSULT", "TRANSFER_FORWARD", "TRANSFER_NO_ANSWER", "TRANSFER_NOT_AVAILABLE", "TRANSPORT_FAILURE", "ERROR", "PEER", "OTHER", "SPAM"]
