...
class UserRecordingsApi(object):
    ...
    def put_recording_id(self, recording_id, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_recording_id(recording_id, body, callback=callback_function)
        ...
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_recording_id`")
