...
class Chidgvis_Bc_T(f90wrap.runtime.FortranDerivedType):
    ...
    def nfaces(self):
        ...
        """
        nfaces_ = _mod.f90wrap_nfaces(self=self._handle)
        return nfaces_
    ...
    def npoints(self):
        ...
        """
        npoints_ = _mod.f90wrap_npoints(self=self._handle)
        return npoints_
    ...
    def __init__(self, handle=None):
        ...
        self._handle = _mod.f90wrap_chidgvis_bc_t_initialise()
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _mod.f90wrap_chidgvis_bc_t_finalise(this=self._handle)
...
def get_points(self, npoints, ndim):
    ...
    """
    points = _mod.f90wrap_get_points(self=self, npoints=npoints, ndim=ndim)
    return points
...
def get_faces(self, nfaces, ndim):
    ...
    """
    faces = _mod.f90wrap_get_faces(self=self, nfaces=nfaces, ndim=ndim)
    return faces
