...
class Dict_T(f90wrap.runtime.FortranDerivedType):
    ...
    def get_real(self, key, val):
        ...
        """
        _mod.f90wrap_get_real(self=self._handle, key=key, val=val)
    ...
    def set_real(self, key, val):
        ...
        """
        _mod.f90wrap_set_real(self=self._handle, key=key, val=val)
    ...
    def get_int(self, key, val):
        ...
        """
        _mod.f90wrap_get_int(self=self._handle, key=key, val=val)
    ...
    def set_int(self, key, val):
        ...
        """
        _mod.f90wrap_set_int(self=self._handle, key=key, val=val)
    ...
    def __init__(self, handle=None):
        ...
        self._handle = _mod.f90wrap_dict_t_initialise()
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _mod.f90wrap_dict_t_finalise(this=self._handle)
