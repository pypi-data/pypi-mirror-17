...
import logging
from chidg.type_chidgvis_bc import Chidgvis_Bc_T
...
class Chidg_T(f90wrap.runtime.FortranDerivedType):
    ...
    def init(self, level):
        ...
        """
        _mod.f90wrap_init(self=self._handle, level=level)
    ...
    def set(self, selector, selection, options):
        ...
        """
        _mod.f90wrap_set(self=self._handle, selector=selector, selection=selection, \
    ...
    def read_grid(self, gridfile, spacedim):
        ...
        """
        _mod.f90wrap_read_grid(self=self._handle, gridfile=gridfile, spacedim=spacedim)
    ...
    def read_boundaryconditions(self, gridfile):
        ...
        """
        _mod.f90wrap_read_boundaryconditions(self=self._handle, gridfile=gridfile)
    ...
    def read_solution(self, solutionfile):
        ...
        """
        _mod.f90wrap_read_solution(self=self._handle, solutionfile=solutionfile)
    ...
    def initialize_solution_domains(self, nterms_s):
        ...
        """
        _mod.f90wrap_initialize_solution_domains(self=self._handle, nterms_s=nterms_s)
    ...
    def initialize_solution_solver(self):
        ...
        """
        _mod.f90wrap_initialize_solution_solver(self=self._handle)
    ...
    def write_solution(self, solutionfile):
        ...
        """
        _mod.f90wrap_write_solution(self=self._handle, solutionfile=solutionfile)
    ...
    def run(self):
        ...
        """
        _mod.f90wrap_run(self=self._handle)
    ...
    def report(self):
        ...
        """
        _mod.f90wrap_report(self=self._handle)
    ...
    def close(self):
        ...
        """
        _mod.f90wrap_close(self=self._handle)
    ...
    def return_gui_bc(self, ibc_in):
        ...
        """
        gui_bc = _mod.f90wrap_return_gui_bc(self=self._handle, ibc_in=ibc_in)
    ...
    def __init__(self, handle=None):
        ...
        self._handle = _mod.f90wrap_chidg_t_initialise()
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _mod.f90wrap_chidg_t_finalise(this=self._handle)
