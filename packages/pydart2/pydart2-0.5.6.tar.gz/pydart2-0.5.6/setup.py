...
sources = glob.glob(API_DIR + "/*.cpp")
sources.append(API_DIR + "pydart2_api.i")
...
print("depend files:")
depends = glob.glob(API_DIR + "/*.h")
depends.append(API_DIR + "numpy.i")
...
setup(name='pydart2',
      ...
      packages=find_packages(exclude=["pydart2.api"]),
