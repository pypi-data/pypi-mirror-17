...
It doesn't do user management itself. This is left to Mambo User package.
"""
import os
import datetime
import json
...
from mambo import (Mambo, set_meta, get_config, redirect, request, url_for,
                         session, abort, flash, flash_data, get_flashed_data,
                         register_package, init_app)
from mambo.decorators import (menu, route, template, plugin, login_required,
                               no_login_required, require_user_roles)
from mambo.ext import (mail, cache, storage, recaptcha, csrf,
                         user_authenticated, user_not_authenticated)
from mambo.exceptions import (ApplicationError, ModelError, UserError)
from mambo import utils
from mambo.extras import markdown_ext
...
def admin(view, **kwargs):
    ...
    template_dir = kwargs.get("template_dir", "Mambo/Plugin/Publisher/Admin")
