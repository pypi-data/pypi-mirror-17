...
def main(**kwargs):
    ...
    if app_data:
        if options.get("recipients") \
            ...
            app_data.set("recipients",
                         options.get("recipients"),
    ...
    class ContactPage(Mambo):
        ...
        def index(self):
                    ...
                    if recaptcha.verify():
                        if not email or not subject or not message:
                            ...
                            try:
                                ...
                                flash_data("emit-contact-page-email-sent")
            ...
            return {
                "title": title,
                "email_sent_successful": True if fd and "emit-contact-page-email-sent" in fd else False,
