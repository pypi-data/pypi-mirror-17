...
class BprMF(object):
    def __init__(self, train_file, metadata_file, test_file=None, ranking_file=None, factors=10, learn_rate=0.05,
                 num_interactions=10, num_events=None, predict_items_number=10, init_mean=0.1, init_stdev=0.1,
                 reg_u=0.0025, reg_i=0.0025, reg_j=0.00025, reg_bias=0, use_loss=True, rank_number=10):
        # external vars
        ...
        for n in xrange(self.num_interactions):
            ...
            for u, user in enumerate(self.users):
                ...
                for item in self.train_set["feedback"][user]:
                    ...
                    j = self.map_items[self.train_set["not_seen"][user][np.random.randint(0, len(
                        self.train_set["not_seen"][user]))]]
...
BprMF(train_file="/home/fortes/Documentos/experiments/user_profile/folds/0/train.dat",
      metadata_file="/home/fortes/Documentos/experiments/user_profile/folds/0/user_statistical_profile.dat",
      test_file="/home/fortes/Documentos/experiments/user_profile/folds/0/test.dat").execute()
