import sqlite3, sys, os, webbrowser, base64
from bs4 import BeautifulSoup as soup

# since I couldn't get the setup script working, I must do some checks right here
...
class sql_table(object):
    ...
    def display_html(self, use_stylesheet=True):
        if os.path.exists(os.getcwd() + "\\docs") == False:
            os.mkdir("docs")
        path_to_html_cache = "docs/generated_table.html"
        ...
        if use_stylesheet:
            r  = b""
            x = base.new_tag("style")
            x.append(base64.b64decode(r).decode('utf-8'))
