    ...
    def get_player_list_on_date(database, date):
        ...
        :return:         the results of the SELECT query, a list of tuples of player information
                         the results are in this order:
                            ...
                            - points
        """
        return database.execute(u"SELECT name, position, value, points FROM players WHERE date = ?", (date,)).fetchall()
    ...
    def get_player_on_date(database, date, name):
        ...
        :return:         the results of the SELECT query, a list of tuples of player information
                         the results are in this order:
                            ...
                            - points
        """
        return database.execute(u"SELECT name, position, value, points FROM players WHERE date = ? AND name = ?",
