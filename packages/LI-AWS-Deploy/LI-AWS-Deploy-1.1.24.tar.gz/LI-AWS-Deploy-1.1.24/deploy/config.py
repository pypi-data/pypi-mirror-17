...
APPLICATIONS = [
    ...
    ('LI-AppConciliacao', ['development', 'staging', 'production']),
...
def get_config_data(filename="li-config"):
            ...
            for app, branch_list in APPLICATIONS:
                ...
                for branch in branch_list:
                    ...
                    if first_branch:
                        ...
                        command = "git checkout -b {branch} remotes/origin/{branch}".format(branch=branch)
                    print(command)
                    run_command(
                        title=None,
                        command_list=[
    ...
    print("Certifique-se de ter instalado o Docker antes de iniciar o uso.")
    return False
