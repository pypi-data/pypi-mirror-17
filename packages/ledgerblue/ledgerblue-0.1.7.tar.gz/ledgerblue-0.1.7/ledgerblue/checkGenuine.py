...
def getDeployedSecretV2(dongle, masterPrivate, targetid):
	...
	index = 0
	last_pub_key = PublicKey(bytes("0490f5c9d15a0134bb019d2afd0bf297149738459706e7ac5be4abc350a1f818057224fce12ec9a65de18ec34d6e8c24db927835ea1692b14c32e9836a75dad609".decode('hex')), raw=True)
	while True:
		if index == 0:			
